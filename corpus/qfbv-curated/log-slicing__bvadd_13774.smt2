...
(declare-fun input1_0 () (_ BitVec 13774))
(declare-fun input2_1 () (_ BitVec 13774))
(declare-fun result_2 () (_ BitVec 13774))
(assert (= result_2 (bvadd input1_0 input2_1)))
(declare-fun bvadd_result_3 () (_ BitVec 13774))
(declare-fun cin_4 () (_ BitVec 13774))
(declare-fun cout_5 () (_ BitVec 13774))
...
(declare-fun concat_result_6 () (_ BitVec 13774))
(assert (= ((_ extract 13772 0) cout_5) ((_ extract 13773 1) concat_result_6)))
