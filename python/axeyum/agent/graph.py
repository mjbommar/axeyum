...
def instructions_text(root: Path) -> str:
    ...
    return (
        ...
        "\n"
        "WHAT YOU CAN DO. You have seven read-only tools. After you emit a plan, a\n"
...
GATHER_PROMPT = (
    ...
    "  4. lemma_neighbourhood -- exact accepted-proof dependencies and reverse\n"
    "     consumers for promising theorem names; rows are candidates, not proof.\n"
    "  5. frontier_select -- other eligible facts of the same shape.\n"
    "  6. operation_registry -- whether anything already targets it.\n"
    "\n"
