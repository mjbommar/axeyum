...
Date: 2026-08-26  
Repository checkpoint: `2721ddd79` (review lane; later mutable views include concurrent mathematics through `5d5b260b3`)
...
- 1,587 declarations with an empty measured footprint; and
- 7,341 direct theorem-dependency edges.
...
with two or more independent checks. The lemma index covers all 1,263 kernel
theorems and 7,341 direct edges; 397 theorems now link exactly to 398 ledger
