...
generated tests and helper-rendered `Result<bool, _>` replay assertions) with
2 proved, 6 disproved, 0 unknown, DISAGREE=0, and 1/1 Lean-required coverage.
External proptest/Kani-style comparison remains the next measurement step.
