...
- `tests/support/corpus_cases.rs` is the shared graduated SDK corpus. The
  ...
  `SCOREBOARD.md` plus `corpus.json`: 5 cases, 2 proved, 3 disproved, 0
...
| PROP.6 | SDK measurement gate | WIP — first committed graduated corpus, generated `SCOREBOARD.md`, and machine-readable `corpus.json` landed with 5 cases, DISAGREE=0, and 1/1 Lean-required coverage; external proptest/Kani-style baseline comparison remains open |
