...
- [x] **4. Polynomial rings as a structure** — *done 2026-09-04, a full `CommRing` instance.*, with the existing ℚ and ℂ
      ...
      half is done.
- [~] **5. Vector spaces over an abstract field, with bases and dimension** — *modules 2026-09-04; `AlgS.Field` with apartness, vector spaces, and dimension at zero 2026-09-05; general invariance of dimension still open.*,
