...
- [~] **4. Arithmetization of syntax, toward Gödel I.** — *numbering, decoder, round trip, the commuting lemma, the Leibniz rule and the arithmetic half of the diagonal lemma all landed 2026-09-05; what remains is representability of the diagonal function in Q, then Gödel I.* Large, well-mapped,
