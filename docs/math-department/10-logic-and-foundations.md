...
- [~] **4. Arithmetization of syntax, toward Gödel I.** — *numbering, decoder, round trip, Leibniz rule, the diagonal identity, and now Robinson's Q with its model, consistency, numeral arithmetic and pairing's representability (existence half) all landed by 2026-09-06; the uniqueness half needs order axioms beyond Q, then the diagonal lemma, then Gödel I.* Large, well-mapped,
