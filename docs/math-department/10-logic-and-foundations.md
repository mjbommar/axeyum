...
- [~] **4. Arithmetization of syntax, toward Gödel I.** — *Gödel numbering with injectivity, a decoder and `substCode` landed 2026-09-05; the diagonal lemma and Gödel I are a proof gap with nothing missing under it.* Large, well-mapped,
