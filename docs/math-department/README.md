...
| 06 | [Topology](06-topology.md) | point-set, algebraic | **Re-measured 2026-09-06 at `5f4c38c32`.** `Metric` is 97 declarations and `Top` is 53; ADR-1602 settled the design (metric first, pointfree later, open sets never) and ADR-1643 built the frame. No separation, no connectedness, one frame instance. |
...
| 08 | [Probability & statistics](08-probability-and-statistics.md) | finite & measure-theoretic | **Re-measured 2026-09-06.** 74 axiom-free declarations — 54 at ℚ, 20 over `AlgS.OrderedRing` — a constructed Bernoulli model and a `1/m²` fourth-moment tail; the blocker is a product space, not a measure. |
