...
| 2026-09-06 | **Toward the completion** (the blocker this file named, ADR-1678): the completion carrier, its distance sequence, the isometric embedding and the four-point estimate; 16 axiom-free declarations. The earlier sizing was wrong in four separate ways, each re-derived: the carrier predicate it said was missing already exists under another name and costs no new estimates, its count of reusable lemmas rested on an inverted inference (a lemma stated about the reals is applicable here, not disqualified), and all four lemmas it called new are existing theorems verbatim. The remaining slice carries no new estimate and no obstruction; the lane stopped for budget. | `c175f529c`; `metric_completion` 12 passed |
