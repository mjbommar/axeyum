...
- [x] **5. Products and subspaces** — *both halves done by 2026-09-05: `Metric.subspace` existed, `Metric.prod` landed with completeness transfer.* **[ADR-1602] split this item.** The
