...
- [x] **3. Unique factorization as a theorem, not a construction.** **[AUDIT]
      ...
      carriers.
- [x] **4. Sums of two squares, with the descent argument reusable.** — *done 2026-09-06 as `Int.fermatTwoSquares`, three slices; the descent step is stated for reuse.* A named
...
- [~] **5. Chebyshev-type bounds on π(x).** — *the primorial, the sharp central-binomial bound, monotonicity of π, and Euclid in counting form landed by 2026-09-06; the bounds themselves wait on Legendre's formula, which sits in a genuinely held-out family.* The first genuinely analytic
