...
- [~] **7. Real quantifier elimination.** *Univariate existential and universal fragment with sample-point certificates landed 2026-09-05 (`qe.rs`); multivariate and CAD open.* The univariate existential fragment
