...
- [~] **6. Geometry beyond the rational plane.** *Conics, 3D, homogeneous coordinates and isometries landed 2026-09-05 (`geometry_beyond.rs`) with three new certified corpus theorems; Pascal and Desargues decline under the current certifier.* Conics as quadratic forms,
