...
- [~] **4. Algebraic extensions and algebraic number theory.** *ℚ(α) arithmetic, ℤ[i], two squares and quadratic units landed 2026-09-05 (`numberfield.rs`); ideal factorization and multivariate factorization open.* Arithmetic in
