...
| W1-8 | Angle measure; laws of sines and cosines | 05.1 | **in progress** | Connect analytic `sin`/`cos` to `CPoint`'s `dot` and `cross`. The library has trigonometry and geometry and they do not touch. |
...
| W1-10 | Generalize finite probability over `AlgS.OrderedRing` | 08.2 | **in progress** | Prerequisite for stating the WLLN across ℚ and ℝ without a hand-built bridge. |
...
| W1-12 | Measure the exact-real performance envelope | 11.4 | **in progress** | π and exp to a stated precision with the cost model. The library claims computable analysis and has never quoted a time. |
| W1-13 | Measure and reduce the `cas-internal` residue | 11.5 | **in progress** | The honest boundary of the trusted pipeline; should be published and falling. |
...
| W2-13 | Isometries of the plane | 05.3 | **in progress** | — |
...
| W2-15 | Independence as a definition | 08.3 | **in progress** | W1-10 |
...
| W1 — unblocked | 13 | 0 | 4 | **9** | **1** |
| W2 — carriers | 21 | 8 | 2 | **9** | **2** |
