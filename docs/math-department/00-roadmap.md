...
| W2-10 | Products and subspaces | 06.5 | not started | **the subspace half is now open** (W0-5 landed `Metric.subspace`); the product is buildable; migrating the existing `*On` forms onto subspaces is a separate decision with real proof cost |
