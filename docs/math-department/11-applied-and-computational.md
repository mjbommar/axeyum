...
- [x] **3. A nonlinear-arithmetic producer with Positivstellensatz
      certificates** — *done 2026-09-05 as `psatz` over ℚ; this file's claim that nothing reconstructed SOS certificates was measured false first.*, connecting the existing SOS work to a kernel-emitting
