...
- [x] **3. Publish the constructive analysis as a Lean library.** **Landed
      ...
      generated from the live kernel and gated on drift: 3,397 of the 3,617
      `creal` declarations publish as Lean commands, 117 more are regenerated by
      Lean from `inductive` commands, and **103 are excluded with typed reasons
