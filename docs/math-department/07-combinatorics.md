...
- [~] **4. Hall's marriage theorem** — *necessity done 2026-09-04; the choice half and the counting half of sufficiency both closed by 2026-09-05; the statement waits on an empty-set/singleton bridge for `Nat.Finset`.*, over `Nat.Finset` with the existing
