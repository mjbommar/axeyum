...
- [~] **5. Complex analysis: holomorphy and Cauchy's integral theorem** — *the uniform derivative, holomorphy on a disc, and now Leibniz with the estimate shelf landed 2026-09-05; polyEval's derivative, Cauchy–Riemann and the integral theorem open.*, over
