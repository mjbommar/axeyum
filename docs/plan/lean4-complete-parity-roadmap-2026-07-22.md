...
pass. Main merges `949dd3d9`, `9fe5cab6`, and `2fd4c187` carry the repair, and
the post-merge focused/parity/link replay passes. Explicit M2.1 authorization
is still required; the repair itself adds no execution credit.
