...
[Note 18](../../research/10-cas/lemire-signed-trace/18-savings-scale.md):
...
endpoints).
[Note 19](../../research/10-cas/lemire-signed-trace/19-effective-large-q.md):
...
[Note 20](../../research/10-cas/lemire-signed-trace/20-almost-all-degrees.md):
...
[Note 21](../../research/10-cas/lemire-signed-trace/21-probabilistic-face.md):
