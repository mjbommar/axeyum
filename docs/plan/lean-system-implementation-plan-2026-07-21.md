...
21. **DONE:** TL0.7.4 — run the pinned-Lean preflight and official-export
    ...
    and R3's released-toolchain pass. **NEXT:** derive fresh deterministic child
    shards from the official parent/profile authorities, execute new unique
    cases through the qualified path, classify their native dependencies, and
