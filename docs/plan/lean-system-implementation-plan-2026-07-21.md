...
| TL2.13 | WIP (P0 preregistered; M0 next) | Admit mutual inductive groups through [proposed ADR-0354](../research/09-decisions/adr-0354-preregister-lean-mutual-inductive-groups.md)'s one atomic ordered group gate. Shared parameters, equivalent result universes, group-wide positivity, per-family indices, all motives/minors, target-family IH/recursive calls, mutual-Prop elimination, atomic rollback, and singleton delegation are registered before implementation. | TL2.12 | L | [Preregistered plan](lean-mutual-inductive-groups-tl2.13-plan-2026-07-22.md): the frozen two-family official fixture and separate non-indexed/indexed computation streams agree with independently generated recursors; >=640 group cases repeat; 768 recursive/840 positivity controls and all rollback/resource gates pass. |
