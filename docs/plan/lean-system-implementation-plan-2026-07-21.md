...
21. **DONE:** TL0.7.4 — run the pinned-Lean preflight and official-export
    ...
    512 MiB task-stack policy. **NEXT:** TL0.6.3 M0 R1 — implement the
    preregistered Lean-shell `-j1` and preset-log corrections, commit/push them,
    then retry the exact singleton;
