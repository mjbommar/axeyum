...
| TL2.13 | WIP (M0 source/wire freeze complete; M1 next) | Admit mutual inductive groups through [proposed ADR-0354](../research/09-decisions/adr-0354-preregister-lean-mutual-inductive-groups.md)'s one atomic ordered group gate. The [M0 result](lean-mutual-inductive-groups-m0-2026-07-22.md) freezes exact non-indexed/indexed computation sources and streams, semantic family order versus dependency-ordered wire recursors, 18 native rows, 16 mutations, resources, controls, and the no-product-credit boundary. M1 adds the group representation and behavior/identity-preserving singleton delegation without widening mutual admission. | TL2.12 | L | [Preregistered plan](lean-mutual-inductive-groups-tl2.13-plan-2026-07-22.md): the frozen two-family official fixture and separate non-indexed/indexed computation streams agree with independently generated recursors; >=640 group cases repeat; 768 recursive/840 positivity controls and all rollback/resource gates pass. |
