...
| TL2.12 | WIP (M2 complete; M3 next) | Generalize direct, recursive-indexed, and reflexive/higher-order fields through proposed ADR-0353's one telescope-based IH/rule construction. [M0](lean-recursive-induction-hypotheses-m0-2026-07-22.md) freezes the baseline and two official roots; [M1](lean-recursive-induction-hypotheses-m1-2026-07-22.md) installs the shared classifier/reopener; [M2](lean-recursive-induction-hypotheses-m2-2026-07-22.md) admits all ten positive native rows, retains four typed negatives, rejects ten native mutation classes, and repeats a 768-case public-path grammar plus the 840-case positivity control. M3-M4 own first official importer observation, exact recursor/computation comparison, metadata/publication mutations, and pinned differential evidence. | TL2.11 | L | [Preregistered plan](lean-recursive-induction-hypotheses-tl2.12-plan-2026-07-22.md): `Vector`- and `Acc`-shaped official streams complete twice, exact generated recursors compare, selected recursor applications compute, direct recursion/840-case positivity remain unchanged, and all rollback/resource gates pass. |
