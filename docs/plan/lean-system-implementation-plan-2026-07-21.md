...
| TL2.12 | NEXT | Generalize induction hypotheses for recursive-indexed and reflexive/higher-order fields as one preregistered semantic slice. | TL2.11 | L | `Vector`- and `Acc`-shaped official fixtures admit and compute. |
