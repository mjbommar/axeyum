...
> **Status update, 2026-09-05: historical.** Not edited since 2026-08-13. Its
...
| TL3.3 | DONE | Namespace and make all preludes fallible/idempotent so logic/Real/Int/String coexist in one kernel; this fulfills T6.0.8 rather than duplicating it. [Requirements R1](lean-kernel-requirements-2026-08-13.md#r1--prelude-composition-hard-blocker), [accepted ADR-0387](../research/09-decisions/adr-0387-fallible-composable-lean-preludes.md), and the [R1 result](lean-prelude-composition-r1-result-2026-08-13.md) define and verify the migration. | TL3.1 | M | **Met:** combined and repeated builds preserve exact declarations; a mixed Nat/Int proof checks; a late conflict rolls back atomically. |
