...
| TL3.3 | TODO | Namespace and make all preludes fallible/idempotent so logic/Real/Int/String coexist in one kernel; this fulfills T6.0.8 rather than duplicating it. [Requirements R1](lean-kernel-requirements-2026-08-13.md#r1--prelude-composition-hard-blocker) and [proposed ADR-0387](../research/09-decisions/adr-0387-fallible-composable-lean-preludes.md) define the migration. | TL3.1 | M | Combined build has no collision or panic. |
