...
| TL2.13 | WIP (M2 native semantics complete; M3 next) | Admit mutual inductive groups through [proposed ADR-0354](../research/09-decisions/adr-0354-preregister-lean-mutual-inductive-groups.md)'s one atomic ordered group gate. [M0](lean-mutual-inductive-groups-m0-2026-07-22.md) freezes exact sources/wire order and the no-product boundary. [M1](lean-mutual-inductive-groups-m1-2026-07-22.md) adds the ordered family specification, common parameter/result-universe preflight, per-family index opening, insertion-log rollback, exact singleton delegation, and typed policy decline. [M2](lean-mutual-inductive-groups-m2-2026-07-22.md) replaces that decline with native complete-group positivity, constructors, globally ordered motives/minors, target-family recursion, per-family recursors, mutual-`Prop` restriction, and atomic rollback across 18 public rows plus mutation/late-failure teeth. M3 owns the independent >=640-case group grammar; importer widening remains M4. | TL2.12 | L | [Preregistered plan](lean-mutual-inductive-groups-tl2.13-plan-2026-07-22.md): the frozen two-family official fixture and separate non-indexed/indexed computation streams agree with independently generated recursors; >=640 group cases repeat; 768 recursive/840 positivity controls and all rollback/resource gates pass. |
