...
| TL2.13 | WIP (M4 official import/computation complete; M5 next) | Admit mutual inductive groups through [proposed ADR-0354](../research/09-decisions/adr-0354-preregister-lean-mutual-inductive-groups.md)'s one atomic ordered group gate. [M0](lean-mutual-inductive-groups-m0-2026-07-22.md) freezes exact sources/wire order and the no-product boundary. [M1](lean-mutual-inductive-groups-m1-2026-07-22.md) adds the ordered specification/preflight/rollback and exact singleton delegation. [M2](lean-mutual-inductive-groups-m2-2026-07-22.md) lands native complete-group semantics across 18 public rows. [M3](lean-mutual-inductive-groups-m3-2026-07-22.md) repeats 720 unique public cases byte-identically with 432 positive contracts, 288 typed rollbacks, direct motive/minor-order and target-rule oracles, generated mutation teeth, and unchanged 768/840 controls. [M4](lean-mutual-inductive-groups-m4-2026-07-22.md) imports all three official streams twice, compares recursors by checked name, confirms both registered cross-family computations, and closes 22 rejecting importer/publication mutation classes. M5 owns the assurance overlay, final gates, and decision. | TL2.12 | L | [Preregistered plan](lean-mutual-inductive-groups-tl2.13-plan-2026-07-22.md): the frozen two-family official fixture and separate non-indexed/indexed computation streams agree with independently generated recursors; >=640 group cases repeat; 768 recursive/840 positivity controls and all rollback/resource gates pass. |
...
| TL4.10 | TODO | Elaborate structural, mutual, nested, well-founded, and partial recursion with termination evidence. | TL4.9 | XL | Positive/negative termination corpus agrees with official Lean. |
