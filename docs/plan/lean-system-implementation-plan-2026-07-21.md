...
21. TL0.7.4 then TL0.6.3 — run the pinned-Lean preflight and official-export
    controls through the complete path with zero credit, accept or revise the
    policy, then retain the first official profile executions;
