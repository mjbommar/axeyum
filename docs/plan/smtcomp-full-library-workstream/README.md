...
3. **Credited full population — F1, the complete process-free F2 preflight, and
   ...
   is fixture-complete on the SMT topic.** The
   ...
   construct live F3 authority or complete F4. No host probe, sentinel, NAS
   preparation root, resource session, allocation, or solver process was
   started.
...
4. Treat the accepted S4 root as immutable. S5/S5.1 admission and the repaired
   ...
   by `c4d9050a`. The process-free F3 coordinator is topic-ready but must be
   integrated and its `resume_fs.py` Lean pin regenerated by the Lean owner.
   No live root has been published. Revalidate the exact current `origin/main`,
