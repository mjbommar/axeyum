...
4. Treat the accepted S4 root as immutable. S5/S5.1 admission and the repaired
   ...
   `resume_fs.py` Lean pin must be regenerated by the Lean owner. No live root
   or canonical acceptance record has been published. Revalidate the exact current `origin/main`,
