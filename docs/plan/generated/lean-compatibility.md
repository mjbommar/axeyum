...
| `expr-projection` | `axeyum-lean-kernel` | Wire projection translation remains declined until kernel inference and reduction land; TL2.2 structural representation alone earns no K1 credit. | [source](../../../crates/axeyum-lean-import/src/lib.rs) |
