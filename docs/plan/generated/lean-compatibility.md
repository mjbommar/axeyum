...
- 13 exact artifact/profile rows and 3 registered unsupported-construct codes.
...
| `K1-import` | Versioned declaration import | `parsed`, `translated`, `admitted` | 6 | 6 |
...
|---|---:|---:|---:|---:|---:|
| `parsed` | 7 | 0 | 0 | 5 | 1 |
| `translated` | 6 | 0 | 0 | 5 | 2 |
| `admitted` | 7 | 0 | 0 | 6 | 0 |
| `official_admitted` | 7 | 0 | 0 | 6 | 0 |
| `source_elaborated` | 7 | 0 | 0 | 5 | 1 |
| `proof_checked` | 3 | 0 | 0 | 10 | 0 |
| `workflow_reproduced` | 0 | 0 | 0 | 12 | 1 |
| `runtime_reproduced` | 0 | 0 | 0 | 12 | 1 |
...
| Official Nat-literal dependency root | K1-import | pass | passed | passed | passed | passed | passed | not attempted | not attempted | not attempted | - | [fixture](../../../docs/plan/fixtures/lean4export-v4.30-nat-literal.ndjson); [test](../../../crates/axeyum-lean-import/tests/lean4export_v31.rs) | This exact K1 Nat-literal root passes. Accelerated Nat arithmetic (ADR-0459) and String literals (ADR-0366) are now implemented and have their own rows; no broader Init, Std, or mathlib closure receives credit. |
...
| Official String-literal dependency root | K1-import | pass | passed | passed | passed | passed | passed | not attempted | not attempted | not attempted | - | [fixture](../../../docs/plan/fixtures/lean4export-v4.30-blocker-census.lean); [source](../../../crates/axeyum-lean-import/examples/string_literal_reduction_probe.rs); [test](../../../crates/axeyum-lean-kernel/tests/real_lean_string_literal_crosscheck.rs) | This exact K1 String-literal root passes. What lies past string literals in a broader Init, Std, or mathlib closure is censused in docs/formalized-math-2026-08/diary-import-strings.md and receives no K1 credit here. |
...
| Native goal, hole, unification, and tactic profile | K3-proof | open | not attempted | not attempted | not attempted | not attempted | not attempted | not attempted | not attempted | not attempted | - | [plan](../../../docs/prover-track/plan/README.md) | P6.2/P6.3 and TL5 remain implementation work. The native producers (linarith, ring, simp, decide, the tactic combinator) are K3-shaped over THIS kernel's preludes, not over Lean goals, so this row's assurance fields stay not_attempted; see ADR-1666 for the Lean-goal side (`by axeyum`, a Lean tactic in lean/axeyum-tactic that hands Lean's own parser/elaborator/kernel a checked term, tracked outside this planned-system-profile row). |
