...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Native kernel regression profile | K0-checker | pass | n/a | n/a | passed | not attempted | n/a | passed | n/a | n/a | - | [test](../../../crates/axeyum-lean-kernel/tests/prop_large_elim_soundness.rs); [test](../../../crates/axeyum-lean-kernel/tests/prop_large_elim_derives_false.rs) | K0 is real but does not imply official declaration import or native source support. |
...
| `expr-projection` | `axeyum-lean-kernel` | Projection expressions are outside the current translated core. | [source](../../../crates/axeyum-lean-import/src/lib.rs) |
