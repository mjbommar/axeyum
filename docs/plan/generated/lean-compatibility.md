...
- 12 exact artifact/profile rows and 10 registered unsupported-construct codes.
...
| `K1-import` | Versioned declaration import | `parsed`, `translated`, `admitted` | 2 | 5 |
...
| Official Nat-literal dependency root | K1-import | open | passed | declined | not attempted | passed | passed | not attempted | not attempted | not attempted | `expr-projection` | [fixture](../../../docs/plan/fixtures/lean4export-v4.30-nat-literal.ndjson); [test](../../../crates/axeyum-lean-import/tests/lean4export_v31.rs) | Projection is reached before the literal record; bignum storage and Nat literal typing remain later blockers. |
| Official structure-projection dependency root | K1-import | open | passed | declined | not attempted | passed | passed | not attempted | not attempted | not attempted | `expr-projection` | [fixture](../../../docs/plan/fixtures/lean4export-v4.30-projection.ndjson); [test](../../../crates/axeyum-lean-import/tests/lean4export_v31.rs) | TL2.2 representation and TL2.3 native inference are landed; TL2.4 reduction, TL2.5 structure eta, and importer translation remain. |
...
| `expr-projection` | `axeyum-lean-kernel` | Wire projection translation remains declined until TL2.4 constructor reduction lands; TL2.2 representation and TL2.3 native inference alone earn no K1 credit. | [source](../../../crates/axeyum-lean-import/src/lib.rs) |
...
| `literal-nat-bignum-and-typing` | `axeyum-lean-kernel` | Natural literals await arbitrary-precision storage and kernel typing. | [source](../../../crates/axeyum-lean-import/src/lib.rs) |
