...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2482 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2427 |
...
| `kernel-lean` | 34 | 20 | 2326 | kernel proof, reconstructed and checked here |
...
Of the 2482 established facts, 2379 record an
