...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2553 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2498 |
...
| `kernel-lean` | 34 | 20 | 2396 | kernel proof, reconstructed and checked here |
...
Of the 2553 established facts, 2449 record an
