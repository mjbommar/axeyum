...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2343 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2292 |
...
| `kernel-lean` | 30 | 20 | 2191 | kernel proof, reconstructed and checked here |
...
Of the 2343 established facts, 2240 record an
