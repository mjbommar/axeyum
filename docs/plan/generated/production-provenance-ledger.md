...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2697 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2642 |
...
|---|---:|---:|---:|---|
| `cas-certificate` | 0 | 0 | 68 | computer-algebra certificate |
| `imported-kernel-lean` | 0 | 0 | 7 | kernel proof imported from an external development |
| `kernel-lean` | 34 | 20 | 2532 | kernel proof, reconstructed and checked here |
...
Of the 2697 established facts, 2585 record an
