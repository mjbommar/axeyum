...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2625 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2570 |
...
| `kernel-lean` | 34 | 20 | 2468 | kernel proof, reconstructed and checked here |
...
Of the 2625 established facts, 2521 record an
