...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2602 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2547 |
...
| `kernel-lean` | 34 | 20 | 2445 | kernel proof, reconstructed and checked here |
...
Of the 2602 established facts, 2498 record an
