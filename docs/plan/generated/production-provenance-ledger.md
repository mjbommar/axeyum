...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2458 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2403 |
...
| `kernel-lean` | 34 | 20 | 2302 | kernel proof, reconstructed and checked here |
...
Of the 2458 established facts, 2355 record an
