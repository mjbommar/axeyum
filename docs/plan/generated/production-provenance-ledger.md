...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2591 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2536 |
...
| `kernel-lean` | 34 | 20 | 2434 | kernel proof, reconstructed and checked here |
...
Of the 2591 established facts, 2487 record an
