...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2531 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2476 |
...
| `kernel-lean` | 34 | 20 | 2375 | kernel proof, reconstructed and checked here |
...
Of the 2531 established facts, 2428 record an
