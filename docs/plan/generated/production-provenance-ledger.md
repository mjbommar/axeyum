...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2511 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2456 |
...
| `kernel-lean` | 34 | 20 | 2355 | kernel proof, reconstructed and checked here |
...
Of the 2511 established facts, 2408 record an
