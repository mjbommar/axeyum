...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2585 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2530 |
...
| `kernel-lean` | 34 | 20 | 2428 | kernel proof, reconstructed and checked here |
...
Of the 2585 established facts, 2481 record an
