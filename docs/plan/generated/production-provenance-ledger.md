...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2534 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2479 |
...
| `kernel-lean` | 34 | 20 | 2378 | kernel proof, reconstructed and checked here |
...
Of the 2534 established facts, 2431 record an
