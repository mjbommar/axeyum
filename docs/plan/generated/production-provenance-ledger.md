...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2584 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2529 |
...
| `kernel-lean` | 34 | 20 | 2427 | kernel proof, reconstructed and checked here |
...
Of the 2584 established facts, 2480 record an
