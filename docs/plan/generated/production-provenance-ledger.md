...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2350 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2299 |
...
| `kernel-lean` | 30 | 20 | 2198 | kernel proof, reconstructed and checked here |
...
Of the 2350 established facts, 2247 record an
