...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2652 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2597 |
...
| `kernel-lean` | 34 | 20 | 2495 | kernel proof, reconstructed and checked here |
...
Of the 2652 established facts, 2548 record an
