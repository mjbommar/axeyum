...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2514 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2459 |
...
| `kernel-lean` | 34 | 20 | 2358 | kernel proof, reconstructed and checked here |
...
Of the 2514 established facts, 2411 record an
