...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2567 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2512 |
...
| `kernel-lean` | 34 | 20 | 2410 | kernel proof, reconstructed and checked here |
...
Of the 2567 established facts, 2463 record an
