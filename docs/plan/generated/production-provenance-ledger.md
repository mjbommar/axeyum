...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2485 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2430 |
...
| `kernel-lean` | 34 | 20 | 2329 | kernel proof, reconstructed and checked here |
...
Of the 2485 established facts, 2382 record an
