...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2529 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2474 |
...
| `kernel-lean` | 34 | 20 | 2373 | kernel proof, reconstructed and checked here |
...
Of the 2529 established facts, 2426 record an
