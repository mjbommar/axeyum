...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2626 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2571 |
...
| `kernel-lean` | 34 | 20 | 2469 | kernel proof, reconstructed and checked here |
...
Of the 2626 established facts, 2522 record an
