...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2360 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2309 |
...
| `kernel-lean` | 30 | 20 | 2208 | kernel proof, reconstructed and checked here |
...
Of the 2360 established facts, 2257 record an
