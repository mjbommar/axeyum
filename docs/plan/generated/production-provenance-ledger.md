...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2399 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2348 |
...
| `kernel-lean` | 30 | 20 | 2247 | kernel proof, reconstructed and checked here |
...
Of the 2399 established facts, 2296 record an
