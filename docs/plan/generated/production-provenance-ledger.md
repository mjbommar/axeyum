...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2389 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2338 |
...
| `kernel-lean` | 30 | 20 | 2237 | kernel proof, reconstructed and checked here |
...
Of the 2389 established facts, 2286 record an
