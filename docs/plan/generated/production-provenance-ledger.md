...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2558 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2503 |
...
| `kernel-lean` | 34 | 20 | 2401 | kernel proof, reconstructed and checked here |
...
Of the 2558 established facts, 2454 record an
