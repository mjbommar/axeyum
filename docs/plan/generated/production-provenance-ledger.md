...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2669 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2614 |
...
| `kernel-lean` | 34 | 20 | 2512 | kernel proof, reconstructed and checked here |
...
Of the 2669 established facts, 2565 record an
