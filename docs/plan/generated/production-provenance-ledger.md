...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2378 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2327 |
...
| `kernel-lean` | 30 | 20 | 2226 | kernel proof, reconstructed and checked here |
...
Of the 2378 established facts, 2275 record an
