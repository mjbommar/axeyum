...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 1754 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 1703 |
...
| `kernel-lean` | 30 | 20 | 1635 | kernel proof, reconstructed and checked here |
...
Of the 1754 established facts, 1684 record an
