...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2539 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2484 |
...
| `kernel-lean` | 34 | 20 | 2382 | kernel proof, reconstructed and checked here |
...
Of the 2539 established facts, 2435 record an
