...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2563 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2508 |
...
| `kernel-lean` | 34 | 20 | 2406 | kernel proof, reconstructed and checked here |
...
Of the 2563 established facts, 2459 record an
