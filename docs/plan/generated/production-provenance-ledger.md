...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2473 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2418 |
...
| `kernel-lean` | 34 | 20 | 2317 | kernel proof, reconstructed and checked here |
...
Of the 2473 established facts, 2370 record an
