...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2680 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2625 |
...
| `kernel-lean` | 34 | 20 | 2523 | kernel proof, reconstructed and checked here |
...
Of the 2680 established facts, 2576 record an
