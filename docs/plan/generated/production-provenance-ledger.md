...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2465 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2410 |
...
| `kernel-lean` | 34 | 20 | 2309 | kernel proof, reconstructed and checked here |
...
Of the 2465 established facts, 2362 record an
