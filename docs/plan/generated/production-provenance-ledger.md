...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2687 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2632 |
...
| `kernel-lean` | 34 | 20 | 2530 | kernel proof, reconstructed and checked here |
...
Of the 2687 established facts, 2583 record an
