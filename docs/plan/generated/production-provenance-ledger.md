...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2638 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2583 |
...
| `kernel-lean` | 34 | 20 | 2481 | kernel proof, reconstructed and checked here |
...
Of the 2638 established facts, 2534 record an
