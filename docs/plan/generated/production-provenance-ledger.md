...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 1728 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 1677 |
...
| `kernel-lean` | 30 | 20 | 1610 | kernel proof, reconstructed and checked here |
...
Of the 1728 established facts, 1659 record an
