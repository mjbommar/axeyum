...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2391 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2340 |
...
| `kernel-lean` | 30 | 20 | 2239 | kernel proof, reconstructed and checked here |
...
Of the 2391 established facts, 2288 record an
