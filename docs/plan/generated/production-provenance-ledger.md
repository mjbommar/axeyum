...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2550 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2495 |
...
| `kernel-lean` | 34 | 20 | 2393 | kernel proof, reconstructed and checked here |
...
Of the 2550 established facts, 2446 record an
