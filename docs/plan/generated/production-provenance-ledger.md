...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2054 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2003 |
...
|---|---:|---:|---:|---|
| `cas-certificate` | 0 | 0 | 41 | computer-algebra certificate |
| `imported-kernel-lean` | 0 | 0 | 5 | kernel proof imported from an external development |
| `kernel-lean` | 30 | 20 | 1922 | kernel proof, reconstructed and checked here |
...
Of the 2054 established facts, 1971 record an
