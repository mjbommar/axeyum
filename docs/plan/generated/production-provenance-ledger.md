...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2554 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2499 |
...
| `kernel-lean` | 34 | 20 | 2397 | kernel proof, reconstructed and checked here |
...
Of the 2554 established facts, 2450 record an
