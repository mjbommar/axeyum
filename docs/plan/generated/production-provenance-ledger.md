...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2598 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2543 |
...
| `kernel-lean` | 34 | 20 | 2441 | kernel proof, reconstructed and checked here |
...
Of the 2598 established facts, 2494 record an
