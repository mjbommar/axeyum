...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2445 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2390 |
...
| `kernel-lean` | 34 | 20 | 2289 | kernel proof, reconstructed and checked here |
...
Of the 2445 established facts, 2342 record an
