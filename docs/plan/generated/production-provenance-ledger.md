...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2491 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2436 |
...
| `kernel-lean` | 34 | 20 | 2335 | kernel proof, reconstructed and checked here |
...
Of the 2491 established facts, 2388 record an
