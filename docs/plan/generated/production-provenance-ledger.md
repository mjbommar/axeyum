...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2478 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2423 |
...
| `kernel-lean` | 34 | 20 | 2322 | kernel proof, reconstructed and checked here |
...
Of the 2478 established facts, 2375 record an
