...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2464 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2409 |
...
| `kernel-lean` | 34 | 20 | 2308 | kernel proof, reconstructed and checked here |
...
Of the 2464 established facts, 2361 record an
