...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2515 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2460 |
...
| `kernel-lean` | 34 | 20 | 2359 | kernel proof, reconstructed and checked here |
...
Of the 2515 established facts, 2412 record an
