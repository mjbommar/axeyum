...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2655 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2600 |
...
| `kernel-lean` | 34 | 20 | 2498 | kernel proof, reconstructed and checked here |
...
Of the 2655 established facts, 2551 record an
