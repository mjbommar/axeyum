...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2542 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2487 |
...
| `kernel-lean` | 34 | 20 | 2385 | kernel proof, reconstructed and checked here |
...
Of the 2542 established facts, 2438 record an
