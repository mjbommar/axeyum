...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2368 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2317 |
...
| `kernel-lean` | 30 | 20 | 2216 | kernel proof, reconstructed and checked here |
...
Of the 2368 established facts, 2265 record an
