...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2600 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2545 |
...
| `kernel-lean` | 34 | 20 | 2443 | kernel proof, reconstructed and checked here |
...
Of the 2600 established facts, 2496 record an
