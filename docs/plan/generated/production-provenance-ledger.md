...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2357 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2306 |
...
| `kernel-lean` | 30 | 20 | 2205 | kernel proof, reconstructed and checked here |
...
Of the 2357 established facts, 2254 record an
