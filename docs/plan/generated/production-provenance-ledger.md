...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2510 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2455 |
...
| `kernel-lean` | 34 | 20 | 2354 | kernel proof, reconstructed and checked here |
...
Of the 2510 established facts, 2407 record an
