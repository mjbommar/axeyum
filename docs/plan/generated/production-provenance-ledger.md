...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2666 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2611 |
...
| `kernel-lean` | 34 | 20 | 2509 | kernel proof, reconstructed and checked here |
...
Of the 2666 established facts, 2562 record an
