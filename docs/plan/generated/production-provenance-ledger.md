...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2417 |
...
| `kernel-lean` | 30 | 20 | 2265 | kernel proof, reconstructed and checked here |
...
Of the 2417 established facts, 2314 record an
