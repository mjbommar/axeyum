...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2517 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2462 |
...
| `kernel-lean` | 34 | 20 | 2361 | kernel proof, reconstructed and checked here |
...
Of the 2517 established facts, 2414 record an
