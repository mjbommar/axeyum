...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2630 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2575 |
...
| `kernel-lean` | 34 | 20 | 2473 | kernel proof, reconstructed and checked here |
...
Of the 2630 established facts, 2526 record an
