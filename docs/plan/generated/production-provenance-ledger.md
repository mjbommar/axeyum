...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2402 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2351 |
...
| `kernel-lean` | 30 | 20 | 2250 | kernel proof, reconstructed and checked here |
...
Of the 2402 established facts, 2299 record an
