...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2393 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2342 |
...
| `kernel-lean` | 30 | 20 | 2241 | kernel proof, reconstructed and checked here |
...
Of the 2393 established facts, 2290 record an
