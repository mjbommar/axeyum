...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2642 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2587 |
...
| `kernel-lean` | 34 | 20 | 2485 | kernel proof, reconstructed and checked here |
...
Of the 2642 established facts, 2538 record an
