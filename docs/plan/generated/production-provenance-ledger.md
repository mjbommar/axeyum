...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2371 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2320 |
...
| `kernel-lean` | 30 | 20 | 2219 | kernel proof, reconstructed and checked here |
...
Of the 2371 established facts, 2268 record an
