...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2471 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2416 |
...
| `kernel-lean` | 34 | 20 | 2315 | kernel proof, reconstructed and checked here |
...
Of the 2471 established facts, 2368 record an
