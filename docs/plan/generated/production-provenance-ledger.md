...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2633 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2578 |
...
| `kernel-lean` | 34 | 20 | 2476 | kernel proof, reconstructed and checked here |
...
Of the 2633 established facts, 2529 record an
