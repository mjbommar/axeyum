...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2586 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2531 |
...
| `kernel-lean` | 34 | 20 | 2429 | kernel proof, reconstructed and checked here |
...
Of the 2586 established facts, 2482 record an
