...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2520 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2465 |
...
| `kernel-lean` | 34 | 20 | 2364 | kernel proof, reconstructed and checked here |
...
Of the 2520 established facts, 2417 record an
