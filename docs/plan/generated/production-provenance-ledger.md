...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2449 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2394 |
...
| `kernel-lean` | 34 | 20 | 2293 | kernel proof, reconstructed and checked here |
...
Of the 2449 established facts, 2346 record an
