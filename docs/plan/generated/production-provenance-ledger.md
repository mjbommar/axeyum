...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2532 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2477 |
...
| `kernel-lean` | 34 | 20 | 2376 | kernel proof, reconstructed and checked here |
...
Of the 2532 established facts, 2429 record an
