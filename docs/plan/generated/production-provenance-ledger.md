...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2663 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2608 |
...
| `kernel-lean` | 34 | 20 | 2506 | kernel proof, reconstructed and checked here |
...
Of the 2663 established facts, 2559 record an
