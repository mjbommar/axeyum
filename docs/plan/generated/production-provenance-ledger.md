...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2618 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2563 |
...
| `kernel-lean` | 34 | 20 | 2461 | kernel proof, reconstructed and checked here |
...
Of the 2618 established facts, 2514 record an
