...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2659 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2604 |
...
| `kernel-lean` | 34 | 20 | 2502 | kernel proof, reconstructed and checked here |
...
Of the 2659 established facts, 2555 record an
