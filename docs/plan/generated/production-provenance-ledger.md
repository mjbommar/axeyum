...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2373 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2322 |
...
| `kernel-lean` | 30 | 20 | 2221 | kernel proof, reconstructed and checked here |
...
Of the 2373 established facts, 2270 record an
