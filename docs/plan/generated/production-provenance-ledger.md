...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2651 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2596 |
...
| `kernel-lean` | 34 | 20 | 2494 | kernel proof, reconstructed and checked here |
...
Of the 2651 established facts, 2547 record an
