...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2382 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2331 |
...
| `kernel-lean` | 30 | 20 | 2230 | kernel proof, reconstructed and checked here |
...
Of the 2382 established facts, 2279 record an
