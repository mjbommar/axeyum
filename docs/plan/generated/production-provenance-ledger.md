...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2609 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2554 |
...
| `kernel-lean` | 34 | 20 | 2452 | kernel proof, reconstructed and checked here |
...
Of the 2609 established facts, 2505 record an
