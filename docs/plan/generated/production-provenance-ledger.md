...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2601 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2546 |
...
| `kernel-lean` | 34 | 20 | 2444 | kernel proof, reconstructed and checked here |
...
Of the 2601 established facts, 2497 record an
