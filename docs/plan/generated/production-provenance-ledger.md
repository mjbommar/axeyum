...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2560 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2505 |
...
| `kernel-lean` | 34 | 20 | 2403 | kernel proof, reconstructed and checked here |
...
Of the 2560 established facts, 2456 record an
