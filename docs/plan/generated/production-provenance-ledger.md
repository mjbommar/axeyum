...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2628 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2573 |
...
| `kernel-lean` | 34 | 20 | 2471 | kernel proof, reconstructed and checked here |
...
Of the 2628 established facts, 2524 record an
