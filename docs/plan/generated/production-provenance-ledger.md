...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2587 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2532 |
...
| `kernel-lean` | 34 | 20 | 2430 | kernel proof, reconstructed and checked here |
...
Of the 2587 established facts, 2483 record an
