...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2621 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2566 |
...
| `kernel-lean` | 34 | 20 | 2464 | kernel proof, reconstructed and checked here |
...
Of the 2621 established facts, 2517 record an
