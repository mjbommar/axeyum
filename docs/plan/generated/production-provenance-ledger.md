...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2421 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2366 |
...
| `kernel-lean` | 34 | 20 | 2265 | kernel proof, reconstructed and checked here |
...
Of the 2421 established facts, 2318 record an
