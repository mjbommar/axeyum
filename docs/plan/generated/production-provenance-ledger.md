...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2476 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2421 |
...
| `kernel-lean` | 34 | 20 | 2320 | kernel proof, reconstructed and checked here |
...
Of the 2476 established facts, 2373 record an
