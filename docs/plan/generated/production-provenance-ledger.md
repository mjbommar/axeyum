...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2611 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2556 |
...
| `kernel-lean` | 34 | 20 | 2454 | kernel proof, reconstructed and checked here |
...
Of the 2611 established facts, 2507 record an
