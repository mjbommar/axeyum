...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2568 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2513 |
...
| `kernel-lean` | 34 | 20 | 2411 | kernel proof, reconstructed and checked here |
...
Of the 2568 established facts, 2464 record an
