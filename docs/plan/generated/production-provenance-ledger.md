...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2380 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2329 |
...
| `kernel-lean` | 30 | 20 | 2228 | kernel proof, reconstructed and checked here |
...
Of the 2380 established facts, 2277 record an
