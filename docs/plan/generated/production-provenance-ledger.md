...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2548 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2493 |
...
| `kernel-lean` | 34 | 20 | 2391 | kernel proof, reconstructed and checked here |
...
Of the 2548 established facts, 2444 record an
