...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2493 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2438 |
...
| `kernel-lean` | 34 | 20 | 2337 | kernel proof, reconstructed and checked here |
...
Of the 2493 established facts, 2390 record an
