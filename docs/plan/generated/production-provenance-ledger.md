...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2623 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2568 |
...
| `kernel-lean` | 34 | 20 | 2466 | kernel proof, reconstructed and checked here |
...
Of the 2623 established facts, 2519 record an
