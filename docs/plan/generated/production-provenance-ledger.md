...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2461 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2406 |
...
| `kernel-lean` | 34 | 20 | 2305 | kernel proof, reconstructed and checked here |
...
Of the 2461 established facts, 2358 record an
