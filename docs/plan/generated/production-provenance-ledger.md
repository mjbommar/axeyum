...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2668 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2613 |
...
| `kernel-lean` | 34 | 20 | 2511 | kernel proof, reconstructed and checked here |
...
Of the 2668 established facts, 2564 record an
