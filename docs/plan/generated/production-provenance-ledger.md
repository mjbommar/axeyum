...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2654 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2599 |
...
| `kernel-lean` | 34 | 20 | 2497 | kernel proof, reconstructed and checked here |
...
Of the 2654 established facts, 2550 record an
