...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2682 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2627 |
...
| `kernel-lean` | 34 | 20 | 2525 | kernel proof, reconstructed and checked here |
...
Of the 2682 established facts, 2578 record an
