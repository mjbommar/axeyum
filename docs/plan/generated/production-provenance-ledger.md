...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2474 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2419 |
...
| `kernel-lean` | 34 | 20 | 2318 | kernel proof, reconstructed and checked here |
...
Of the 2474 established facts, 2371 record an
