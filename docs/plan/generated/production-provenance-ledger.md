...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2506 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2451 |
...
| `kernel-lean` | 34 | 20 | 2350 | kernel proof, reconstructed and checked here |
...
Of the 2506 established facts, 2403 record an
