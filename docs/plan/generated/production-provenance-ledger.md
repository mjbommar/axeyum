...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2513 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2458 |
...
| `kernel-lean` | 34 | 20 | 2357 | kernel proof, reconstructed and checked here |
...
Of the 2513 established facts, 2410 record an
