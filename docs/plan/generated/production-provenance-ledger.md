...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2395 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2344 |
...
| `kernel-lean` | 30 | 20 | 2243 | kernel proof, reconstructed and checked here |
...
Of the 2395 established facts, 2292 record an
