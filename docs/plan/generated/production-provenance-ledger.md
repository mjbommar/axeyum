...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2615 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2560 |
...
| `kernel-lean` | 34 | 20 | 2458 | kernel proof, reconstructed and checked here |
...
Of the 2615 established facts, 2511 record an
