...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2545 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2490 |
...
| `kernel-lean` | 34 | 20 | 2388 | kernel proof, reconstructed and checked here |
...
Of the 2545 established facts, 2441 record an
