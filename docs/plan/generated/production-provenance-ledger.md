...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2490 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2435 |
...
| `kernel-lean` | 34 | 20 | 2334 | kernel proof, reconstructed and checked here |
...
Of the 2490 established facts, 2387 record an
