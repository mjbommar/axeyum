...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2496 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2441 |
...
| `kernel-lean` | 34 | 20 | 2340 | kernel proof, reconstructed and checked here |
...
Of the 2496 established facts, 2393 record an
