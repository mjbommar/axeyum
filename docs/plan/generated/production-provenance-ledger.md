...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2551 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2496 |
...
| `kernel-lean` | 34 | 20 | 2394 | kernel proof, reconstructed and checked here |
...
Of the 2551 established facts, 2447 record an
