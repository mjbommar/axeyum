...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2683 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2628 |
...
| `kernel-lean` | 34 | 20 | 2526 | kernel proof, reconstructed and checked here |
...
Of the 2683 established facts, 2579 record an
