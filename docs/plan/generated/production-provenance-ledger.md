...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2579 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2524 |
...
| `kernel-lean` | 34 | 20 | 2422 | kernel proof, reconstructed and checked here |
...
Of the 2579 established facts, 2475 record an
