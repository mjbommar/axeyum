...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2577 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2522 |
...
| `kernel-lean` | 34 | 20 | 2420 | kernel proof, reconstructed and checked here |
...
Of the 2577 established facts, 2473 record an
