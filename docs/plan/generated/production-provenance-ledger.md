...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2359 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2308 |
...
| `kernel-lean` | 30 | 20 | 2207 | kernel proof, reconstructed and checked here |
...
Of the 2359 established facts, 2256 record an
