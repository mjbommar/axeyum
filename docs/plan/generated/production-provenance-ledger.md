...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2590 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2535 |
...
| `kernel-lean` | 34 | 20 | 2433 | kernel proof, reconstructed and checked here |
...
Of the 2590 established facts, 2486 record an
