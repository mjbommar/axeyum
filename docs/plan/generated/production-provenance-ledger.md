...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 1732 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 1681 |
...
|---|---:|---:|---:|---|
| `cas-certificate` | 0 | 0 | 28 | computer-algebra certificate |
| `imported-kernel-lean` | 0 | 0 | 5 | kernel proof imported from an external development |
| `kernel-lean` | 30 | 20 | 1613 | kernel proof, reconstructed and checked here |
...
Of the 1732 established facts, 1662 record an
