...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2346 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2295 |
| Established facts (`proved` or `computed`) | 2347 |
| …via an operation covering **more than one** fact | **30** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2296 |
...
| `kernel-lean` | 30 | 20 | 2194 | kernel proof, reconstructed and checked here |
| `kernel-lean` | 30 | 20 | 2195 | kernel proof, reconstructed and checked here |
...
Of the 2346 established facts, 2243 record an
Of the 2347 established facts, 2244 record an
