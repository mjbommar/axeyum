...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2489 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2434 |
...
| `kernel-lean` | 34 | 20 | 2333 | kernel proof, reconstructed and checked here |
...
Of the 2489 established facts, 2386 record an
