...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2555 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2500 |
...
| `kernel-lean` | 34 | 20 | 2398 | kernel proof, reconstructed and checked here |
...
Of the 2555 established facts, 2451 record an
