...
| | |
|---|---:|
| Established facts (`proved` or `computed`) | 2512 |
| …via an operation covering **more than one** fact | **34** |
| …via a single-target operation (a capsule) | 21 |
| …with no registered operation (hand-constructed or imported) | 2457 |
...
| `kernel-lean` | 34 | 20 | 2356 | kernel proof, reconstructed and checked here |
...
Of the 2512 established facts, 2409 record an
