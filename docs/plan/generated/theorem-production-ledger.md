...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 1021 | 87 | 1021 | 0 |
| `cpoint` | 1024 | 90 | 1024 | 0 |
| `creal` | 934 | 191 | 934 | 0 |
...
| `rat` | 743 | 238 | 743 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1175** | **1175** | **1175** | **0** |

- **1175 distinct theorems**, of which **1175 rest on no assumption at all** (0 are axiom-bearing).
