...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 927 | 84 | 927 | 0 |
| `cpoint` | 932 | 89 | 932 | 0 |
| `creal` | 843 | 154 | 843 | 0 |
| `integer` | 460 | 152 | 460 | 0 |
| `logic` | 32 | 32 | 32 | 0 |
| `nat` | 308 | 276 | 308 | 0 |
| `rat` | 689 | 229 | 689 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1080** | **1080** | **1080** | **0** |

- **1080 distinct theorems**, of which **1080 rest on no assumption at all** (0 are axiom-bearing).
