...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 1044 | 87 | 1044 | 0 |
| `cpoint` | 1047 | 90 | 1047 | 0 |
| `creal` | 957 | 212 | 957 | 0 |
...
| `rat` | 745 | 240 | 745 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1198** | **1198** | **1198** | **0** |

- **1198 distinct theorems**, of which **1198 rest on no assumption at all** (0 are axiom-bearing).
