...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 1004 | 87 | 1004 | 0 |
| `cpoint` | 1007 | 90 | 1007 | 0 |
| `creal` | 917 | 185 | 917 | 0 |
| `integer` | 495 | 156 | 495 | 0 |
| `logic` | 32 | 32 | 32 | 0 |
| `nat` | 339 | 307 | 339 | 0 |
| `rat` | 732 | 237 | 732 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1158** | **1158** | **1158** | **0** |

- **1158 distinct theorems**, of which **1158 rest on no assumption at all** (0 are axiom-bearing).
