...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 1055 | 87 | 1055 | 0 |
| `cpoint` | 1058 | 90 | 1058 | 0 |
| `creal` | 968 | 221 | 968 | 0 |
...
| `rat` | 747 | 240 | 747 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1209** | **1209** | **1209** | **0** |

- **1209 distinct theorems**, of which **1209 rest on no assumption at all** (0 are axiom-bearing).
