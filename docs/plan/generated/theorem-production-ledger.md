...
|---|---:|---:|---:|---:|
| `axreal` | 13 | 0 | 13 | 0 |
| `complex` | 453 | 24 | 453 | 0 |
| `creal` | 429 | 76 | 429 | 0 |
| `integer` | 234 | 62 | 234 | 0 |
| `logic` | 13 | 13 | 13 | 0 |
| `nat` | 172 | 159 | 172 | 0 |
| `rat` | 353 | 119 | 353 | 0 |
| `string` | 17 | 4 | 17 | 0 |
| **distinct** | **457** | **457** | **457** | **0** |

- **457 distinct theorems**, of which **457 rest on no assumption at all** (0 are axiom-bearing).
...
Origin ties: 13. A tie is two preludes with identical theorem sets
