...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 938 | 84 | 938 | 0 |
| `cpoint` | 943 | 89 | 943 | 0 |
| `creal` | 854 | 157 | 854 | 0 |
| `integer` | 468 | 154 | 468 | 0 |
| `logic` | 32 | 32 | 32 | 0 |
| `nat` | 314 | 282 | 314 | 0 |
| `rat` | 697 | 229 | 697 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1091** | **1091** | **1091** | **0** |

- **1091 distinct theorems**, of which **1091 rest on no assumption at all** (0 are axiom-bearing).
