...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 929 | 84 | 929 | 0 |
| `cpoint` | 934 | 89 | 934 | 0 |
| `creal` | 845 | 154 | 845 | 0 |
| `integer` | 462 | 152 | 462 | 0 |
| `logic` | 32 | 32 | 32 | 0 |
| `nat` | 310 | 278 | 310 | 0 |
| `rat` | 691 | 229 | 691 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1082** | **1082** | **1082** | **0** |

- **1082 distinct theorems**, of which **1082 rest on no assumption at all** (0 are axiom-bearing).
