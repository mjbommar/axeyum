...
|---|---:|---:|---:|---:|
| `axreal` | 32 | 0 | 32 | 0 |
| `complex` | 971 | 84 | 971 | 0 |
| `cpoint` | 977 | 90 | 977 | 0 |
| `creal` | 887 | 177 | 887 | 0 |
| `integer` | 479 | 154 | 479 | 0 |
| `logic` | 32 | 32 | 32 | 0 |
| `nat` | 325 | 293 | 325 | 0 |
| `rat` | 710 | 231 | 710 | 0 |
| `string` | 96 | 64 | 96 | 0 |
| **distinct** | **1125** | **1125** | **1125** | **0** |

- **1125 distinct theorems**, of which **1125 rest on no assumption at all** (0 are axiom-bearing).
