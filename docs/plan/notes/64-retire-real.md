...
The decision is [ADR-0473](../../research/09-decisions/adr-0473-the-trusted-surface-is-measured-as-reached-not-only-declared.md);
...
ADR-0473 records the bounded route out of both: pin the ledger's digests onto the
