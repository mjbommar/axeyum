...
| [P5.5](P5.5-external-target.md) | A real external target, measured — T5.5.1 selects Maestro device-number encoding; capture and measurement remain | M–L | P5.1 + at least one of P5.2/P5.3 |
