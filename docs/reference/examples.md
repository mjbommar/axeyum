...
| [`geometry_probe`](../../crates/axeyum-cas/examples/geometry_probe.rs) | `[theorem-name]` | Reproduces a geometry certification, including the frontier declines — `rhombus-diagonals-perpendicular` and `euler-line` are unproved rather than unchecked, and this is how you see where they stop. |
