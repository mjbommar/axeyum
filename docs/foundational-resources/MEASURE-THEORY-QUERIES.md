...
| Integration, martingale, and hitting-time display rows | packs `finite-integration-v0`, `finite-martingales-v0`, `finite-hitting-times-v0` | `Farkas` | `checks --pack finite-integration-v0 --route Farkas --proof-status checked --text qf-lra-bad-expectation`; `checks --pack finite-martingales-v0 --route Farkas --proof-status checked`; `checks --pack finite-hitting-times-v0 --route Farkas --proof-status checked` |
