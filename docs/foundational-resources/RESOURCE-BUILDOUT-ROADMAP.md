...
17. Landed: promote `finite-product-measure-v0` through a source-linked
...
18. Landed: promote `finite-random-variables-v0` through a source-linked
...
19. Landed: promote `finite-integration-v0` through a source-linked
...
20. Landed: promote `finite-martingales-v0` through a source-linked
...
21. Landed: promote `finite-markov-chain-v0` at the solver-reuse metadata layer
...
22. Landed: revisited the library boundary decision after promoted solver-reuse
...
23. Landed: promote `finite-concentration-v0` through a source-linked
...
24. Landed: promote `finite-conditional-expectation-v0` through a source-linked
...
25. Landed: promote `finite-hitting-times-v0` through a source-linked
...
26. Landed: promote `finite-euler-method-v0` through a source-linked
...
27. Landed: promote `polynomial-identities-v0` through a source-linked
...
28. Landed: promote `finite-predicate-v0` through a source-linked Bool/CNF
...
29. Landed: promote `calculus-riemann-sum-v0` through a source-linked
...
30. Landed: promote `sequence-limit-shadow-v0` through a source-linked
...
31. Landed: promote `multivariable-calculus-rational-v0` through a
...
32. Landed: promote `calculus-algebraic-shadow-v0` through a source-linked
...
33. Landed: promote `complex-plane-transforms-v0` through a source-linked
...
34. Landed: promote `induction-obligations-v0` through a source-linked
...
35. Landed: promote `cardinality-principles-v0` through a source-linked
...
36. Landed: promote `polynomial-factorization-rational-v0` through a
...
37. Landed: promote `reals-rcf-shadow-v0` through a source-linked QF_LRA/Farkas
...
38. Landed: promote `finite-measure-v0` through a source-linked QF_LRA/Farkas
...
39. Continue proof-route promotions or consumer-query examples; revisit the
