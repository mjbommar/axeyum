...
- math example packs: 163
- learner-linked packs: 163 focused links
- packs with non-checked proof rows: 152
- non-checked proof rows: 672
...
| [QF_LRA Farkas](../proof-cookbook/recipes/qf-lra-farkas.md) | 112 | Exact rational infeasibility and linear inequality obligations. |
...
| [Lean horizon](../proof-cookbook/recipes/lean-horizon-template.md) | 133 | General theorem statements that remain outside bounded SMT replay. |
