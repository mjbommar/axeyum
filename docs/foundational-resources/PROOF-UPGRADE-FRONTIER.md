...
- math example packs: 162
- learner-linked packs: 162 focused links
- packs with non-checked proof rows: 151
- non-checked proof rows: 666
...
| [QF_LRA Farkas](../proof-cookbook/recipes/qf-lra-farkas.md) | 111 | Exact rational infeasibility and linear inequality obligations. |
...
| [Lean horizon](../proof-cookbook/recipes/lean-horizon-template.md) | 132 | General theorem statements that remain outside bounded SMT replay. |
