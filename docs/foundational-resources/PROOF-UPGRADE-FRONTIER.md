...
- math example packs: 164
- learner-linked packs: 164 focused links
- packs with non-checked proof rows: 153
- non-checked proof rows: 678
...
| [QF_LRA Farkas](../proof-cookbook/recipes/qf-lra-farkas.md) | 113 | Exact rational infeasibility and linear inequality obligations. |
...
| [Lean horizon](../proof-cookbook/recipes/lean-horizon-template.md) | 134 | General theorem statements that remain outside bounded SMT replay. |
...
- descriptive-statistics satisfiable witness rows remain finite-model replay;
  ...
  variance proof-object row now explicit as `qf-lra-bad-variance`, and
...
- [finite-random-variables-v0](../../artifacts/examples/math/finite-random-variables-v0/)
  (exact finite random-variable replay stays in the bad pushforward and
  expectation rows; resource-backed Farkas regressions now live in
...
- [finite-linear-discriminant-v0](../../artifacts/examples/math/finite-linear-discriminant-v0/)
  (source-linked Farkas regression landed for the bad Fisher direction after
  exact class-mean, within-scatter, direction, and threshold replay computes
  `wy = 3/2`)
...
- [descriptive-statistics-v0](../../artifacts/examples/math/descriptive-statistics-v0/)
  ...
  contingency-table total row; the exact-rational `qf-lra-bad-variance` row is
  covered by the QF_LRA/Farkas lane above)
