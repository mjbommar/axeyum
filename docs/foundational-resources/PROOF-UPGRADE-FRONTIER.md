...
- learner-linked packs: 161 focused links
- packs with non-checked proof rows: 150
- non-checked proof rows: 660
...
| [QF_LRA Farkas](../proof-cookbook/recipes/qf-lra-farkas.md) | 110 | Exact rational infeasibility and linear inequality obligations. |
...
| [Lean horizon](../proof-cookbook/recipes/lean-horizon-template.md) | 131 | General theorem statements that remain outside bounded SMT replay. |
