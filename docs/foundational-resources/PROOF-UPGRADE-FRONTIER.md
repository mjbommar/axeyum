...
- math example packs: 112
- learner-linked packs: 112 focused links
- packs with non-checked proof rows: 101
- non-checked proof rows: 375
...
| [QF_LRA Farkas](../proof-cookbook/recipes/qf-lra-farkas.md) | 61 | Exact rational infeasibility and linear inequality obligations. |
...
| [Lean horizon](../proof-cookbook/recipes/lean-horizon-template.md) | 82 | General theorem statements that remain outside bounded SMT replay. |
