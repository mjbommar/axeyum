...
- math example packs: 113
- learner-linked packs: 113 focused links
- packs with non-checked proof rows: 102
- non-checked proof rows: 380
...
| [Lean horizon](../proof-cookbook/recipes/lean-horizon-template.md) | 83 | General theorem statements that remain outside bounded SMT replay. |
