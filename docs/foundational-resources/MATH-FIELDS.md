...
11. `artifacts/examples/math/finite-conditional-expectation-v0/`
    ...
    - Checks: finite partition conditional expectations, law of total
      ...
      rejection.
12. `artifacts/examples/math/bounded-dynamics-v0/`
...
13. `artifacts/examples/math/finite-operator-v0/`
...
14. `artifacts/examples/math/modular-arithmetic-v0/`
...
15. `artifacts/examples/math/real-analysis-rational-v0/`
...
16. `artifacts/examples/math/complex-algebraic-v0/`
