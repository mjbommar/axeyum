...
| `graph_theory` | Graph theory | Core undergraduate / graduate combinatorics | Coloring, reachability, traversal cost counters, matching, cuts, finite flow/cut certificates, small counterexample graphs, causal d-separation | Graph minors, extremal graph theory, max-flow/min-cut theorem families, and asymptotic families are mostly proof-horizon. |
...
11. `artifacts/examples/math/finite-random-variables-v0/`
    ...
    - Checks: finite random-variable pushforwards, expectation through
      pushforward distributions, independence checks, bad pushforward replay,
      bad expectation-through-pushforward replay, and separate checked QF_LRA
      rows.
...
15. `artifacts/examples/math/finite-hitting-times-v0/`
    ...
    - Checks: finite first-hit distributions, survival probabilities,
      ...
      bad survival-mass/expected-time replay with separate checked QF_LRA rows.
...
18. `artifacts/examples/math/finite-operator-v0/`
    ...
    - Checks: finite-dimensional norm replay, matrix operator bound,
      checked QF_LRA/Farkas bad `l1` norm, bad operator-bound, and bad
      Chebyshev-prefix rejection, and Chebyshev recurrence witness.
...
28. `artifacts/examples/math/finite-order-lattices-v0/`
    ...
    - Checks: finite partial-order replay, Boolean-lattice meet/join table
      ...
      Bool/CNF bad top-element rejection, and a general order/lattice
      Lean-horizon row.
