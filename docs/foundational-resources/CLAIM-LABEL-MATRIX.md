...
```text
concept_rows=137
non_template_packs=173
checks=1131
expected_results=not-run:136,sat:581,unsat:414
proof_statuses=checked:399,lean-horizon:136,replay-only:596
solver_reuse=promoted:173
```
