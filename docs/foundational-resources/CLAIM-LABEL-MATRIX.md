...
checks=698
expected_results=not-run:73,sat:340,unsat:285
proof_statuses=checked:330,lean-horizon:73,replay-only:295
solver_reuse=non-benchmark-horizon:2,promoted:108
```
