...
```text
concept_rows=122
non_template_packs=153
checks=996
expected_results=not-run:116,sat:506,unsat:374
proof_statuses=checked:379,lean-horizon:116,replay-only:501
solver_reuse=promoted:153
```
