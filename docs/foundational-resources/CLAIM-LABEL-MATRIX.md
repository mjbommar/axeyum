...
```text
concept_rows=128
non_template_packs=164
checks=1068
expected_results=not-run:127,sat:545,unsat:396
proof_statuses=checked:390,lean-horizon:127,replay-only:551
solver_reuse=promoted:164
```
