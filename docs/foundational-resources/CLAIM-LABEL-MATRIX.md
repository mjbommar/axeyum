...
checks=703
expected_results=not-run:74,sat:342,unsat:287
proof_statuses=checked:334,lean-horizon:74,replay-only:295
solver_reuse=non-benchmark-horizon:3,promoted:108
```
