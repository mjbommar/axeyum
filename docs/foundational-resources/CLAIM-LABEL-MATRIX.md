...
```text
concept_rows=134
non_template_packs=170
checks=1110
expected_results=not-run:133,sat:569,unsat:408
proof_statuses=checked:396,lean-horizon:133,replay-only:581
solver_reuse=promoted:170
```
