...
```text
concept_rows=121
non_template_packs=114
checks=726
expected_results=not-run:77,sat:353,unsat:296
proof_statuses=checked:340,lean-horizon:77,replay-only:309
solver_reuse=promoted:114
```
