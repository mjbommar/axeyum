...
```text
concept_rows=123
non_template_packs=159
checks=1033
expected_results=not-run:122,sat:525,unsat:386
proof_statuses=checked:385,lean-horizon:122,replay-only:526
solver_reuse=promoted:159
```
