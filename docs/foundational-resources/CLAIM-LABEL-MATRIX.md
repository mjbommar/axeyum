...
```text
concept_rows=132
non_template_packs=168
checks=1096
expected_results=not-run:131,sat:561,unsat:404
proof_statuses=checked:394,lean-horizon:131,replay-only:571
solver_reuse=promoted:168
```
