...
```text
concept_rows=121
non_template_packs=115
checks=733
expected_results=not-run:78,sat:357,unsat:298
proof_statuses=checked:341,lean-horizon:78,replay-only:314
solver_reuse=promoted:115
```
