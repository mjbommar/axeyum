...
```text
concept_rows=133
non_template_packs=169
checks=1103
expected_results=not-run:132,sat:565,unsat:406
proof_statuses=checked:395,lean-horizon:132,replay-only:576
solver_reuse=promoted:169
```
