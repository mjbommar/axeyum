...
```text
concept_rows=126
non_template_packs=162
checks=1054
expected_results=not-run:125,sat:537,unsat:392
proof_statuses=checked:388,lean-horizon:125,replay-only:541
solver_reuse=promoted:162
```
