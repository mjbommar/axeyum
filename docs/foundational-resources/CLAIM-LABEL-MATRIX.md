...
```text
concept_rows=121
non_template_packs=113
checks=719
expected_results=not-run:76,sat:349,unsat:294
proof_statuses=checked:339,lean-horizon:76,replay-only:304
solver_reuse=promoted:113
```
