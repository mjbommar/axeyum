...
```text
concept_rows=127
non_template_packs=163
checks=1061
expected_results=not-run:126,sat:541,unsat:394
proof_statuses=checked:389,lean-horizon:126,replay-only:546
solver_reuse=promoted:163
```
