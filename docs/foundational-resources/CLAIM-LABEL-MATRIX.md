...
```text
concept_rows=122
non_template_packs=121
checks=777
expected_results=not-run:84,sat:383,unsat:310
proof_statuses=checked:347,lean-horizon:84,replay-only:346
solver_reuse=promoted:121
```
