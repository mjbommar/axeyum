...
```text
concept_rows=122
non_template_packs=155
checks=1008
expected_results=not-run:117,sat:509,unsat:376
proof_statuses=checked:380,lean-horizon:117,replay-only:505
solver_reuse=promoted:155
```
