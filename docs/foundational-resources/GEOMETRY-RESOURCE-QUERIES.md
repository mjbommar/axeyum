...
| Orientation/area display rows | pack `orientation-area-geometry-v0` | `Farkas` | `checks --pack orientation-area-geometry-v0 --route Farkas --proof-status checked`; `horizon-frontier --text oriented` |
...
- arbitrary affine, incidence, oriented-area, affine-volume,
  change-of-variables, projective, rigidity, circle, inversion,
