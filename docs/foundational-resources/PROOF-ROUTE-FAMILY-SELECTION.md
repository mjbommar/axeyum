...
| QF_UF/Alethe | 19 | 115 | 56 | 43 | 16 |
| Lean horizon | 78 | 487 | 215 | 201 | 71 |
...
| QF_UF/Alethe | equality-heavy finite structures and quotient maps | equivalence classes, function composition, finite homomorphisms, finite monoids/groups/actions including identity and compatibility conflicts, finite module scalar-closure membership, finite vector-space additive-closure membership, finite dual-space covector additivity, modules/tensors, continuous-map preimage membership, quotient topology representative/open conflicts, and cohomology shadows | Alethe adds value when table replay says what happened and congruence proof explains why an equality claim is impossible. | Prefer equality conflicts where table replay and congruence proof teach different things, such as algebra/topology map preservation beyond the current preimage, module/vector-space/dual-space closure or additivity, and quotient representative consistency rows. |
