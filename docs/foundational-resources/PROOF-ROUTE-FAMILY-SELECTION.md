...
| QF_LRA/Farkas | 58 | 367 | 146 | 179 | 42 |
| QF_UF/Alethe | 19 | 110 | 51 | 43 | 16 |
| Lean horizon | 78 | 479 | 207 | 201 | 71 |
...
| QF_UF/Alethe | equality-heavy finite structures and quotient maps | equivalence classes, function composition, finite homomorphisms, finite monoids/groups/actions including identity and compatibility conflicts, modules/tensors, quotient topology/cohomology shadows | Alethe adds value when table replay says what happened and congruence proof explains why an equality claim is impossible. | Prefer equality conflicts where table replay and congruence proof teach different things, such as quotient representative consistency or algebra/topology map preservation. |
