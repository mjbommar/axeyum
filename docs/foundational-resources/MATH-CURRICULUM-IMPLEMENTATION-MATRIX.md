...
119. Landed: add the finite barycentric interpolation resource.
    ...
    correctness, and numerical stability.
120. Revisit crate/repo boundaries only after three real consumers or repeated
