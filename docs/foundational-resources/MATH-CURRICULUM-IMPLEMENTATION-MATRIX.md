...
| `reals` | RCF shadow, bounded real analysis, metric continuity, finite root finding, finite separation, finite KKT, finite active-set QP, finite SDP, finite gradient descent, finite line search, finite Wolfe line search, finite projected gradient, finite proximal gradient, finite circle and inversion geometry | Add concept rows for balls, limits, continuity, compactness, root-finding, separation, KKT, active-set QP, SDP, gradient descent, line search, Wolfe line search, projected gradient, proximal gradient, finite circle/inversion geometry, and completeness/convergence/geometry-theorem horizons. | QF_LRA/Farkas for bounded bad-delta, bad-iterate, bad-separator, bad-stationarity, bad-free-gradient, bad-objective, bad-decrease, bad-Armijo, bad-Wolfe-curvature, bad-projection, bad-proximal-point, bad-radius, and bad-inverse-coordinate rows, QF_LRA/NRA for algebraic shadows; Lean horizon for completeness/general topology, separation, KKT sufficiency, active-set method theory, SDP duality, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, circle/inversion geometry, and convergence. | Each epsilon-delta/root-finding/separation/KKT/active-set/SDP/descent/line-search/Wolfe/projected/proximal-gradient/circle/inversion pack says fixed rational instance vs theorem, and metric-continuity, finite-root-finding, finite-separation, finite-KKT, finite-active-set-QP, finite-SDP, finite-gradient-descent, finite-line-search, finite-wolfe-line-search, finite-projected-gradient, finite-proximal-gradient, finite-circle-geometry, plus finite-inversion-geometry now have checked finite bad-row routes. |
...
| `polynomials` | identities, rational factorization, generating functions, finite root finding, finite circle/inversion geometry | Add coefficient-ring, polynomial-division, finite root-finding, and finite polynomial-geometry reusable rows. | Finite replay, QF_LIA/LRA coefficient constraints, QF_LRA/Farkas for linearized exact conflicts, Lean horizon for general factorization, circle/inversion geometry, and convergence. | Factorization, root-finding, circle, and inversion rows replay product, degree/leading constraints, polynomial values, exact iterates, squared radii, tangent lines, chord dot products, inverse images, and distance products. |
...
| `linear-algebra` | rational matrices, finite vector/dual/module/tensor, spectral, invariants, separation, KKT, active-set QP, SDP, gradient descent, line search, Wolfe line search, projected gradient, proximal gradient, circle tangent/chord checks, inversion vector checks | Landed matrix-computation bridge rows plus algebra-map rows for kernel/image, quotient maps, module actions, tensor bilinearity, separating-hyperplane replay, KKT stationarity replay, finite active-face stationarity/slack replay, finite SDP slack/objective replay, finite gradient-step replay, finite Armijo/Wolfe line-search replay, finite projected-gradient interval replay, finite proximal-gradient soft-threshold replay, finite circle tangent/chord dot-product replay, and finite inversion scalar-vector/determinant replay; next split dual/projection maps only when reuse demands it. | QF_LRA/Farkas, finite-field replay, QF_UF/Alethe for algebraic table conflicts. | Matrix, dot-product, stationarity, active-set QP, SDP objective, descent-step, line-search, Wolfe-line-search, projected-gradient, proximal-gradient, finite circle, and finite inversion rows can become solver regressions with source-pack back-links. |
...
| `numerical_analysis` | linear algebra, calculus | residual bounds, Euler steps, interval boxes, exact error recurrences, root-finding, active-set QP, gradient-descent, Armijo/Wolfe line-search, projected-gradient, and proximal-gradient iterations | QF_LRA, replay, numerical-honesty metadata |
...
| `geometry` | reals, polynomials, linear algebra | landed coordinate, incidence, rigid-configuration, affine, oriented-area, finite circle-geometry, and finite inversion-geometry shadows; add only distinct cyclic-configuration, angle, circle-line correspondence, or higher-degree polynomial-geometry pressure when reused | QF_LRA/NRA, replay |
...
4. R1 bridge-concept rows landed for probability/statistics finite-table
   ...
   rows now also land for coordinate/incidence/rigid/oriented/circle/inversion geometry replay and complex
...
39. `finite-inversion-geometry-v0` now links `bad-inversion-image-rejected`
    ...
    checked by the `math_resource_lra_routes` QF_LRA/Farkas regression.
40. Revisit crate/repo boundaries only after three real consumers or repeated
