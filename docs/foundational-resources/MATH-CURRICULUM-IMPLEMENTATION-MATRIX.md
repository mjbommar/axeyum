...
| `real_analysis` | rationals, reals, sequences, calculus | balls, bounded epsilon-delta, Simpson-rule quadrature, divided-difference interpolation, compactness/continuity horizons | QF_LRA/Farkas, QF_LRA/NRA, Lean horizon |
...
118. Landed: add the finite divided-differences resource.
    ...
    correctness, and numerical stability.
119. Revisit crate/repo boundaries only after three real consumers or repeated
