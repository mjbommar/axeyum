...
| `reals` | RCF shadow, bounded real analysis, metric continuity, finite Simpson quadrature, finite divided-difference and barycentric interpolation, finite-difference derivatives, finite Taylor polynomials, finite cubic Hermite interpolation, finite root finding, finite separation, finite KKT, finite active-set QP, finite SDP, finite gradient descent, finite line search, finite Wolfe line search, finite projected gradient, finite proximal gradient, finite circle, inversion, and cyclic geometry | Add concept rows for balls, limits, continuity, compactness, integration/quadrature/interpolation/finite-difference derivatives/Taylor polynomials/Hermite interpolation, root-finding, separation, KKT, active-set QP, SDP, gradient descent, line search, Wolfe line search, projected gradient, proximal gradient, finite circle/inversion/cyclic geometry, and completeness/convergence/geometry-theorem horizons. | QF_LRA/Farkas for bounded bad-delta, bad-quadrature-value, bad-interpolation-value, bad-barycentric-value, bad-finite-difference-value, bad-Taylor-value, bad-Hermite-value, bad-iterate, bad-separator, bad-stationarity, bad-complementarity, bad-free-gradient, bad-inactive-slack, bad-objective, bad-duality-gap, bad-slack-entry, bad-decrease, bad-descent-bound, bad-Armijo, bad descent-direction, bad accepted-candidate, bad-Wolfe-minimizer, bad-Wolfe-curvature, bad-projection, bad-projected-decrease, bad-proximal-point, bad-composite-decrease, bad-box-proximal-point, bad-radius, bad-line-intersection, bad-inverse-coordinate, bad-diagonal-intersection, bad-opposite-angle, and bad-Ptolemy rows, QF_LRA/NRA for algebraic shadows; Lean horizon for completeness/general topology, integration/quadrature/interpolation/Hermite/finite-difference/Taylor theory, separation, KKT sufficiency, active-set method theory, SDP duality, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, circle/inversion/cyclic geometry, and convergence. | Each epsilon-delta/integration/interpolation/Hermite/finite-difference/Taylor/root-finding/separation/KKT/active-set/SDP/descent/line-search/Wolfe/projected/proximal-gradient/circle/inversion/cyclic pack says fixed rational instance vs theorem, and metric-continuity, finite-Simpson, finite-divided-differences, finite-barycentric-interpolation, finite-difference-derivatives, finite-taylor-polynomials, finite-cubic-hermite-interpolation, finite-root-finding, finite-separation, finite-KKT, finite-active-set-QP, finite-SDP, finite-gradient-descent, finite-line-search, finite-wolfe-line-search, finite-projected-gradient, finite-proximal-gradient, finite-circle-geometry, finite-inversion-geometry, plus finite-cyclic-geometry now have checked finite bad-row routes. |
...
| `polynomials` | identities, rational factorization, generating functions, finite root finding, finite interpolation, finite-difference derivatives, finite Taylor polynomials, finite cubic Hermite interpolation, finite circle/inversion/cyclic geometry | Add coefficient-ring, polynomial-division, finite root-finding, finite interpolation/Taylor/Hermite, and finite polynomial-geometry reusable rows. | Finite replay, QF_LIA/LRA coefficient constraints, QF_LRA/Farkas for linearized exact conflicts, Lean horizon for general factorization, interpolation, Taylor/Hermite theory, circle/inversion/cyclic geometry, and convergence. | Factorization, root-finding, interpolation, finite-difference, Taylor, Hermite, circle, inversion, and cyclic rows replay product, degree/leading constraints, polynomial values, exact iterates, bisection widths, divided-difference tables, barycentric weights, derivative stencils, Taylor coefficients, Taylor remainders, Hermite endpoint value/slope rows, squared radii, tangent lines, chord dot products, inverse images, distance products, diagonal midpoints, angle dot products, and Ptolemy product sums. |
...
| `calculus` | algebraic calculus, Riemann sums, finite Simpson-rule quadrature, finite divided-difference and barycentric interpolation, finite-difference derivatives, finite Taylor polynomials, finite cubic Hermite interpolation, multivariable rational calculus, finite root finding, finite active-set QP, finite line search, finite Wolfe line search, finite projected gradient, finite proximal gradient | Add derivative/integral/quadrature/interpolation/Taylor/Hermite/convergence theorem horizon rows plus exact algebraic, quadrature, interpolation, Taylor/Hermite, and algorithm-step shadows. | LRA/NRA for polynomial shadows; QF_LRA/Farkas for bad finite quadrature, interpolation, finite-difference, Taylor, and Hermite values; Lean horizon for FTC, differentiability, Simpson/Newton-Cotes quadrature theory, interpolation theory, Taylor theorem/remainder/convergence, Hermite/spline theory, active-set/Wolfe/line-search/projected/proximal-gradient convergence, and convergence. | Calculus packs never conflate finite symbolic, quadrature, interpolation, Taylor, Hermite, or iterative replay with analytic theorem proof. |
...
123. Revisit crate/repo boundaries only after three real consumers or repeated
