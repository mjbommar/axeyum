...
| `reals` | RCF shadow, bounded real analysis, metric continuity, finite Simpson quadrature, finite divided-difference and barycentric interpolation, finite-difference derivatives, finite Taylor polynomials, finite root finding, finite separation, finite KKT, finite active-set QP, finite SDP, finite gradient descent, finite line search, finite Wolfe line search, finite projected gradient, finite proximal gradient, finite circle, inversion, and cyclic geometry | Add concept rows for balls, limits, continuity, compactness, integration/quadrature/interpolation/finite-difference derivatives/Taylor polynomials, root-finding, separation, KKT, active-set QP, SDP, gradient descent, line search, Wolfe line search, projected gradient, proximal gradient, finite circle/inversion/cyclic geometry, and completeness/convergence/geometry-theorem horizons. | QF_LRA/Farkas for bounded bad-delta, bad-quadrature-value, bad-interpolation-value, bad-barycentric-value, bad-finite-difference-value, bad-Taylor-value, bad-iterate, bad-separator, bad-stationarity, bad-complementarity, bad-free-gradient, bad-inactive-slack, bad-objective, bad-duality-gap, bad-slack-entry, bad-decrease, bad-descent-bound, bad-Armijo, bad descent-direction, bad accepted-candidate, bad-Wolfe-minimizer, bad-Wolfe-curvature, bad-projection, bad-projected-decrease, bad-proximal-point, bad-composite-decrease, bad-box-proximal-point, bad-radius, bad-line-intersection, bad-inverse-coordinate, bad-diagonal-intersection, bad-opposite-angle, and bad-Ptolemy rows, QF_LRA/NRA for algebraic shadows; Lean horizon for completeness/general topology, integration/quadrature/interpolation/finite-difference/Taylor theory, separation, KKT sufficiency, active-set method theory, SDP duality, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, circle/inversion/cyclic geometry, and convergence. | Each epsilon-delta/integration/interpolation/finite-difference/Taylor/root-finding/separation/KKT/active-set/SDP/descent/line-search/Wolfe/projected/proximal-gradient/circle/inversion/cyclic pack says fixed rational instance vs theorem, and metric-continuity, finite-Simpson, finite-divided-differences, finite-barycentric-interpolation, finite-difference-derivatives, finite-taylor-polynomials, finite-root-finding, finite-separation, finite-KKT, finite-active-set-QP, finite-SDP, finite-gradient-descent, finite-line-search, finite-wolfe-line-search, finite-projected-gradient, finite-proximal-gradient, finite-circle-geometry, finite-inversion-geometry, plus finite-cyclic-geometry now have checked finite bad-row routes. |
...
| `polynomials` | identities, rational factorization, generating functions, finite root finding, finite interpolation, finite-difference derivatives, finite Taylor polynomials, finite circle/inversion/cyclic geometry | Add coefficient-ring, polynomial-division, finite root-finding, finite interpolation/Taylor, and finite polynomial-geometry reusable rows. | Finite replay, QF_LIA/LRA coefficient constraints, QF_LRA/Farkas for linearized exact conflicts, Lean horizon for general factorization, interpolation, Taylor theory, circle/inversion/cyclic geometry, and convergence. | Factorization, root-finding, interpolation, finite-difference, Taylor, circle, inversion, and cyclic rows replay product, degree/leading constraints, polynomial values, exact iterates, bisection widths, divided-difference tables, barycentric weights, derivative stencils, Taylor coefficients, Taylor remainders, squared radii, tangent lines, chord dot products, inverse images, distance products, diagonal midpoints, angle dot products, and Ptolemy product sums. |
...
| `calculus` | algebraic calculus, Riemann sums, finite Simpson-rule quadrature, finite divided-difference and barycentric interpolation, finite-difference derivatives, finite Taylor polynomials, multivariable rational calculus, finite root finding, finite active-set QP, finite line search, finite Wolfe line search, finite projected gradient, finite proximal gradient | Add derivative/integral/quadrature/interpolation/Taylor/convergence theorem horizon rows plus exact algebraic, quadrature, interpolation, Taylor, and algorithm-step shadows. | LRA/NRA for polynomial shadows; QF_LRA/Farkas for bad finite quadrature, interpolation, finite-difference, and Taylor values; Lean horizon for FTC, differentiability, Simpson/Newton-Cotes quadrature theory, interpolation theory, Taylor theorem/remainder/convergence, active-set/Wolfe/line-search/projected/proximal-gradient convergence, and convergence. | Calculus packs never conflate finite symbolic, quadrature, interpolation, Taylor, or iterative replay with analytic theorem proof. |
...
| `real_analysis` | rationals, reals, sequences, calculus | balls, bounded epsilon-delta, Simpson-rule quadrature, divided-difference and barycentric interpolation, finite-difference derivatives, Taylor polynomials, compactness/continuity horizons | QF_LRA/Farkas, QF_LRA/NRA, Lean horizon |
...
121. Landed: add the finite Taylor polynomial resource.
    ...
    evaluation.
122. Revisit crate/repo boundaries only after three real consumers or repeated
