...
| `linear_algebra` | fields, polynomials, relations | LU exact replay plus a checked bad product-entry proof row, rank/nullity, residual, spectral, tensor and module rows | QF_LRA/Farkas, finite-field replay |
