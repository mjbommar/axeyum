...
finite error replay, explicit midpoint Runge-Kutta stage replay,
...
|---|---|---|---|
| Finite recurrences, transition steps, invariants, Euler rows, and Runge-Kutta midpoint rows | `bridge_finite_dynamics_euler_replay` | `Farkas` | `checks --concept bridge_finite_dynamics_euler_replay --route Farkas --proof-status checked` |
