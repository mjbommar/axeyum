...
| `statistics` | probability, rationals, linear algebra | `descriptive-statistics-v0`, `least-squares-regression-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0`, `finite-covariance-matrix-v0`, `finite-confusion-matrix-v0`, `finite-roc-auc-v0`, `finite-precision-recall-v0`, `finite-calibration-brier-v0`, `finite-decision-tree-gini-v0`, `finite-entropy-information-gain-v0`, `finite-k-nearest-neighbors-v0`, `finite-perceptron-v0`, contingency tables, exact small tests, ordinary and ridge regression normal equations, finite linear-discriminant/classification replay, finite classifier metrics, finite ROC/AUC ranking replay, finite precision-recall ranking replay, finite calibration/Brier scoring replay, finite decision-tree Gini split replay, finite dyadic entropy/information-gain replay, finite nearest-neighbor distance/vote replay, finite perceptron trace replay, finite stochastic-kernel checks, finite hitting-time checks, finite martingale checks, finite concentration checks, finite covariance checks, and finite random-matrix moment checks. |
...
- At least 12 validated example packs.
  Status: 170 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 170 non-template packs have at least one `checked` expected-result row.
