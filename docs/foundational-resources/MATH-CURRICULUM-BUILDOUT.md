...
| `reals` | `real_analysis`, `optimization_and_convexity` | `real-analysis-rational-v0`, `reals-rcf-shadow-v0`, `multivariable-calculus-rational-v0`, `finite-root-finding-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `finite-newton-step-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0`, `finite-circle-geometry-v0`, `finite-inversion-geometry-v0`, `finite-cyclic-geometry-v0` | Bounded rational neighborhoods, algebraic real constraints through LRA/NRA, checked QF_LRA negative-discriminant shadow, exact rational gradients, Hessian checks, finite root-finding iteration replay, finite Newton divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial and truncated-remainder replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece/knot-continuity replay, finite multivariable Newton-step Hessian-solve replay, finite separating-hyperplane replay, finite KKT stationarity/complementarity replay, finite active-set QP face/slack replay with checked inactive-slack evidence, finite SDP objective/slack/gap replay, finite gradient-descent step replay, finite Armijo line-search replay, finite Wolfe sufficient-decrease/curvature replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, finite circle point/tangent/chord/line replay, finite inversion replay, finite cyclic quadrilateral replay, and rational Ptolemy replay; completeness, interpolation uniqueness/equivalence/error/conditioning, Hermite/spline theory, finite-difference and Taylor theorem/remainder/convergence/stability, Newton convergence/globalization, separation theorems, KKT sufficiency, active-set method theory, SDP duality, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, circle/inversion/cyclic-geometry theorems, and convergence marked horizon. |
...
| `calculus` | `real_analysis`, `differential_equations_and_dynamical_systems`, `numerical_analysis` | `calculus-algebraic-shadow-v0`, `calculus-riemann-sum-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `multivariable-calculus-rational-v0`, `real-analysis-rational-v0`, `finite-root-finding-v0`, `finite-newton-step-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0` | Polynomial derivative identities, exact rational gradients/Jacobians/Hessians, finite Riemann sums, antiderivative endpoint replay, finite divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial and truncated-remainder replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece, first-derivative, and second-derivative replay, bounded epsilon-delta shadows, finite root-finding iteration replay, finite multivariable Newton-step replay, finite KKT stationarity/complementarity replay, finite active-set free-gradient and inactive-slack replay, finite gradient-descent step replay, finite Armijo/Wolfe line-search replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, and algebraic inequalities; general integration, interpolation theory/equivalence, Hermite/spline theory, finite-difference error/convergence/stability, Taylor theorem/remainder/convergence, Newton convergence/globalization, KKT sufficiency, active-set method theory, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, and convergence marked Lean-horizon. |
...
| `numerical_analysis` | linear algebra, real algebra | `numerical-linear-algebra-v0`, `finite-condition-number-v0`, `finite-schur-complement-v0`, `finite-singular-value-shadow-v0`, `finite-jordan-chain-v0`, `finite-euler-method-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, LU replay, interval bounds, exact condition-number/perturbation shadows, Schur-complement block shadows, singular-value/SVD shadows, Jordan-chain replay as exact matrix evidence, divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial/truncation replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece/knot replay, error recurrences, Jacobian/Hessian replay, Newton-step Hessian solves, and finite ODE step replay. |
...
- At least 12 validated example packs.
  Status: 153 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 153 non-template packs have at least one `checked` expected-result row.
