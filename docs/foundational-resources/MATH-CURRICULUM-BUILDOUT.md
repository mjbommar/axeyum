...
| `numerical_analysis` | linear algebra, real algebra | `numerical-linear-algebra-v0`, `finite-condition-number-v0`, `finite-euler-method-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, LU replay, interval bounds, exact condition-number/perturbation shadows, error recurrences, Jacobian/Hessian replay, Newton-step Hessian solves, and finite ODE step replay. |
...
| `functional_analysis_and_operator_theory` | linear algebra, real analysis | `finite-operator-v0`, `finite-condition-number-v0`, `inner-product-spaces-rational-v0`, `finite-chebyshev-systems-v0`, norms, inner products, exact condition-number shadows, projections, matrices as operators, Chebyshev polynomial slices, finite interpolation/sign-pattern checks, and the Chebyshev/operator learner-query index. |
