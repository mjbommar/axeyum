...
propositional truth-table replay, graph coloring, rational midpoint replay,
...
logic basics, graph coloring, graph reachability/traversal/search
runtime/matching, finite DAG d-separation, finite cut certificates, rational
arithmetic, linear algebra/optimization, probability/statistics, rational inner
