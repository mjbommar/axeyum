...
| `numerical_analysis` | linear algebra, real algebra | `numerical-linear-algebra-v0`, `finite-euler-method-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, LU replay, interval bounds, error recurrences, Jacobian/Hessian replay, Newton-step Hessian solves, and finite ODE step replay. |
...
- At least 12 validated example packs.
  Status: 116 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 116 non-template packs have at least one `checked` expected-result row.
