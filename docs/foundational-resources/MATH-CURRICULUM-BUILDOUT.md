...
- At least 12 validated example packs.
  Status: 165 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 165 non-template packs have at least one `checked` expected-result row.
