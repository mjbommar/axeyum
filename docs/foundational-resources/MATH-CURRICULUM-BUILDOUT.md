...
| `numerical_analysis` | linear algebra, real algebra | `numerical-linear-algebra-v0`, `finite-condition-number-v0`, `finite-singular-value-shadow-v0`, `finite-jordan-chain-v0`, `finite-euler-method-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, LU replay, interval bounds, exact condition-number/perturbation shadows, singular-value/SVD shadows, Jordan-chain replay as exact matrix evidence, error recurrences, Jacobian/Hessian replay, Newton-step Hessian solves, and finite ODE step replay. |
...
- At least 12 validated example packs.
  Status: 119 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 119 non-template packs have at least one `checked` expected-result row.
