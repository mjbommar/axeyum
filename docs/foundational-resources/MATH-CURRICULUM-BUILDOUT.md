...
| `numerical_analysis` | linear algebra, real algebra | `numerical-linear-algebra-v0`, `finite-condition-number-v0`, `finite-schur-complement-v0`, `finite-singular-value-shadow-v0`, `finite-jordan-chain-v0`, `finite-euler-method-v0`, `finite-simpson-rule-v0`, `finite-romberg-extrapolation-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, LU replay, interval bounds, exact condition-number/perturbation shadows, Schur-complement block shadows, singular-value/SVD shadows, Jordan-chain replay as exact matrix evidence, Simpson quadrature and Romberg extrapolation replay, divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial/truncation replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece/knot replay, error recurrences, Jacobian/Hessian replay, Newton-step Hessian solves, and finite ODE step replay. |
...
- At least 12 validated example packs.
  Status: 156 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 156 non-template packs have at least one `checked` expected-result row.
