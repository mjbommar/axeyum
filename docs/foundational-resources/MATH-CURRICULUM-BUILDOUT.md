...
| `calculus` | `real_analysis`, `differential_equations_and_dynamical_systems`, `numerical_analysis` | `calculus-algebraic-shadow-v0`, `calculus-riemann-sum-v0`, `finite-divided-differences-v0`, `multivariable-calculus-rational-v0`, `real-analysis-rational-v0`, `finite-root-finding-v0`, `finite-newton-step-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0` | Polynomial derivative identities, exact rational gradients/Jacobians/Hessians, finite Riemann sums, antiderivative endpoint replay, finite divided-difference interpolation replay, bounded epsilon-delta shadows, finite root-finding iteration replay, finite multivariable Newton-step replay, finite KKT stationarity/complementarity replay, finite active-set free-gradient and inactive-slack replay, finite gradient-descent step replay, finite Armijo/Wolfe line-search replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, and algebraic inequalities; general integration, interpolation theory, Newton convergence/globalization, KKT sufficiency, active-set method theory, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, and convergence marked Lean-horizon. |
...
- At least 12 validated example packs.
  Status: 148 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 148 non-template packs have at least one `checked` expected-result row.
