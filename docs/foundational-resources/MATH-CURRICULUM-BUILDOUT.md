...
For concrete pack-level worklists under those frontier groups, use the
[Pack Frontier Queries](PACK-FRONTIER-QUERIES.md).
...
| `rationals` | `real_analysis`, `linear_algebra` | `rationals-lra-v0`, `polynomial-factorization-rational-v0`, `finite-aitken-acceleration-v0`, `finite-steffensen-method-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0` | Exact rational order/field facts, density, trichotomy, Farkas links, rational polynomial division, GCD, factorization replay, exact sequence/fixed-point acceleration replay, exact regularized regression and finite discriminant replay, and QF_LRA conflicts for discriminants, malformed accelerated values, malformed ridge coefficients, and malformed Fisher directions. |
| `reals` | `real_analysis`, `optimization_and_convexity` | `real-analysis-rational-v0`, `reals-rcf-shadow-v0`, `multivariable-calculus-rational-v0`, `finite-root-finding-v0`, `finite-secant-method-v0`, `finite-aitken-acceleration-v0`, `finite-steffensen-method-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `finite-simpson-rule-v0`, `finite-romberg-extrapolation-v0`, `finite-newton-step-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0`, `finite-circle-geometry-v0`, `finite-inversion-geometry-v0`, `finite-cyclic-geometry-v0` | Bounded rational neighborhoods, algebraic real constraints through LRA/NRA, checked QF_LRA negative-discriminant shadow, exact rational gradients, Hessian checks, finite root-finding/secant iteration replay, finite sequence and fixed-point acceleration replay, finite regularized normal-equation and Fisher-discriminant replay, finite Newton divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial and truncated-remainder replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece/knot-continuity replay, finite Simpson quadrature replay, finite Romberg/Richardson extrapolation replay, finite multivariable Newton-step Hessian-solve replay, finite separating-hyperplane replay, finite KKT stationarity/complementarity replay, finite active-set QP face/slack replay with checked inactive-slack evidence, finite SDP objective/slack/gap replay, finite gradient-descent step replay, finite Armijo line-search replay, finite Wolfe sufficient-decrease/curvature replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, finite circle point/tangent/chord/line replay, finite inversion replay, finite cyclic quadrilateral replay, and rational Ptolemy replay; completeness, interpolation uniqueness/equivalence/error/conditioning, Hermite/spline theory, quadrature/extrapolation theory, finite-difference and Taylor theorem/remainder/convergence/stability, Newton/secant/Aitken/Steffensen convergence/globalization, ridge-regression and Fisher LDA theory, separation theorems, KKT sufficiency, active-set method theory, SDP duality, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, circle/inversion/cyclic-geometry theorems, and convergence marked horizon. |
...
| `polynomials` | `abstract_algebra`, `real_analysis`, `complex_analysis` | `polynomial-identities-v0`, `polynomial-factorization-rational-v0`, `generating-functions-v0`, `finite-root-finding-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `finite-simpson-rule-v0`, `finite-romberg-extrapolation-v0`, `finite-circle-geometry-v0`, `finite-inversion-geometry-v0`, `finite-cyclic-geometry-v0` | Fixed-degree identities, factor theorem, root witness replay, rational factor products, polynomial division, Euclidean GCD, square-free decomposition, irreducible-quadratic rejection with QF_LRA/Farkas evidence, coefficient extraction, finite convolution, exact polynomial evaluation inside bisection/Newton steps, Newton divided-difference tables, barycentric weights/node hits, finite-difference derivative stencils, Taylor coefficients, cubic Hermite endpoint value/slope constraints, natural cubic spline piece polynomials, knot-continuity constraints, truncated remainders, interpolation/Taylor/Hermite/spline-value replay, finite Simpson quadrature replay, finite Romberg polynomial-integral replay, finite circle equations/tangent/chord/line intersections, finite inversion image/distance-product replay, finite cyclic-configuration replay, and rational Ptolemy product-sum replay. |
| `sequences-and-limits` | `real_analysis`, `topology` | `sequence-limit-shadow-v0`, `bounded-monotone-sequence-v0`, `finite-recurrence-prefix-v0`, `finite-aitken-acceleration-v0`, `finite-steffensen-method-v0`, `real-analysis-rational-v0`, `generating-functions-v0` | Bounded epsilon/N and epsilon-delta templates, algebraic sequence checks, finite monotone-prefix/supremum/tail-gap replay, finite recurrence-prefix and companion-matrix replay, finite Aitken/Steffensen acceleration replay, and finite generating-function prefixes; general limits and convergence acceleration marked Lean-horizon. |
...
| `linear-algebra` | `linear_algebra`, `numerical_analysis`, `optimization_and_convexity` | `linear-algebra-rational-v0`, `finite-vector-spaces-v0`, `finite-dual-spaces-v0`, `inner-product-spaces-rational-v0`, `finite-covariance-matrix-v0`, `least-squares-regression-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0`, `finite-condition-number-v0`, `finite-schur-complement-v0`, `finite-singular-value-shadow-v0`, `finite-jordan-chain-v0`, `finite-modules-v0`, `finite-tensor-products-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0`, `finite-circle-geometry-v0`, `finite-inversion-geometry-v0`, `finite-cyclic-geometry-v0` | Fixed rational matrices, finite vector spaces and modules, finite dual spaces, covectors, annihilators, transpose maps, exact rational inner products, Gram matrices, finite covariance matrices, ordinary and ridge regression normal-equation replay, finite Fisher-discriminant within-scatter and direction replay, exact condition-number and perturbation-bound replay, Schur-complement block replay, singular-value/SVD shadow replay, Jordan-chain and nilpotent-part replay, projections, Gram-Schmidt replay, finite tensor products, bilinear maps, exact LU replay with a separate checked bad product-entry proof row, nullspace replay with checked bad component evidence, inverse checks, inconsistent systems, subspaces, linear maps, quotient modules, rank-nullity replay, Jacobians, Hessians, exact Newton-step Hessian solves, exact separating-hyperplane dot-product replay, finite KKT stationarity/complementarity replay, finite active-face stationarity and checked inactive-slack replay, finite SDP PSD/slack/objective/gap replay, finite gradient-descent matrix-step replay, finite Armijo/Wolfe line-search replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, finite circle tangent/chord/line replay, finite inversion scalar-vector/determinant replay, and finite cyclic diagonal/angle/Ptolemy product-sum replay. |
| `calculus` | `real_analysis`, `differential_equations_and_dynamical_systems`, `numerical_analysis` | `calculus-algebraic-shadow-v0`, `calculus-riemann-sum-v0`, `finite-simpson-rule-v0`, `finite-romberg-extrapolation-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `multivariable-calculus-rational-v0`, `real-analysis-rational-v0`, `finite-root-finding-v0`, `finite-newton-step-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0` | Polynomial derivative identities, exact rational gradients/Jacobians/Hessians, finite Riemann sums, finite Simpson quadrature replay, finite Romberg/Richardson extrapolation replay, antiderivative endpoint replay, finite divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial and truncated-remainder replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece, first-derivative, and second-derivative replay, bounded epsilon-delta shadows, finite root-finding iteration replay, finite multivariable Newton-step replay, finite KKT stationarity/complementarity replay, finite active-set free-gradient and inactive-slack replay, finite gradient-descent step replay, finite Armijo/Wolfe line-search replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, and algebraic inequalities; general integration, quadrature/extrapolation theory, interpolation theory/equivalence, Hermite/spline theory, finite-difference error/convergence/stability, Taylor theorem/remainder/convergence, Newton convergence/globalization, KKT sufficiency, active-set method theory, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, and convergence marked Lean-horizon. |
...
| `probability_theory` | counting, rationals, finite sets | `finite-probability-v0`, Bayes tables, finite expectations, finite random variables, finite conditional expectation, finite stochastic kernels, finite martingales, finite hitting times, finite concentration/tail bounds, product tables, exact discrete distributions, finite covariance matrices, finite classifier metrics, finite ROC/AUC score-ranking rows, finite precision-recall ranking rows, finite calibration/Brier scoring rows, finite decision-tree Gini split rows, finite dyadic entropy/information-gain rows, finite nearest-neighbor vote rows, finite perceptron training traces, finite value-iteration Bellman-backup rows, finite policy-iteration evaluation/improvement rows, finite random-matrix moment tables, and the random-matrix moment learner-query index. |
| `statistics` | probability, rationals, linear algebra | `descriptive-statistics-v0`, `least-squares-regression-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0`, `finite-covariance-matrix-v0`, `finite-confusion-matrix-v0`, `finite-roc-auc-v0`, `finite-precision-recall-v0`, `finite-calibration-brier-v0`, `finite-decision-tree-gini-v0`, `finite-entropy-information-gain-v0`, `finite-k-nearest-neighbors-v0`, `finite-perceptron-v0`, `finite-hard-margin-svm-v0`, contingency tables, exact small tests, ordinary and ridge regression normal equations, finite linear-discriminant/classification replay, finite classifier metrics, finite ROC/AUC ranking replay, finite precision-recall ranking replay, finite calibration/Brier scoring replay, finite decision-tree Gini split replay, finite dyadic entropy/information-gain replay, finite nearest-neighbor distance/vote replay, finite perceptron trace replay, finite hard-margin SVM hyperplane/KKT replay, finite stochastic-kernel checks, finite hitting-time checks, finite martingale checks, finite concentration checks, finite covariance checks, and finite random-matrix moment checks. |
| `optimization_and_convexity` | rationals, reals, linear algebra | `linear-optimization-v0`, `convexity-rational-v0`, `least-squares-regression-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0`, `finite-hard-margin-svm-v0`, LP feasibility, dual/Farkas certificates, finite convexity, ordinary and regularized least-squares objectives, finite Fisher-discriminant direction/threshold shadows, gradients, Hessian checks, Newton-step Hessian solves, threshold checks, KKT stationarity/complementarity witnesses, active-set QP witnesses including inactive-slack conflicts, SDP primal/dual slack/gap replay, finite descent-step checks, finite Armijo/Wolfe line-search replay, finite projected-gradient interval/decrease replay, finite proximal-gradient replay, finite hard-margin SVM hyperplane/KKT/duality-gap replay, finite value-iteration Bellman-backup replay, and finite policy-iteration evaluation/improvement replay. |
| `numerical_analysis` | linear algebra, real algebra | `numerical-linear-algebra-v0`, `finite-condition-number-v0`, `finite-schur-complement-v0`, `finite-singular-value-shadow-v0`, `finite-jordan-chain-v0`, `finite-ridge-regression-v0`, `finite-linear-discriminant-v0`, `finite-euler-method-v0`, `finite-simpson-rule-v0`, `finite-romberg-extrapolation-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `finite-aitken-acceleration-v0`, `finite-steffensen-method-v0`, `multivariable-calculus-rational-v0`, `finite-newton-step-v0`, LU replay, interval bounds, exact condition-number/perturbation shadows, Schur-complement block shadows, singular-value/SVD shadows, Jordan-chain replay as exact matrix evidence, regularized normal-equation and linear-discriminant shadows, Simpson quadrature and Romberg extrapolation replay, divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial/truncation replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece/knot replay, finite sequence/fixed-point acceleration replay, error recurrences, Jacobian/Hessian replay, Newton-step Hessian solves, and finite ODE step replay. |
| `differential_equations_and_dynamical_systems` | calculus, linear algebra | `bounded-dynamics-v0`, `finite-euler-method-v0`, `finite-value-iteration-v0`, `finite-policy-iteration-v0`, recurrence traces, Euler-method steps, threshold reachability, finite error replay, discounted Bellman backups, policy-evaluation solves, and invariant checks before continuous theory. |
...
| `functional_analysis_and_operator_theory` | linear algebra, real analysis | `finite-operator-v0`, `finite-condition-number-v0`, `finite-singular-value-shadow-v0`, `finite-jordan-chain-v0`, `inner-product-spaces-rational-v0`, `finite-chebyshev-systems-v0`, norms, inner products, exact condition-number and singular-value shadows, Jordan/nilpotent operator shadows, projections, matrices as operators, Chebyshev polynomial slices, finite interpolation/sign-pattern checks, and the Chebyshev/operator learner-query index. |
...
action orbit/stabilizer replay, exact bad-nonbijection replay, an explicit
QF_UF/Alethe bad-nonbijection injectivity row, and a general permutation-group
Lean-horizon row. `finite-group-actions-v0` now
...
compatibility rows, and a general group-action Lean-horizon row.
...
tail-gap replay, replay-only rejection of false upper-bound and tail-gap source
claims, separate checked QF_LRA/Farkas proof rows for those contradictions, and
a monotone-convergence Lean-horizon row.
...
distributions, finite independence checks, exact bad pushforward and
expectation replay, separate checked QF_LRA/Farkas rejection rows, and a
general random-variable/conditional expectation Lean-horizon row.
...
rows, separate checked QF_LRA/Farkas proof rows, and an ODE-theory
Lean-horizon row.
...
- At least 40 validated concept rows.
  ...
  residual bounds, eigenpair and Jordan-chain witnesses, characteristic-polynomial replay,
  ...
  finite tail/count obstructions, finite classifier metrics, finite ROC/AUC
  score-ranking replay,
...
- At least 12 validated example packs.
  Status: 173 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 173 non-template packs have at least one `checked` expected-result row.
...
pushforward, expectation, independence bridge, exact bad-row replay, and
separate checked `qf-lra-bad-pushforward` and
`qf-lra-bad-expectation-through-pushforward` rows toward probability/statistics
and measure-theory semantics.
...
It also has a focused finite Bayes-update page for the diagnostic-test
...
`calculus-riemann-sum-v0`, `finite-simpson-rule-v0`,
`finite-romberg-extrapolation-v0`, and `multivariable-calculus-rational-v0` a
focused finite/general calculus trust map. It keeps exact derivative
coefficients, fixed product-rule identity replay, tangent and critical-point
replay, finite Riemann sums, finite Simpson-rule quadrature, finite
Romberg/Richardson extrapolation, antiderivative endpoint replay,
...
explicit `qf-lra-bad-lu-product-entry` row, and malformed nullspace-component
row through source-linked checked Farkas evidence paths, while the bad LU
finite-product row remains exact replay.
...
`bounded-monotone-sequence-v0` now keeps its bad upper-bound and bad finite
tail-gap source rows as replay-only rows after exact finite-prefix replay
computes `a_6 = 6/7` and exact tail replay computes `a_2 = 2/3` with gap
excess `1/12`; separate checked `qf-lra-*` rows route the fixed scalar
contradictions through the same Farkas evidence path.
...
`finite-euler-method-v0` now keeps its bad fixed-step transition,
bad terminal-error, and bad max-error bound rows as exact replay, then routes
the separate `qf-lra-*` conflicts through source-linked checked Farkas evidence
paths after exact derivative and finite error-table replay; its metadata
promotes the explicit proof rows for solver reuse.
...
The learner/planning layer now also has
[`inversion-geometry-theorem-boundary.md`](../learn/math/inversion-geometry-theorem-boundary.md),
which expands the finite inversion-geometry row into a concrete boundary
ledger: inverse-image replay, inverse-distance-product replay, collinearity
replay, and bad inverse-coordinate/bad inverse-distance-product QF_LRA/Farkas
rows are linked to copyable queries and graduation criteria while keeping
...
Lean/theorem-horizon lanes.
The learner/planning layer now also has
[`calculus-theorem-boundary.md`](../learn/math/calculus-theorem-boundary.md),
which expands the finite calculus rows into a concrete boundary ledger:
polynomial derivative replay, product-rule replay, tangent replay, finite
Riemann-sum replay, antiderivative endpoint replay, gradient/Jacobian/Hessian
replay, and bad derivative/bad integral/bad gradient QF_LRA/Farkas rows are
linked to copyable queries and graduation criteria while keeping
differentiability, MVT, integrability, FTC, inverse/implicit-function,
change-of-variables, and manifold-calculus claims in Lean/theorem-horizon
lanes.
...
The matrix-computation layer now adds `finite-cholesky-decomposition-v0` as the
114th non-template math pack. Exact rational replay checks lower-triangular
`L`, positive diagonal entries, `L*L^T = A`, and two-by-two leading principal
minors, while a source-linked QF_LRA/Farkas artifact rejects the malformed
bottom-right product-entry claim `9` against the exact value `10`. Cholesky
existence, algorithm correctness, conditioning, and floating-point stability
stay in theorem or numerical-honesty lanes.
The statistics/probability/linear-algebra layer now adds
`finite-covariance-matrix-v0` as the 115th non-template math pack. Exact
finite-sample replay computes the mean vector `[7/3, 2/3]`, centered rows,
centered Gram matrix `[[14/3, 4/3], [4/3, 2/3]]`, covariance matrix
`[[14/9, 4/9], [4/9, 2/9]]`, and two-by-two positive-semidefinite shadow,
while a source-linked QF_LRA/Farkas artifact rejects the malformed
off-diagonal covariance claim `1/2` against the exact value `4/9`. General
covariance-estimator consistency, PCA theorem claims, random-matrix
asymptotics, and floating-point covariance algorithms stay in theorem or
numerical-honesty lanes.
The calculus/linear-algebra/optimization layer now adds
`finite-newton-step-v0` as the 116th non-template math pack. Exact rational
replay differentiates
`f(x,y) = x^2 + x*y + 2*y^2 - 4*x - 6*y`, checks Hessian minors `2` and `7`,
solves the Newton system `[[2,1],[1,4]] * d = [4,6]`, computes
`d = [10/7,8/7]`, verifies stationarity at the next point, and records
objective decrease `44/7`. A source-linked QF_LRA/Farkas artifact rejects the
malformed next-coordinate claim `3/2` against the exact value `10/7`. Newton
convergence, globalization, trust-region methods, conditioning, and
floating-point Newton algorithms stay in theorem or numerical-honesty lanes.
The linear-algebra/numerical-analysis/operator layer now adds
`finite-condition-number-v0` as the 117th non-template math pack. Exact
rational replay checks a diagonal matrix inverse, infinity norms,
`kappa_infinity(A) = 6`, and a saturating perturbation-bound row. A
source-linked QF_LRA/Farkas artifact rejects the malformed upper-bound claim
...
numerical-honesty lanes.
The linear-algebra/numerical-analysis/operator layer now adds
`finite-jordan-chain-v0` as the 119th non-template math pack. Exact rational
replay checks one non-diagonal Jordan block, `A*v1 = 2*v1`, `N*v2 = v1`,
`N^2 = 0`, and `P*J*P^-1 = A`. A source-linked QF_LRA/Farkas artifact rejects
the malformed nilpotent-component claim. Jordan normal form,
diagonalizability criteria, algebraic/geometric multiplicity theorems, and
numerical eigensolver behavior stay in theorem or numerical-honesty lanes.
The linear-algebra/numerical-analysis/optimization/statistics layer now adds
`finite-schur-complement-v0` as the 120th non-template math pack. Exact
rational replay checks one block split of `A = [[4,2],[2,3]]`, computes
`S = D - C*B^-1*C^T = 2`, checks determinant factorization, a two-sided
inverse, positive-definite and conditional-variance shadows, and uses a
source-linked QF_LRA/Farkas artifact to reject the malformed scalar claim
...
numerical-honesty lanes.
The linear-algebra/numerical-analysis layer now adds
`finite-pivoted-lu-decomposition-v0` as the 130th non-template math pack. Exact
rational replay checks the row-swap permutation
`P = [[0,1],[1,0]]`, `P*A = [[3,4],[1,2]]`,
`L = [[1,0],[1/3,1]]`, `U = [[3,4],[0,2/3]]`,
determinant-sign accounting `det(P) * det(A) = product(pivots) = 2`,
triangular solve replay for `b = [3,7]`, and the solution `[1,1]`, while a
...
`finite-runge-kutta-midpoint-v0` as the 141st non-template math pack. Exact
rational replay checks `y' = 2t`, `y(0)=0`, `h=1/2`, midpoint stages,
states `[0, 1/4, 1, 9/4]`, the exact solution at those times, and a zero
absolute-error table, while a source-linked QF_LRA/Farkas artifact rejects the
...
The differential-equations/numerical-analysis/real-analysis layer now adds
`finite-crank-nicolson-method-v0` as the 144th non-template math pack. Exact
rational replay checks `y' = -y`, `y(0)=1`, `h=1/2`, start derivatives,
endpoint derivatives, averaged slopes, zero implicit residuals, geometric
decay ratio `3/5`, and states `[1, 3/5, 9/25, 27/125]`, while a source-linked
QF_LRA/Farkas artifact rejects the malformed first-step claim `1/2` against
exact `3/5`. General Crank-Nicolson order, convergence, A-stability,
stiffness behavior, nonlinear endpoint solves, adaptive-step control,
floating-point time-stepping, and PDE theory stay in future Lean/theorem or
numerical-honesty lanes.
The differential-equations/numerical-analysis/real-analysis layer now adds
`finite-adams-bashforth-method-v0` as the 145th non-template math pack. Exact
rational replay checks `y' = 2t`, `y(0)=0`, `h=1/2`, exact starter
`y_1=1/4`, derivative history, Adams-Bashforth slopes `[3/2, 5/2]`, states
`[0, 1/4, 1, 9/4]`, the exact solution at those times, and a zero
absolute-error table, while a source-linked QF_LRA/Farkas artifact rejects the
malformed first multistep claim `3/4` against exact `1`. General
...
The real-analysis/numerical-analysis layer now adds
`finite-divided-differences-v0` as the 148th non-template math pack. Exact
rational replay checks Newton divided-difference tables, Newton coefficients,
basis products, terms, and interpolation values for `1+x^2` at nodes
`0,1,2` and `x^3` at nodes `0,1,2,3`, while a source-linked QF_LRA/Farkas
artifact rejects the malformed interpolation claim `9` against exact `10`.
General interpolation uniqueness, divided-difference identities, error
estimates, node-choice conditioning, spline theory, floating-point
interpolation correctness, and numerical stability stay in future
Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-barycentric-interpolation-v0` as the 149th non-template math pack.
Exact rational replay checks barycentric weights, regular numerator and
denominator terms, interpolation values, and explicit node-hit behavior for
linear and quadratic polynomial rows, while a source-linked QF_LRA/Farkas
artifact rejects the malformed barycentric claim `5` against exact `4`.
General barycentric/Lagrange/Newton equivalence, interpolation uniqueness,
error estimates, node-choice conditioning, Runge phenomena, spline theory,
floating-point interpolation correctness, and numerical stability stay in
future Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-difference-derivatives-v0` as the 150th non-template math pack. Exact
rational replay checks forward first-difference, central first-difference, and
central second-difference derivative stencils for fixed polynomial rows, while
a source-linked QF_LRA/Farkas artifact rejects the malformed
finite-difference claim `5` against exact `4`. General finite-difference
stencil exactness classes, Taylor truncation-error bounds, convergence order,
stability, boundary-condition handling, PDE discretization correctness,
automatic-differentiation behavior, and floating-point derivative accuracy
stay in future Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-taylor-polynomials-v0` as the 151st non-template math pack. Exact
rational replay checks symbolic derivative values, factorial divisors, Taylor
coefficients, basis powers, Taylor values, polynomial values, and one explicit
truncated linearization remainder for fixed quadratic and cubic polynomial
rows, while a source-linked QF_LRA/Farkas artifact rejects the malformed
Taylor-value claim `6` against exact `25/4`. General Taylor theorem
hypotheses, Lagrange/integral/Peano/asymptotic remainder formulas, analytic
convergence, radius of convergence, multivariable Taylor theory, and
floating-point Taylor evaluation stay in future Lean/theorem or
numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-cubic-hermite-interpolation-v0` as the 152nd non-template math pack.
Exact rational replay checks endpoint values, endpoint slopes, normalized
parameters, cubic Hermite basis values, interval-length scaled derivative
terms, Hermite values, and polynomial values for smoothstep, unit-interval
quadratic, and nonunit-interval quadratic rows, while a source-linked
QF_LRA/Farkas artifact rejects the malformed Hermite-value claim `2` against
exact `7/4`. General Hermite interpolation uniqueness, divided-difference
equivalence, error estimates, spline assembly/smoothness, monotonicity,
shape-preservation guarantees, and floating-point Hermite evaluation stay in
future Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-cubic-spline-interpolation-v0` as the 153rd non-template math pack.
Exact rational replay checks a two-interval natural cubic spline through knots
`0, 1, 2` with values `0, 1, 0`: it validates each cubic piece, sample values,
C1/C2 continuity at the interior knot, natural endpoint second derivatives,
midpoint values `11/16`, and a source-linked QF_LRA/Farkas artifact rejecting
the malformed spline-value claim `3/4` against exact `11/16`. General spline
existence and uniqueness, interpolation error, convergence and stability,
knot-selection theory, shape preservation, and floating-point spline
evaluation stay in future Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-romberg-extrapolation-v0` as the 154th non-template math pack. Exact
rational replay checks one-step Romberg/Richardson extrapolation from
one-panel and two-panel composite trapezoid values for `x^2` and `x^4` on
`[0, 1]`, records the quadratic error-cancellation row and quartic residual,
and promotes the malformed extrapolated-value claim `1/4` through a
source-linked QF_LRA/Farkas artifact against exact `1/3`. General
...
Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-aitken-acceleration-v0` as the 156th non-template math pack. Exact
rational replay checks Aitken's delta-squared transform on fixed sequence
triples: `[2, 3/2, 5/4]` accelerates to exact `1`, `[2, 3/2, 4/3]`
accelerates to exact `5/4`, and the fixed residual improves from `1/3` to
`1/4`. A source-linked QF_LRA/Farkas artifact rejects the malformed
accelerated-value claim `3/2` against exact `1`. General convergence
acceleration, nonzero-denominator preconditions, fixed-point acceleration
theory, floating-point implementation correctness, and numerical stability
stay in future Lean/theorem or numerical-honesty lanes.
The real-analysis/numerical-analysis layer now adds
`finite-steffensen-method-v0` as the 157th non-template math pack. Exact
rational replay checks Steffensen fixed-point acceleration on two affine rows:
`g(x) = (x + 1)/2` from `x0 = 0` accelerates to exact `1`, and
`g(x) = 1 + (x - 1)/3` from `x0 = 4` also accelerates to exact `1`. The pack
also checks the fixed half-step residual improvement `0 < 1/8`. A
source-linked QF_LRA/Farkas artifact rejects the malformed accelerated-value
claim `3/2` against exact `1`. General fixed-point existence, Steffensen
convergence, convergence-order improvement, nonzero-denominator preconditions,
nonlinear-map behavior, floating-point implementation correctness, and
numerical stability stay in future Lean/theorem or numerical-honesty lanes.
The statistics/linear-algebra/optimization/numerical-analysis layer now adds
`finite-ridge-regression-v0` as the 158th non-template math pack. Exact
rational replay checks a fixed three-row design matrix with `lambda = 1`:
the regularized normal matrix `X^T X + I`, ridge coefficients
`[4/5, 19/15]`, fitted values, residuals, RSS, coefficient penalty,
regularized objective, coefficient shrinkage against ordinary least squares,
and the ridge-objective improvement all validate over exact rationals. A
source-linked QF_LRA/Farkas artifact rejects the malformed regularized
coefficient claim `beta0 = 1` against exact `4/5`. General ridge optimality,
regularization paths, model selection, cross-validation, statistical
guarantees, rank-deficient generality, floating-point linear algebra, and
numerical stability stay in future Lean/theorem or numerical-honesty lanes.
The statistics/linear-algebra/optimization/numerical-analysis layer now adds
`finite-linear-discriminant-v0` as the 159th non-template math pack. Exact
rational replay checks two fixed rational classes, class means, centered rows,
within-class scatter, the Fisher direction `[0, 3/2]`, projected scores,
midpoint threshold `9/4`, finite training margins, and the finite Fisher ratio.
A source-linked QF_LRA/Farkas artifact rejects the malformed direction claim
`wy = 1` against exact `3/2`. General Fisher LDA optimality, Gaussian
...
in future Lean/theorem or numerical-honesty lanes.
The statistics/probability layer now adds `finite-roc-auc-v0` as the 164th
non-template math pack. Exact rational replay checks a six-row scored
classifier table, descending score order, class totals, the `score >= 7/10`
threshold operating point, TPR/FPR/precision/specificity rates, the ROC
staircase, pairwise AUC, and trapezoid area. A source-linked QF_LRA/Farkas
artifact rejects the malformed AUC claim `3/4` against exact `2/3`. Threshold
policy, calibration, confidence intervals, general tie conventions,
continuous score-distribution theory, floating-point classifier-metric
behavior, and statistical generalization stay in future Lean/theorem or
numerical-honesty lanes.
The statistics/probability layer now adds `finite-precision-recall-v0` as the
165th non-template math pack. Exact rational replay checks a six-row scored
classifier table, descending score order, class totals, the `score >= 7/10`
threshold precision/recall/F1 point, the precision-recall curve, and average
precision `34/45`. A source-linked QF_LRA/Farkas artifact rejects the
malformed average-precision claim `3/4` against exact `34/45`. Threshold
policy, calibration, confidence intervals, general tie/interpolation
conventions, continuous score-distribution theory, floating-point
classifier-metric behavior, and statistical generalization stay in future
Lean/theorem or numerical-honesty lanes.
The statistics/probability layer now adds `finite-calibration-brier-v0` as the
166th non-template math pack. Exact rational replay checks a six-row
probability-forecast table, class totals, fixed two-bin calibration summaries,
expected calibration error `1/10`, and Brier score `71/300`. A source-linked
QF_LRA/Farkas artifact rejects the malformed Brier-score claim `1/5` against
exact `71/300`. Binning-policy optimality, model calibration,
proper-scoring-rule theorems, confidence intervals, continuous
score-distribution theory, floating-point classifier behavior, and
statistical generalization stay in future Lean/theorem or numerical-honesty
lanes.
The statistics/probability layer now adds `finite-decision-tree-gini-v0` as
the 167th non-template math pack. Exact rational replay checks an eight-row
binary-feature training table, class totals, root Gini impurity `1/2`, the
`color` split weighted impurity `3/8`, the `shape` split weighted impurity
`1/2`, and the best-split comparison. A source-linked QF_LRA/Farkas artifact
rejects the malformed weighted-Gini claim `1/2` against exact `3/8`. Greedy
tree optimality, pruning, threshold policy, entropy/information-gain
splitting, statistical generalization, continuous feature thresholds, and
floating-point tree-training behavior stay in future Lean/theorem or
numerical-honesty lanes.
The statistics/probability layer now adds `finite-entropy-information-gain-v0`
as the 168th non-template math pack. Exact rational replay checks an
eight-row training table whose root and split nodes all have class
proportions in `{0, 1/2, 1}`, so every `log2` value is an integer and every
entropy is an exact rational number of bits: root entropy `1`, the `color`
split weighted entropy `1/2` with information gain `1/2`, the `shape` split
weighted entropy `1` with gain `0`, and the best-split comparison. A
source-linked QF_LRA/Farkas artifact rejects the malformed weighted-entropy
claim `3/4` against exact `1/2`. Entropy at non-dyadic proportions, log-loss
and mutual-information variants, greedy information-gain optimality, pruning,
threshold policy, statistical generalization, continuous feature thresholds,
and floating-point logarithm or tree-training behavior stay in future
Lean/theorem or numerical-honesty lanes.
The statistics/probability layer now adds `finite-k-nearest-neighbors-v0` as
the 169th non-template math pack. Exact rational replay checks a six-point
two-class training set with two rational queries and `k = 3`: every squared
Euclidean distance (squaring keeps the arithmetic rational while preserving
the neighbor ranking), strict rank gaps `2 < 18` and `5 < 13` between the
k-th and (k+1)-th distances so no tie policy is needed, neighbor sets, and
`3-0` majority votes for `positive` and `negative`. A source-linked
QF_LRA/Farkas artifact rejects the malformed squared-distance claim `16`
against exact `18`. Nearest-neighbor consistency, Bayes-risk bounds,
curse-of-dimensionality behavior, metric/weighting/tie policy, choice of
`k`, statistical generalization, continuous feature spaces, and
floating-point distance behavior stay in future Lean/theorem or
numerical-honesty lanes.
The statistics/probability/linear-algebra layer now adds
`finite-perceptron-v0` as the 170th non-template math pack. Exact integer
replay checks a four-point linearly separable training set in augmented
coordinates trained from the zero weight vector: every presented dot-product
score, the mistake condition `y*(w.x) <= 0`, the two mistake updates ending
at weights `(-1, 3, 0)`, and a strict-margin convergence pass with functional
margins `5, 5, 7, 7`. A source-linked QF_LRA/Farkas artifact rejects the
malformed first-weight-coordinate claim `1` against exact `-1`. The Novikoff
mistake bound, convergence theorems, geometric-margin theory (which divides
by an irrational norm), averaged/voted/kernel and non-separable variants,
learning-rate policy, statistical generalization, and floating-point training
behavior stay in future Lean/theorem or numerical-honesty lanes.
The statistics/optimization/linear-algebra layer now adds
`finite-hard-margin-svm-v0` as the 171st non-template math pack. Exact
rational replay checks a six-point linearly separable training set with the
committed maximum-margin hyperplane `w = (1/2, 1/2)`, `b = -1`: every
functional margin `1, 1, 2, 3/2, 2, 2` with the support vectors exactly on
the margin, the KKT stationarity, multiplier-balance, and
complementary-slackness identities, and the zero primal-dual objective gap
`1/4 = 1/4`. A source-linked QF_LRA/Farkas artifact rejects the malformed
maximum-margin bias claim `-1/2` against exact `-1`. Strong duality and KKT
sufficiency theorems, maximum-margin optimality and uniqueness,
geometric-margin theory (which divides by an irrational norm),
soft-margin/hinge-loss and kernel variants, SMO/working-set solver behavior,
statistical generalization, and floating-point training behavior stay in
future Lean/theorem or numerical-honesty lanes.
The probability/dynamics/optimization layer now adds
`finite-value-iteration-v0` as the 172nd non-template math pack. Exact
rational replay checks a fixed three-state, two-action discounted MDP with
`gamma = 1/2` iterated from the zero value vector: every Bellman backup
`Q(s, a) = r + gamma * P . V` and greedy maximum across three iterations, a
greedy-policy switch at `s1` from the myopic to the far-sighted action, the
exact Bellman fixed point `(5/2, 3, 0)` reproduced by a full backup, and the
sup-norm contraction steps `3, 1/2, 0`. A source-linked QF_LRA/Farkas
artifact rejects the malformed Bellman-backup claim `2` against exact `5/2`.
The Banach fixed-point theorem, value-iteration and policy-iteration
convergence in general, uniqueness and optimality of the fixed point,
infinite-horizon/average-reward and continuous MDP theory, stochastic
approximation/Q-learning, and floating-point dynamic programming stay in
future Lean/theorem or numerical-honesty lanes.
The probability/dynamics/optimization layer now adds
`finite-policy-iteration-v0` as the 173rd non-template math pack. Exact
rational replay checks a complete policy-iteration trace on the same fixed
three-state MDP as `finite-value-iteration-v0`: exact zero-residual
policy-evaluation linear solves `(2, 2/3, 0)`, `(2, 3, 0)`, `(5/2, 3, 0)`
for the three committed policies (the first needs a genuine solve because
`s2` feeds back into `s1` and `s2`), two greedy improvement rounds,
termination by policy stability at `(a, a, a)`, and componentwise monotone
value improvement ending at the shared exact optimum. A source-linked
QF_LRA/Farkas artifact rejects the malformed policy-evaluation claim `1/2`
against exact `2/3`. The policy-improvement theorem in general,
policy-iteration termination and optimality, modified/asynchronous variants,
average-reward and continuous MDP theory, the LP formulation, stochastic
approximation/Q-learning, and floating-point dynamic programming stay in
future Lean/theorem or numerical-honesty lanes.
