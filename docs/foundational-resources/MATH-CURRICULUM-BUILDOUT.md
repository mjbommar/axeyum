...
7. `coordinate-geometry-v0`, `incidence-geometry-v0`,
   ...
   `orientation-area-geometry-v0`, `finite-circle-geometry-v0`, and
...
equations, plus coordinate/incidence/rigid/affine/oriented/circle/inversion
...
- At least 40 validated concept rows.
  ...
  finite group actions, coordinate/incidence/rigid/oriented/circle/inversion geometry replay,
...
- At least 12 validated example packs.
  Status: 101 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 101 non-template packs have at least one `checked` expected-result row.
...
`rigid-configuration-geometry-v0`, `affine-geometry-v0`,
`orientation-area-geometry-v0`, `finite-circle-geometry-v0`, and
`finite-inversion-geometry-v0` now have
...
unit-circle inversion replay, inverse-distance products, inversion
collinearity, checked QF_LRA/Farkas bad squared-distance, checked QF_LRA/Farkas bad incidence,
...
QF_LRA/Farkas bad-radius, checked QF_LRA/Farkas bad inverse-coordinate, and
