...
| `rationals` | `real_analysis`, `linear_algebra` | `rationals-lra-v0`, `polynomial-factorization-rational-v0`, `finite-aitken-acceleration-v0`, `finite-steffensen-method-v0`, `finite-ridge-regression-v0` | Exact rational order/field facts, density, trichotomy, Farkas links, rational polynomial division, GCD, factorization replay, exact sequence/fixed-point acceleration replay, exact regularized regression replay, and QF_LRA conflicts for discriminants, malformed accelerated values, and malformed ridge coefficients. |
| `reals` | `real_analysis`, `optimization_and_convexity` | `real-analysis-rational-v0`, `reals-rcf-shadow-v0`, `multivariable-calculus-rational-v0`, `finite-root-finding-v0`, `finite-secant-method-v0`, `finite-aitken-acceleration-v0`, `finite-steffensen-method-v0`, `finite-ridge-regression-v0`, `finite-divided-differences-v0`, `finite-barycentric-interpolation-v0`, `finite-difference-derivatives-v0`, `finite-taylor-polynomials-v0`, `finite-cubic-hermite-interpolation-v0`, `finite-cubic-spline-interpolation-v0`, `finite-simpson-rule-v0`, `finite-romberg-extrapolation-v0`, `finite-newton-step-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-active-set-qp-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-wolfe-line-search-v0`, `finite-projected-gradient-v0`, `finite-proximal-gradient-v0`, `finite-circle-geometry-v0`, `finite-inversion-geometry-v0`, `finite-cyclic-geometry-v0` | Bounded rational neighborhoods, algebraic real constraints through LRA/NRA, checked QF_LRA negative-discriminant shadow, exact rational gradients, Hessian checks, finite root-finding/secant iteration replay, finite sequence and fixed-point acceleration replay, finite regularized normal-equation replay, finite Newton divided-difference and barycentric interpolation replay, finite-difference derivative stencil replay, finite Taylor polynomial and truncated-remainder replay, finite cubic Hermite endpoint value/slope replay, finite natural cubic spline piece/knot-continuity replay, finite Simpson quadrature replay, finite Romberg/Richardson extrapolation replay, finite multivariable Newton-step Hessian-solve replay, finite separating-hyperplane replay, finite KKT stationarity/complementarity replay, finite active-set QP face/slack replay with checked inactive-slack evidence, finite SDP objective/slack/gap replay, finite gradient-descent step replay, finite Armijo line-search replay, finite Wolfe sufficient-decrease/curvature replay, finite projected-gradient interval/decrease replay, finite proximal-gradient soft-threshold/composite-decrease and box-plus-L1 replay, finite circle point/tangent/chord/line replay, finite inversion replay, finite cyclic quadrilateral replay, and rational Ptolemy replay; completeness, interpolation uniqueness/equivalence/error/conditioning, Hermite/spline theory, quadrature/extrapolation theory, finite-difference and Taylor theorem/remainder/convergence/stability, Newton/secant/Aitken/Steffensen convergence/globalization, ridge-regression theory, separation theorems, KKT sufficiency, active-set method theory, SDP duality, descent-rate, Wolfe/line-search/projected/proximal-gradient convergence, circle/inversion/cyclic-geometry theorems, and convergence marked horizon. |
...
- At least 12 validated example packs.
  Status: 158 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 158 non-template packs have at least one `checked` expected-result row.
