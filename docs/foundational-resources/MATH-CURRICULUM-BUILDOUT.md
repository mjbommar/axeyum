...
| `reals` | `real_analysis`, `optimization_and_convexity` | `real-analysis-rational-v0`, `reals-rcf-shadow-v0`, `multivariable-calculus-rational-v0`, `finite-root-finding-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-projected-gradient-v0` | Bounded rational neighborhoods, algebraic real constraints through LRA/NRA, checked QF_LRA negative-discriminant shadow, exact rational gradients, Hessian checks, finite root-finding iteration replay, finite separating-hyperplane replay, finite KKT stationarity replay, finite SDP objective/slack replay, finite gradient-descent step replay, finite Armijo line-search replay, and finite projected-gradient interval replay; completeness, separation theorems, KKT sufficiency, SDP duality, descent-rate, line-search/projected-gradient convergence, and convergence marked horizon. |
...
| `linear-algebra` | `linear_algebra`, `numerical_analysis`, `optimization_and_convexity` | `linear-algebra-rational-v0`, `finite-vector-spaces-v0`, `finite-dual-spaces-v0`, `inner-product-spaces-rational-v0`, `finite-modules-v0`, `finite-tensor-products-v0`, `multivariable-calculus-rational-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-projected-gradient-v0` | Fixed rational matrices, finite vector spaces and modules, finite dual spaces, covectors, annihilators, transpose maps, exact rational inner products, Gram matrices, projections, Gram-Schmidt replay, finite tensor products, bilinear maps, LU replay, inverse checks, inconsistent systems, subspaces, linear maps, quotient modules, rank-nullity replay, Jacobians, Hessians, exact separating-hyperplane dot-product replay, finite KKT stationarity/complementarity replay, finite SDP PSD/slack/objective replay, finite gradient-descent matrix-step replay, finite Armijo line-search replay, and finite projected-gradient interval replay. |
| `calculus` | `real_analysis`, `differential_equations_and_dynamical_systems`, `numerical_analysis` | `calculus-algebraic-shadow-v0`, `calculus-riemann-sum-v0`, `multivariable-calculus-rational-v0`, `real-analysis-rational-v0`, `finite-root-finding-v0`, `finite-kkt-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-projected-gradient-v0` | Polynomial derivative identities, exact rational gradients/Jacobians/Hessians, finite Riemann sums, antiderivative endpoint replay, bounded epsilon-delta shadows, finite root-finding iteration replay, finite KKT stationarity replay, finite gradient-descent step replay, finite Armijo line-search replay, finite projected-gradient interval replay, and algebraic inequalities; general integration, KKT sufficiency, descent-rate, line-search/projected-gradient convergence, and convergence marked Lean-horizon. |
...
| `optimization_and_convexity` | rationals, reals, linear algebra | `linear-optimization-v0`, `convexity-rational-v0`, `multivariable-calculus-rational-v0`, `finite-separation-v0`, `finite-kkt-v0`, `finite-sdp-v0`, `finite-gradient-descent-v0`, `finite-line-search-v0`, `finite-projected-gradient-v0`, LP feasibility, dual/Farkas certificates, finite convexity, gradients, Hessian checks, threshold checks, KKT witnesses, SDP primal/dual slack replay, finite descent-step checks, finite Armijo line-search replay, and finite projected-gradient replay. |
...
rejection of a false Armijo acceptance claim, and a general line-search
...
replay, trace/objective arithmetic, dual-slack matrix replay, checked
QF_LRA/Farkas rejection of a false objective claim, and an SDP-duality
Lean-horizon row.
...
Armijo acceptance claim, and a line-search convergence Lean-horizon row.
...
35. `finite-kkt-v0`: exact constrained-quadratic grid replay, stationarity,
    ...
    remain horizon claims.
36. `finite-sdp-v0`: exact two-by-two PSD replay, trace/objective arithmetic,
    dual-slack matrix replay, zero duality-gap checking, and checked
    QF_LRA/Farkas bad-objective rejection, while general SDP duality and
    convergence theorems remain horizon claims.
37. `finite-gradient-descent-v0`: exact quadratic gradient replay, descent-step
    ...
    convergence theorems remain horizon claims.
38. `finite-line-search-v0`: exact Armijo descent-direction replay, trial-step
    rejection, accepted-backtrack replay, and checked QF_LRA/Farkas bad-Armijo
    rejection, while Wolfe conditions, projected/stochastic line search, and
    convergence theorems remain horizon claims.
39. `finite-projected-gradient-v0`: exact gradient replay, unconstrained-step
    ...
    projected-gradient convergence theorems remain horizon claims.
...
- At least 12 validated example packs.
  Status: 96 non-template math example packs validate.
- At least 6 packs with checked proof/evidence routes.
  Status: 96 non-template packs have at least one `checked` expected-result row.
...
PSD replay, trace/objective arithmetic, dual-slack matrix replay, checked
bad-objective rejection with QF_LRA/Farkas evidence, and the general SDP-duality
Lean horizon.
...
and the general projected-gradient convergence Lean horizon.
...
gradient/Hessian replay, KKT stationarity replay, finite SDP objective/slack
replay, finite gradient-descent replay, finite line-search replay, residual
bounds, finite projected-gradient replay, and matrix witnesses stay visible
through the public JSON boundary without promoting duality, KKT sufficiency,
SDP strong duality, gradient-descent, line-search, or projected-gradient
