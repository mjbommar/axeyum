...
- 121 atlas rows generated from curriculum, field data, 75 R1 bridge
  ...
  example families.
- 109 non-template math example packs, plus the validating template pack.
...
- [Learner Coverage Audit](LEARNER-COVERAGE-AUDIT.md), which records that all
  109 current non-template math packs are focused-lesson linked with no
...
15. Add QF_UF/Alethe upgrade rows for equivalence, function, and finite algebra
   ...
   decision. The curriculum-pressure view now groups the 109 non-template packs
