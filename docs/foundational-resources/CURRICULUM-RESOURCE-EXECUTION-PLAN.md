...
- 122 atlas rows generated from curriculum, field data, 76 R1 bridge
  ...
  example families.
- 155 non-template math example packs, plus the validating template pack.
...
- [Learner Coverage Audit](LEARNER-COVERAGE-AUDIT.md), which records that all
  155 current non-template math packs are focused-lesson linked with no
...
15. Add QF_UF/Alethe upgrade rows for equivalence, function, and finite algebra
   ...
   decision. The curriculum-pressure view now groups the 155 non-template packs
