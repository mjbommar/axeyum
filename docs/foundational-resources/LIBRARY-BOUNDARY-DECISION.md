...
|---|---|
| At least 40 validated concept rows | 111 atlas rows: 23 curriculum rows, 18 field rows, 65 bridge-concept rows, and 5 example-family rows. |
...
- `checked`: 232 expected-result rows
