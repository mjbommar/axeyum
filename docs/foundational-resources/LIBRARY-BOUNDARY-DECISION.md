...
Reviewed: 2026-06-30; counts refreshed after 60 promoted solver-reuse packs.
...
| At least one consumer can read promoted solver-reuse rows | `scripts/query-foundational-resources.py packs --solver-reuse promoted --require-any` is part of `scripts/check-foundational-resources.sh` and currently finds 60 promoted packs. |
...
- `solver_reuse`: 60 promoted packs and 24 unclassified packs
