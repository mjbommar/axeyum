...
Reviewed: 2026-06-30; counts refreshed after 62 promoted solver-reuse packs.
...
| At least one consumer can read promoted solver-reuse rows | `scripts/query-foundational-resources.py packs --solver-reuse promoted --require-any` is part of `scripts/check-foundational-resources.sh` and currently finds 62 promoted packs. |
...
- `solver_reuse`: 62 promoted packs and 22 unclassified packs
