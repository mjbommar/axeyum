...
- [TOPOLOGY-HOMOLOGY-QUERIES.md](TOPOLOGY-HOMOLOGY-QUERIES.md) gives copyable
  ...
  UCT shadows, and cup-product rows.
...
- [`artifacts/examples/math/finite-steffensen-method-v0/`](../../artifacts/examples/math/finite-steffensen-method-v0/)
  validates exact Steffensen fixed-point acceleration replay, fixed residual
  checking, checked rejection of a false accelerated-value claim, and a
  fixed-point/convergence Lean-horizon row.
...
- [`artifacts/examples/math/finite-line-search-v0/`](../../artifacts/examples/math/finite-line-search-v0/)
  ...
  acceptance, false descent-direction, and accepted-candidate claims, and a
...
- [`artifacts/examples/math/finite-wolfe-line-search-v0/`](../../artifacts/examples/math/finite-wolfe-line-search-v0/)
  ...
  sufficient-decrease and curvature checks, checked rejection of false
  line-minimizer and curvature claims, and a Wolfe line-search Lean-horizon
  row.
...
- [`artifacts/examples/math/finite-proximal-gradient-v0/`](../../artifacts/examples/math/finite-proximal-gradient-v0/)
  ...
  rejection of false proximal-point, false composite-decrease, and false
...
- [`artifacts/examples/math/finite-continuous-maps-v0/`](../../artifacts/examples/math/finite-continuous-maps-v0/)
  ...
  homeomorphism replay, bad-continuity and bad-homeomorphism rejection, a
  checked QF_UF/Alethe preimage-membership row, and a continuous-map
  Lean-horizon row.
...
- [`artifacts/examples/math/linear-algebra-rational-v0/`](../../artifacts/examples/math/linear-algebra-rational-v0/)
  ...
  replay, exact bad LU product-entry replay with a separate checked
  QF_LRA/Farkas row, checked bad nullspace-component certificates, and a
...
- [`artifacts/examples/math/exact-statistical-tests-v0/`](../../artifacts/examples/math/exact-statistical-tests-v0/)
  ...
  ordered exact multinomial p-values, checked QF_LRA/Farkas rejection of false
  Fisher and multinomial p-values, and checked QF_LIA/Diophantine rejection of
...
- [`artifacts/examples/math/finite-sdp-v0/`](../../artifacts/examples/math/finite-sdp-v0/)
  ...
  bad-duality-gap and bad-slack-entry rejections, and a general SDP-duality
  Lean-horizon row.
- [`artifacts/examples/math/finite-gradient-descent-v0/`](../../artifacts/examples/math/finite-gradient-descent-v0/)
...
- [`artifacts/examples/math/finite-line-search-v0/`](../../artifacts/examples/math/finite-line-search-v0/)
  ...
  accepted backtracking, checked bad-acceptance, bad descent-direction, and bad
  accepted-candidate rejection, and a general line-search convergence
  Lean-horizon row.
- [`artifacts/examples/math/finite-wolfe-line-search-v0/`](../../artifacts/examples/math/finite-wolfe-line-search-v0/)
...
- [`artifacts/examples/math/finite-proximal-gradient-v0/`](../../artifacts/examples/math/finite-proximal-gradient-v0/)
  ...
  decrease, checked bad-proximal-point, bad composite-decrease, and bad
  box-proximal-point rejection, and a general proximal-gradient convergence
  Lean-horizon row.
...
- [`artifacts/examples/math/finite-random-variables-v0/`](../../artifacts/examples/math/finite-random-variables-v0/)
  ...
  false pushforward and expectation-through-pushforward claims, separate
  checked QF_LRA/Farkas rows, and a general random-variable Lean-horizon row.
- [`artifacts/examples/math/finite-conditional-expectation-v0/`](../../artifacts/examples/math/finite-conditional-expectation-v0/)
  ...
  expectation, tower property replay, conditional-variance decomposition,
  checked rejection of false conditional-expectation, total-expectation,
  tower-property, and variance-decomposition tables, and a general
...
- [`artifacts/examples/math/finite-stochastic-kernels-v0/`](../../artifacts/examples/math/finite-stochastic-kernels-v0/)
  ...
  table factorization/disintegration, finite kernel composition, replay-only
  rejection of malformed kernel-row and composed-entry tables, separate checked
  QF_LRA/Farkas rows for the isolated linear conflicts, and a
...
- [`artifacts/examples/math/finite-operator-v0/`](../../artifacts/examples/math/finite-operator-v0/)
  ...
  operator-bound, and Chebyshev-prefix claims.
...
- [`artifacts/examples/math/complex-algebraic-v0/`](../../artifacts/examples/math/complex-algebraic-v0/)
  ...
  QF_LRA/Farkas rejection of bad product-coordinate and norm-squared rows, and
