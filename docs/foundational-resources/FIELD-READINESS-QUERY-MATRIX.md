...
At the time this matrix was written, the public summary reports 103 concept
...
| `topology` | 9 / 48 | `fields --field topology --route boolean`; `fields --field topology --route Diophantine` | `concepts --field topology --text compactness`; `concepts --field topology --text preimage`; `concepts --field topology --text homology` | `checks --field topology --route boolean --proof-status checked`; `checks --field topology --route alethe --proof-status checked`; `checks --field topology --route Diophantine --proof-status checked` | Arbitrary compactness, connectedness, homeomorphism invariance, homology invariance, exact sequences, or cohomology. |
