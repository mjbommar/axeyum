...
integral replay, Newton/root-finding steps, finite recurrence, Euler, and
Runge-Kutta midpoint rows,
...
| Finite dynamics, recurrence, Euler, and Runge-Kutta midpoint replay | `bridge_finite_dynamics_euler_replay` | `Farkas` | `checks --concept bridge_finite_dynamics_euler_replay --route Farkas --proof-status checked`; `checks --pack finite-runge-kutta-midpoint-v0 --route Farkas --proof-status checked` |
