...
Fisher p-values, checked QF_LRA/Farkas rejection of a false Fisher left-tail
p-value, and checked QF_LIA/Diophantine rejection of a bad binomial tail count.
