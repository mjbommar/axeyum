...
| `statistics` | descriptive stats, exact tests, ordinary and ridge regression, finite count tables | distinguish exact finite tests and exact rational regression replay from numerical/statistical inference | QF_LIA, QF_LRA/Farkas, replay |
