...
- 617 expected checks.
- 294 checked proof/evidence rows.
...
| `calculus` | deepen | one-variable false derivative, Riemann-sum false integral, multivariable bad-gradient, finite root-finding bad-step and bad-width, finite KKT bad-stationarity, finite active-set QP bad-free-gradient and bad-degenerate-multiplier, finite gradient-descent bad-decrease and bad step-coordinate, finite line-search bad-Armijo and bad accepted-candidate, finite Wolfe bad-minimizer and bad-curvature, finite projected-gradient bad-projection, and finite proximal-gradient bad-proximal-point plus bad box-proximal-point rows now have QF_LRA/Farkas regressions |
