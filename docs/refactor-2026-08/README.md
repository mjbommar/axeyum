...
| library | `nat_prelude` **119 proved / 0 trusted**; `int_prelude` **54 proved / 0 axioms**; `arith_prelude` **0 proved / 30 axioms — but see below: it is not an axiomatisation of ℝ** |
