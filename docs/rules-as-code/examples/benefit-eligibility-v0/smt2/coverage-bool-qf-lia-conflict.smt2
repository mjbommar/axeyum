; Bool/QF_LIA coverage check for benefit-eligibility-v0.
;
; Source clauses:
...
;
; For a complete fact pattern, the model defines `ineligible` as the negation
; of `eligible`. Asking for neither output is therefore inconsistent.
(set-logic QF_LIA)
