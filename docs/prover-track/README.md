...
| Prelude assumptions form part of the trust boundary | Still material, and measurably smaller. The [generated ledger](../plan/generated/lean-axiom-ledger.md) records real 30, integer 1, string 1 — down from 65 as ℤ was constructed over the proved ℕ development, with 33 rows filed as retired. Its counts are generated from a measurement and `--check`-gated (ADR-0465); accepted TL3.2 classification/discharge work remains open. |
