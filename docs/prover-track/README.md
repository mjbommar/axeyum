...
| [`06-kernel-gap-analysis.md`](research/06-kernel-gap-analysis.md) | Historical 64-row arithmetic census, corrected to 65 total by runtime inventory; vacuous positivity; `Lit::Nat` truncation; **zero fuzz**. |
