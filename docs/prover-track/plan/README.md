...
| The prelude-assumption boundary — **30** runtime/type-digested rows, down from 65 as ℤ was constructed over the proved ℕ development; the generated ledger assigns 3 derivable, 19 external, and 8 primitive rows, while accepted TL3.2 classification and discharge remain open | T6.0.6 / TL0.4 / TL3.2 |
