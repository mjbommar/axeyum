...
$2Q^2\leq\ell$: the individual Riemann--Hypothesis bounds for all smaller
orders fit in the budget.  Thus the unresolved input is a high-order Witt
estimate, not an ordinary Artin--Schreier estimate.
