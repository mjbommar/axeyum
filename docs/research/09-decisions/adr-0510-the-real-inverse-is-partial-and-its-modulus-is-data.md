# ADR-0510: the real inverse is partial, its modulus is data, and both halves of that are theorems
...
- The 22 ordered-ring laws are untouched: no field law is one of them, so no
  count moves and the `Real` package's 30 axioms are unaffected (ADR-0512 retires
