...
Every operation owes an `Equiv`-congruence, exactly as ADR-0512 counted for ℝ:
...
*defined* equality, which is the transcription ADR-0512 predicted would be
...
- **ℚ(i) first, per ADR-0512's deferral.** Still the right thing for
