...
already been misread in practice: two lane status docs in-tree quote
`MUTATION_ANCHORS|...|stale=1` beside the phrase *"the same 4 pre-existing
complaints"*, a one that was four.
