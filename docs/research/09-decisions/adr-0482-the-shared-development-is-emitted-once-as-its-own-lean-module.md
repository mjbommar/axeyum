# ADR-0482: The shared development is emitted once as its own Lean module, and the split artefact is weaker than the single file
...
Related: [ADR-0483](adr-0483-real-is-constructed-as-a-setoid-over-the-rationals.md),
