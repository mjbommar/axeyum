...
| [0344](adr-0344-preregister-resumable-distributed-benchmark-execution.md) | Preregister resumable distributed benchmark execution before another large candidate run | accepted |
