...
| [0089](adr-0089-retained-warm-array-relations.md) | Retained warm array relations: projection-owned positive equality plus one exact private diff witness for disequality over supported structural parents, with scoped roots, array-first/function-second projection, owner filtering, and replay | proposed |
