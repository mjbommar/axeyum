...
| [0090](adr-0090-retained-warm-structural-array-equality.md) | Retained warm structural array equality: cached private constructor owners, bounded old/future shared-index observations, class-aware observed-read-preserving fixed-point realization, array-first/function-second projection, filtering, and replay | proposed |
