...
| [0086](adr-0086-retained-warm-structural-array-reads.md) | Retained warm structural array reads: give observed store/constant/ITE reads permanent exact scalar definitions in the incremental CNF, project only leaf owners, and replay original scoped roots | proposed |
