...
| [0085](adr-0085-bounded-structural-array-class-equations.md) | Bounded structural array-class equations: decompose array-ITE equality before search, realize true store/ITE/constant equations into class-owned leaf arrays without changing observed reads, then project functions and replay | proposed |
