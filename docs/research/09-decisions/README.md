...
| [0087](adr-0087-candidate-triggered-retained-warm-row.md) | Candidate-triggered retained warm ROW: retain exact structural-read equations as dormant metadata, activate only candidate-false equations in the persistent incremental CNF, share one deadline, and preserve leaf projection plus original replay | proposed |
