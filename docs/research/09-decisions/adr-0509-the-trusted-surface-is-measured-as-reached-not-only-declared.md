# ADR-0509: The trusted surface is measured as *reached*, not only as *declared* — and the `Real` package is retained as a specification and a control
...
**What still reaches the axioms.** The `RingSignature` seam (ADR-0512 phase R3)
