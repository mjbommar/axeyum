# ADR-0490: the real lattice is defined on the representation, and it is one-Lipschitz
...
[ADR-0483](adr-0483-real-is-constructed-as-a-setoid-over-the-rationals.md)
...
degree-2 identities in ℕ to justify it ([ADR-0487](adr-0487-the-real-inverse-is-well-defined-by-uniqueness-not-by-estimate.md)).
...
undecidable and ADR-0483 states no totality law for it, precisely because
...
wall [ADR-0481](adr-0481-the-real-inverse-is-partial-and-its-modulus-is-data.md)
hit with `Apart`.
