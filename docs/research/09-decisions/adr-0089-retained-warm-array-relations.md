...
- Unsupported indices/elements/signatures, positive structural equality,
  ...
  relation flags land in ADR-0091, direct array-valued UF parameters land in
  ADR-0092, and supported structural array-key expressions land in ADR-0093;
  nested array-valued application keys remain deferred.
