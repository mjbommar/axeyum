...
- Sparse Fourier support or wholesale imprimitive-character vanishing cannot
  explain the pinned connected cancellation.
...
- The next Heisenberg experiment is therefore a phase-resolved connected Witt
  object and a checked central extension, not a formal second difference of
  the integer-valued spectrum.
