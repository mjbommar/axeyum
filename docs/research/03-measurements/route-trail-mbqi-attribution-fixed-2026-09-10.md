...
ADR-1907, commits `43cfae068` (decision) and `72a5adf6f` (fix). Population: the
32 files in
...
[ADR-1907](../09-decisions/adr-1907-a-route-trace-segment-cost-is-movable-a-rung-verdict-is-not.md).
...
ADR-1907 also fixes a second defect at the same site: the `q:uf-fmf-full`
