...
For fuller traces through finite sets, relations/functions, finite
function-table actions, finite order/lattice replay, finite cardinality
principles, topology, connectedness, and measure replay, read
