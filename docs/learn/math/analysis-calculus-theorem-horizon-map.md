...
| Differential equations and dynamical systems | `bounded-dynamics-v0`, `finite-euler-method-v0`, `finite-recurrence-prefix-v0`, `finite-stochastic-kernels-v0`, `finite-markov-chain-v0`, `finite-hitting-times-v0` | Bounded recurrence traces, finite invariants, threshold reachability, checked bad transition-step, bad threshold-step, and invariant-bound rows, Euler transitions, finite error tables, checked bad finite error-bound and terminal-error rows, finite stochastic transitions, stationary distributions, replayed bad Markov rows, separate checked QF_LRA/Farkas scalar Markov refutations, and hitting-time equations. | Existence/uniqueness, continuous flow invariants, stability, Gronwall-style estimates, Euler convergence, PDE theory, infinite-state Markov processes, and recurrence/transience classifications. | A dynamics theorem-horizon ledger that groups deterministic, numerical, and stochastic finite shadows separately. |
