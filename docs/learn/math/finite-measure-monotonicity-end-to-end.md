...
cargo test -p axeyum-solver --features full --test math_resource_lra_routes finite_measure_monotonicity_bad_union_subadditivity_artifact_emits_checked_farkas
```
