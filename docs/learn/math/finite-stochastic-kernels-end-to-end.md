...
cargo test -p axeyum-solver --features full --test math_resource_lra_routes finite_stochastic_kernel_bad_row_artifact_emits_checked_farkas
cargo test -p axeyum-solver --features full --test math_resource_lra_routes finite_stochastic_kernel_bad_composition_artifact_emits_checked_farkas
```
