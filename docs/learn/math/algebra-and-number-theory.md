...
module tables, kernels, images, and bad-submodule refutations. The gcd/Bezout
...
finite vector-space, finite-field, finite-module, gcd/Diophantine, bounded
number-theory, and fixed-degree polynomial universal rows.
