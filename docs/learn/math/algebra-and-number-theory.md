...
QF_UF/Alethe evidence. The finite-group-actions pack checks a finite group
...
addition and multiplication tables. Its bad ideal row links the failed
additive-closure equation to checked QF_UF/Alethe evidence.
The focused
[Algebra Homomorphism And Quotient Theorem Boundary](algebra-homomorphism-quotient-theorem-boundary.md)
keeps those finite map, kernel/image, ideal, and quotient rows separate from
general isomorphism, correspondence, quotient, localization, and ideal-theory
claims.
...
addition and scalar-action tables. Its bad submodule row links the failed
