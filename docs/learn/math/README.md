...
- [Finite Dynamics And Euler Replay](finite-dynamics-euler-end-to-end.md):
  ...
  reachability, explicit Euler replay, Runge-Kutta midpoint replay, finite
  error tables, and checked QF_LRA/Farkas rows split from replay-only bad
  error-bound, bad terminal-error, bad Euler-step, and bad RK-step rejection.
