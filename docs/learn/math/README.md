...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md):
  ...
  spline replay, finite Riemann-sum, finite Simpson-rule quadrature,
  antiderivative, gradient, Jacobian, Hessian, and checked bad-row replay from general
