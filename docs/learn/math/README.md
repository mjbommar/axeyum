...
- [Finite Dynamics And Euler Replay](finite-dynamics-euler-end-to-end.md):
  ...
  trapezoid replay, Adams-Bashforth derivative-history replay, finite error tables, and
  ...
  rejection, plus bad Adams-Bashforth-step rejection.
