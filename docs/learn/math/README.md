...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md):
  ...
  stencils, finite Riemann-sum, finite Simpson-rule quadrature,
...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md): maps finite
  ...
  differentiability, MVT, integrability, quadrature, interpolation, FTC,
