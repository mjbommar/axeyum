...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md):
  separates finite polynomial derivative, finite Riemann-sum, finite
  Simpson-rule quadrature, antiderivative, gradient, Jacobian, Hessian, and
