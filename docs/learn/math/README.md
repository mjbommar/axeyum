...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md):
  ...
  stencils, finite Taylor polynomial replay, finite Riemann-sum, finite Simpson-rule quadrature,
...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md): maps finite
  ...
  Taylor-polynomial, Hermite-interpolation, antiderivative,
