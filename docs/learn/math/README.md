...
- [Calculus Theorem Boundary](calculus-theorem-boundary.md): maps finite
  derivative, product-rule, tangent, Riemann-sum, Simpson-rule, antiderivative,
  gradient, Jacobian, Hessian, and malformed-row shadows to the missing
  differentiability, MVT, integrability, quadrature, FTC, multivariable, and
  manifold-calculus theorem routes.
