...
claimed shorter distance below the potential lower bound. Its focused theorem
boundary is [Shortest Path Theorem Boundary](shortest-path-theorem-boundary.md).
The finite DAG
