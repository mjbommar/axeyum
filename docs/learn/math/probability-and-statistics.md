...
QF_LRA bad high-block, bad total-expectation, and bad tower-property
certificates, finite
...
checked Farkas certificate for the bad high-block table, false
total-expectation value, and false tower value.
