...
- **`bench-results/DOMINANCE.md`** (`python3 scripts/gen-dominance-scoreboard.py`) —
  ...
  `83% (141/169)`, QF_AUFBV/bitwuzla `100% (41/41)`, QF_BV/bvred `83% (5/6)`,
  ...
  the equal store-chain readback extension added `ext27` and `ext28`, lifting
  ABV Lean unsat coverage to **57/83**.
