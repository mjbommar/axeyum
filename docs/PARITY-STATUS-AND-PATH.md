...
- **`bench-results/DOMINANCE.md`** (`python3 scripts/gen-dominance-scoreboard.py`) —
  ...
  `87% (147/169)`, QF_AUFBV/bitwuzla `100% (41/41)`, QF_BV/bvred `83% (5/6)`,
  ...
  concat-xor finite extensionality extension added `ext23`, and the finite
  row-wise extensionality extension added `ext19`, `ext24`, and `ext25`,
  lifting ABV Lean unsat coverage to **63/83**.
