...
- **`bench-results/DOMINANCE.md`** (`python3 scripts/gen-dominance-scoreboard.py`) —
  ...
  `89% (151/169)`, QF_AUFBV/bitwuzla `100% (41/41)`, QF_BV/bvred `83% (5/6)`,
  ...
  row-wise extensionality extension added `ext19`, `ext24`, and `ext25`, and
  the symbolic-cover/implication extension added `ext13`, `read9`, `write16`,
  and `write17`, lifting ABV Lean unsat coverage to **67/83**.
