...
| 14 | [`14-frontier-reachability.md`](14-frontier-reachability.md) | why the agent attempts ~3 of 146 open facts, decomposed into reachability (frozen-export coverage, `gen-statement-adapters.py`) × provability (producer reach), with the measured census and the lean4export arrow cap | 03 |
