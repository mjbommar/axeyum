...
//!
//! Both modules were promoted from `examples/*_support/mod.rs` so that the
...
//!
//! Each producer defines its own `MAX_BINDERS`, `Candidate` and
//! `DeclineReason`, and they are **different types with different variants and
