...
/// The `NatPrelude` field table (1439 names,
...
pub(super) fn nat(p: &NatPrelude) -> Fields {
    Fields {
        names: vec![
            ...
            (
                "least_residue_sum_range_reconcile",
                p.least_residue_sum_range_reconcile,
            ),
            (
                "mul_sum_range_div_add_least_residue",
                p.mul_sum_range_div_add_least_residue,
            ),
            ("eisenstein_count_identity", p.eisenstein_count_identity),
            ("eisenstein_lemma", p.eisenstein_lemma),
            ("eisenstein_lemma_mod_eq", p.eisenstein_lemma_mod_eq),
            ("div_mul_succ_le_of_le", p.div_mul_succ_le_of_le),
            (
            ...
            (
                "count_range_eq_zero_of_all_false",
            ...
            ("graph", p.graph),
            ("graph_mk", p.graph_mk),
            ("graph_rec", p.graph_rec),
            ("graph_rel", p.graph_rel),
            ("graph_order", p.graph_order),
            ("graph_and_b", p.graph_and_b),
            ("graph_or_b", p.graph_or_b),
            ("graph_not_b", p.graph_not_b),
            ("graph_ne_b", p.graph_ne_b),
            ("graph_adj_b", p.graph_adj_b),
            ("graph_neighbors", p.graph_neighbors),
            ("graph_degree", p.graph_degree),
            ("graph_and_b_comm", p.graph_and_b_comm),
            ("graph_and_b_false_right", p.graph_and_b_false_right),
            ("graph_and_b_intro", p.graph_and_b_intro),
            ("graph_and_b_left", p.graph_and_b_left),
            ("graph_and_b_right", p.graph_and_b_right),
            ("graph_adj_b_symm", p.graph_adj_b_symm),
            ("graph_adj_b_irrefl", p.graph_adj_b_irrefl),
            ("graph_adj_b_of_order_le", p.graph_adj_b_of_order_le),
            ("graph_lt_order_of_adj_b", p.graph_lt_order_of_adj_b),
            ("graph_ne_of_adj_b", p.graph_ne_of_adj_b),
            ("graph_adj_b_of_rel", p.graph_adj_b_of_rel),
            ("graph_mem_b_neighbors", p.graph_mem_b_neighbors),
            ("graph_degree_le_order", p.graph_degree_le_order),
            ("graph_compl", p.graph_compl),
            ("graph_has_clique3", p.graph_has_clique3),
            ("graph_no_clique3_b", p.graph_no_clique3_b),
            ("graph_arrows33", p.graph_arrows33),
            ("graph_is_ramsey33", p.graph_is_ramsey33),
            (
                "graph_adj_b_compl_of_not_adj_b",
                p.graph_adj_b_compl_of_not_adj_b,
            ),
            (
                "graph_not_has_clique3_of_decide",
                p.graph_not_has_clique3_of_decide,
            ),
            ("graph_triangle_or_indep", p.graph_triangle_or_indep),
            ("graph_antitriangle_or_indep", p.graph_antitriangle_or_indep),
            ("graph_arrows33_of_le", p.graph_arrows33_of_le),
            ("graph_is_ramsey33_of_succ", p.graph_is_ramsey33_of_succ),
            ("graph_ramsey33_arrows_six", p.graph_ramsey33_arrows_six),
            ("graph_ramsey33_witness", p.graph_ramsey33_witness),
            (
                "graph_ramsey33_not_arrows_five",
                p.graph_ramsey33_not_arrows_five,
            ),
            ("graph_ramsey_three_three", p.graph_ramsey_three_three),
            ("hall_any_below", p.hall_any_below),
            ("hall_union_bound", p.hall_union_bound),
            ("hall_union_over", p.hall_union_over),
            ("hall_is_matching", p.hall_is_matching),
            ("hall_condition", p.hall_condition),
            ("hall_any_below_of_witness", p.hall_any_below_of_witness),
            ("hall_mem_union_over", p.hall_mem_union_over),
            (
            ...
            ("finset_card_pos_of_mem_b", p.finset_card_pos_of_mem_b),
            ("hall_is_matching_congr", p.hall_is_matching_congr),
            (
                "hall_exists_is_matching_of_card_le_zero",
...
pub(super) fn rat(p: &RatPrelude) -> Fields {
    Fields {
        names: vec![
            ...
            ("nonzero_row_b", p.nonzero_row_b),
            ("nonzero_row_b_eq_ble", p.nonzero_row_b_eq_ble),
            ("nonzero_row_b_zero_cols", p.nonzero_row_b_zero_cols),
            ("rank", p.rank),
            ("rank_eq_count_range", p.rank_eq_count_range),
            ("rank_le_rows", p.rank_le_rows),
            ("rank_zero_rows", p.rank_zero_rows),
            (
                "count_range_nonzero_row_b_zero",
