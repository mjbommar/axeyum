...
fn named(p: &RatPrelude) -> Vec<(&'static str, crate::NameId)> {
    vec![
        ...
        ("sumMaps_congr_mapsInto", p.sum_maps_congr_maps_into),
        ("det_matMul_expand", p.det_mat_mul_expand),
        ("det_matMul", p.det_mat_mul),
        ("isZeroB", p.is_zero_b),
        ("isZeroB_zero", p.is_zero_b_zero),
        ("eq_zero_of_isZeroB", p.eq_zero_of_is_zero_b),
        ("isZeroB_of_eq_zero", p.is_zero_b_of_eq_zero),
        ("ne_zero_of_isZeroB_false", p.ne_zero_of_is_zero_b_false),
        ("rowSwap", p.row_swap),
        ("rowScale", p.row_scale),
        ("rowAddMul", p.row_add_mul),
        ("rowSwap_at_left", p.row_swap_at_left),
        ("rowSwap_at_right", p.row_swap_at_right),
        ("rowSwap_off", p.row_swap_off),
        ("rowScale_at", p.row_scale_at),
        ("rowScale_off", p.row_scale_off),
        ("rowAddMul_at", p.row_add_mul_at),
        ("rowAddMul_off", p.row_add_mul_off),
        ("rowSwap_involutive", p.row_swap_involutive),
        ("rowAddMul_inverse", p.row_add_mul_inverse),
        ("rowScale_inverse", p.row_scale_inverse),
        ("pivotSearchAux", p.pivot_search_aux),
        ("pivotSearch", p.pivot_search),
        ("clearBelowAux", p.clear_below_aux),
        ("clearBelow", p.clear_below),
        ("echelonAux", p.echelon_aux),
        ("rowEchelon", p.row_echelon),
        ("leadingIndexAux", p.leading_index_aux),
        ("leadingIndex", p.leading_index),
        ...
        ("pivotSearchAux_ge_start", p.pivot_search_aux_ge_start),
        ("pivotSearch_ge_start", p.pivot_search_ge_start),
        ("isEchelonAux_of_pairs", p.is_echelon_aux_of_pairs),
        ("isEchelon_of_pairs", p.is_echelon_of_pairs),
        ("echelonStepOk_of_lt", p.echelon_step_ok_of_lt),
        ("echelonStepOk_both_cols", p.echelon_step_ok_both_cols),
        ("echelonAux_isEchelon", p.echelon_aux_is_echelon),
        ("rowEchelon_isEchelon", p.row_echelon_is_echelon),
        ("lt_of_echelonStepOk", p.lt_of_echelon_step_ok),
        ("pairs_of_isEchelonAux", p.pairs_of_is_echelon_aux),
        ("pairs_of_isEchelon", p.pairs_of_is_echelon),
        ("leadingIndex_strict_below", p.leading_index_strict_below),
        (
            "pivotRowSearchAux_eq_of_first",
            p.pivot_row_search_aux_eq_of_first,
        ),
        ("pivotRowOfCol_eq_of_first", p.pivot_row_of_col_eq_of_first),
        ("pivotSection_of_isEchelon", p.pivot_section_of_is_echelon),
        ("rank_eq_rankCols", p.rank_eq_rank_cols),
...
fn the_determinant_toolkit_is_axiom_free() {
    ...
    let expected = [
        ...
        ("sumMaps_congr_mapsInto", p.sum_maps_congr_maps_into, true),
        ("det_matMul_expand", p.det_mat_mul_expand, true),
        ("det_matMul", p.det_mat_mul, true),
        ("isZeroB", p.is_zero_b, false),
        ...
        ("rowSwap_at_left", p.row_swap_at_left, true),
        ("rowSwap_at_right", p.row_swap_at_right, true),
        ("rowSwap_off", p.row_swap_off, true),
        ("rowScale_at", p.row_scale_at, true),
        ("rowScale_off", p.row_scale_off, true),
        ("rowAddMul_at", p.row_add_mul_at, true),
        ("rowAddMul_off", p.row_add_mul_off, true),
        ("rowSwap_involutive", p.row_swap_involutive, true),
        ("rowAddMul_inverse", p.row_add_mul_inverse, true),
        ("rowScale_inverse", p.row_scale_inverse, true),
        ("pivotSearchAux", p.pivot_search_aux, false),
        ("pivotSearch", p.pivot_search, false),
        ("clearBelowAux", p.clear_below_aux, false),
        ("clearBelow", p.clear_below, false),
        ("echelonAux", p.echelon_aux, false),
        ("rowEchelon", p.row_echelon, false),
        ("leadingIndexAux", p.leading_index_aux, false),
        ("leadingIndex", p.leading_index, false),
        ...
        ("pivotColSearchAux", p.pivot_col_search_aux, false),
        ("isPivotColB", p.is_pivot_col_b, false),
        ("isPivotColB_eq_search", p.is_pivot_col_b_eq_search, true),
        ("isPivotColB_zero_rows", p.is_pivot_col_b_zero_rows, true),
        ("rankCols", p.rank_cols, false),
        ("rankCols_eq_countRange", p.rank_cols_eq_count_range, true),
        ("nullity", p.nullity, false),
        ("nullity_eq_countRange", p.nullity_eq_count_range, true),
        ("rank_nullity", p.rank_nullity, true),
        ("rankCols_le_cols", p.rank_cols_le_cols, true),
        ("nullity_le_cols", p.nullity_le_cols, true),
        ("rankCols_zero_cols", p.rank_cols_zero_cols, true),
        ("nullity_zero_cols", p.nullity_zero_cols, true),
        (
            "countRange_isPivotColB_zeroRows",
            p.count_range_is_pivot_col_b_zero_rows,
            true,
        ...
        ("pivotSearchAux_ge_start", p.pivot_search_aux_ge_start, true),
        ("pivotSearch_ge_start", p.pivot_search_ge_start, true),
        ("isEchelonAux_of_pairs", p.is_echelon_aux_of_pairs, true),
        ("isEchelon_of_pairs", p.is_echelon_of_pairs, true),
        ("echelonStepOk_of_lt", p.echelon_step_ok_of_lt, true),
        ("echelonStepOk_both_cols", p.echelon_step_ok_both_cols, true),
        ("echelonAux_isEchelon", p.echelon_aux_is_echelon, true),
        ("rowEchelon_isEchelon", p.row_echelon_is_echelon, true),
        ("lt_of_echelonStepOk", p.lt_of_echelon_step_ok, true),
        ("pairs_of_isEchelonAux", p.pairs_of_is_echelon_aux, true),
        ("pairs_of_isEchelon", p.pairs_of_is_echelon, true),
        (
            "leadingIndex_strict_below",
        ...
        (
            "pivotRowOfCol_eq_of_first",
            p.pivot_row_of_col_eq_of_first,
            true,
        ),
        (
            "pivotSection_of_isEchelon",
            p.pivot_section_of_is_echelon,
            true,
        ),
        ("rank_eq_rankCols", p.rank_eq_rank_cols, true),
        ("rank_le_cols", p.rank_le_cols, true),
        ("rank_nullity_rows", p.rank_nullity_rows, true),
        (
