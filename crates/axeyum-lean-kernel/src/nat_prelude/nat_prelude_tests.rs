...
fn definition_names(p: &NatPrelude) -> Vec<NameId> {
    vec![
        ...
        p.rado_of_finset,
        p.rado_schur_set,
        // `graph-carrier` lane: `graph.rs` / `ramsey.rs` (ADR-1608).
        p.graph_rel,
        p.graph_order,
        p.graph_and_b,
        p.graph_or_b,
        ...
        p.graph_compl,
        p.graph_has_clique3,
        p.graph_no_clique3_b,
        p.graph_arrows33,
        p.graph_is_ramsey33,
        p.graph_ramsey33_witness,
        p.hall_any_below,
        p.hall_union_bound,
        p.hall_union_over,
        p.hall_is_matching,
...
fn theorem_names(p: &NatPrelude) -> Vec<NameId> {
    vec![
        ...
        p.rado_schur_two,
        // `graph-carrier` lane: `graph.rs` (ADR-1608).
        p.graph_and_b_comm,
        p.graph_and_b_false_right,
        p.graph_and_b_intro,
        p.graph_and_b_left,
        p.graph_and_b_right,
        p.graph_adj_b_symm,
        p.graph_adj_b_irrefl,
        p.graph_adj_b_of_order_le,
        p.graph_lt_order_of_adj_b,
        p.graph_ne_of_adj_b,
        p.graph_adj_b_of_rel,
        p.graph_mem_b_neighbors,
        p.graph_degree_le_order,
        p.graph_adj_b_compl_of_not_adj_b,
        p.graph_not_has_clique3_of_decide,
        p.graph_triangle_or_indep,
        p.graph_antitriangle_or_indep,
        p.graph_arrows33_of_le,
        p.graph_is_ramsey33_of_succ,
        p.graph_ramsey33_arrows_six,
        p.graph_ramsey33_not_arrows_five,
        p.graph_ramsey_three_three,
        p.hall_any_below_of_witness,
        p.hall_mem_union_over,
        p.hall_condition_of_is_matching,
        // `hall-counting` lane (roadmap W2-12): the counting half of
        // Hall, `hall.rs` and `finset.rs` (ADR-1623).
        p.hall_any_below_witness,
        p.hall_mem_union_over_elim,
        ...
        p.finset_mem_b_sdiff,
        p.finset_mem_b_sdiff_intro,
        p.finset_mem_b_sdiff_elim,
        p.finset_card_le_card_sdiff_add,
        p.finset_mem_b_union,
        p.finset_mem_b_union_left,
        p.finset_mem_b_union_right,
        p.finset_mem_b_union_elim,
        ...
        p.transposition_at_i,
        p.transposition_at_j,
        p.transposition_gt_j,
        p.transposition_eq_of_ne,
        ...
        p.size_one,
        p.size_eq_zero,
        p.size_aux_zero_any_fuel,
        p.size_aux_agree_of_fuel,
        p.size_aux_eq_size_of_le,
        p.size_aux_mono_value,
        p.size_le_size,
        p.size_bit,
        p.mod_eq_self_of_lt,
        p.sum_test_bit_eq,
        ...
        p.clog_anti_left,
        p.clog_mono,
        p.clog_of_left_le_one,
        p.clog_of_right_le_one,
        p.log_of_left_le_one,
        p.log_pos,
        p.log_eq_zero_iff,
        p.clog_eq_one,
