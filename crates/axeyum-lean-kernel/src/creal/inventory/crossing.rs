//! Inventory shard for `crates/axeyum-lean-kernel/src/creal/crossing.rs`.
//!
...
//! declaration to `crates/axeyum-lean-kernel/src/creal/crossing.rs` adds its entry HERE and nowhere else — this
...
/// declaration built by `crates/axeyum-lean-kernel/src/creal/crossing.rs`.
///
