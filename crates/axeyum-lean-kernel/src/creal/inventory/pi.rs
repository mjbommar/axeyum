...
pub(crate) fn entries(p: crate::CRealPrelude) -> Vec<(&'static str, crate::NameId, &'static str)> {
    vec![
        ("CReal.piHalfCoef", p.pi.pi_half_coef, "def"),
        ("CReal.piHalfTerm", p.pi.pi_half_term, "def"),
        (
            "CReal.piHalfSeriesPartial",
            p.pi.pi_half_series_partial,
            "def",
        ),
        (
            "CReal.piHalfCoefNonneg",
            p.pi.pi_half_coef_nonneg,
            "theorem",
        ),
        (
            "CReal.piHalfTermNonneg",
            p.pi.pi_half_term_nonneg,
            "theorem",
        ),
        (
            "CReal.piHalfTermLePowHalf",
            p.pi.pi_half_term_le_pow_half,
            "theorem",
        ),
        (
        ...
        ("CReal.piHalf", p.pi.pi_half, "def"),
        ("CReal.piHalfConverges", p.pi.pi_half_converges, "theorem"),
        ("CReal.pi", p.pi.pi, "def"),
        ("CReal.piHalfLeTwo", p.pi.pi_half_le_two, "theorem"),
        ("CReal.piLeFour", p.pi.pi_le_four, "theorem"),
        ("CReal.twoLePi", p.pi.two_le_pi, "theorem"),
        ("CReal.threeLePi", p.pi.three_le_pi, "theorem"),
    ]
}
