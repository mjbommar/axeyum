//! Inventory shard for `crates/axeyum-lean-kernel/src/creal/rolle.rs`.
//!
...
//! `crates/axeyum-lean-kernel/src/creal/rolle.rs` adds its entry HERE and
//! nowhere else.
//!
...
/// declaration built by `crates/axeyum-lean-kernel/src/creal/rolle.rs`.
