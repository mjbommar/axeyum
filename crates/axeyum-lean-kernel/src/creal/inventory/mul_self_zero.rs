//! Inventory shard for `crates/axeyum-lean-kernel/src/creal/mul_self_zero.rs`.
//!
...
//! declaration to `crates/axeyum-lean-kernel/src/creal/mul_self_zero.rs` adds its entry HERE and nowhere else — this
...
/// declaration built by `crates/axeyum-lean-kernel/src/creal/mul_self_zero.rs`.
///
