//! Inventory shard for `crates/axeyum-lean-kernel/src/creal/order_extra.rs`.
//!
...
//! declaration to `crates/axeyum-lean-kernel/src/creal/order_extra.rs` adds its entry HERE and nowhere else — this
...
/// declaration built by `crates/axeyum-lean-kernel/src/creal/order_extra.rs`.
///
