//! Inventory shard for `crates/axeyum-lean-kernel/src/creal/archimedean_squeeze.rs`.
//!
...
//! declaration to `crates/axeyum-lean-kernel/src/creal/archimedean_squeeze.rs` adds its entry HERE and nowhere else — this
...
/// declaration built by `crates/axeyum-lean-kernel/src/creal/archimedean_squeeze.rs`.
///
...
pub(crate) fn entries(p: crate::CRealPrelude) -> Vec<(&'static str, crate::NameId, &'static str)> {
    vec![
        ...
        (
            "CReal.le_of_forall_le_add_rate",
