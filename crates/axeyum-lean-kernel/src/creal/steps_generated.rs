...
pub(super) const STEPS: &[BuildStep] = &[
    ...
    BuildStep {
        label: "field_setoid_instance::declare_field_s_all",
        requires: &[
            |p: CRealPrelude| p.add,
            |p: CRealPrelude| p.add_comm,
            |p: CRealPrelude| p.add_lt_add_of_le_of_lt,
        ...
        provides: &[
            |p: CRealPrelude| p.field_s.apart_compat,
            |p: CRealPrelude| p.field_s.field_s,
            |p: CRealPrelude| p.field_s.mul_inv_ex,
            |p: CRealPrelude| p.field_s.one_apart_zero,
            |p: CRealPrelude| p.field_s.pos_of_neg_lt_zero,
        ],
        run: super::field_setoid_instance::declare_field_s_all,
    },
    BuildStep {
        label: "power_series::declare_abs_pow_le",
        requires: &[
            |p: CRealPrelude| p.abs,
            |p: CRealPrelude| p.abs_le,
            |p: CRealPrelude| p.abs_mul_le_of_bounds,
        ...
        provides: &[|p: CRealPrelude| p.power_series.abs_pow_le],
        run: super::power_series::declare_abs_pow_le,
    },
    BuildStep {
        label: "power_series::declare_one_pow",
        requires: &[
            |p: CRealPrelude| p.equiv,
            |p: CRealPrelude| p.equiv_refl,
            |p: CRealPrelude| p.equiv_trans,
        ...
        provides: &[|p: CRealPrelude| p.power_series.one_pow],
        run: super::power_series::declare_one_pow,
    },
    BuildStep {
        label: "power_series::declare_power_series_partial",
        requires: &[
            |p: CRealPrelude| p.creal,
            |p: CRealPrelude| p.power_series_term,
            |p: CRealPrelude| p.sum_range,
        ],
        provides: &[|p: CRealPrelude| p.power_series.power_series_partial],
        run: super::power_series::declare_power_series_partial,
    },
    BuildStep {
        label: "power_series::declare_power_series_term_radius_bound",
        requires: &[
            |p: CRealPrelude| p.abs,
            |p: CRealPrelude| p.abs_mul_le_of_bounds,
            |p: CRealPrelude| p.creal,
            ...
            |p: CRealPrelude| p.pow_mul_distrib,
            |p: CRealPrelude| p.pow_nonneg,
            |p: CRealPrelude| p.power_series.abs_pow_le,
            |p: CRealPrelude| p.power_series_term,
            |p: CRealPrelude| p.zero,
        ],
        provides: &[|p: CRealPrelude| p.power_series.power_series_term_radius_bound],
        run: super::power_series::declare_power_series_term_radius_bound,
    },
    BuildStep {
        label: "power_series::declare_power_series_cauchy_within_radius",
        requires: &[
            |p: CRealPrelude| p.abs,
            |p: CRealPrelude| p.add,
            |p: CRealPrelude| p.cauchy,
            ...
            |p: CRealPrelude| p.pos_bound,
            |p: CRealPrelude| p.pow,
            |p: CRealPrelude| p.power_series.power_series_partial,
            |p: CRealPrelude| p.power_series.power_series_term_radius_bound,
            |p: CRealPrelude| p.power_series_term,
            |p: CRealPrelude| p.ratio_test.geom_scaled_cauchy_of_lt,
            |p: CRealPrelude| p.sum_range_cauchy_of_dominated,
            |p: CRealPrelude| p.zero,
        ],
        provides: &[|p: CRealPrelude| p.power_series.power_series_cauchy_within_radius],
        run: super::power_series::declare_power_series_cauchy_within_radius,
    },
    BuildStep {
        label: "power_series::declare_power_series_converges_within_radius",
        requires: &[
            |p: CRealPrelude| p.abs,
            |p: CRealPrelude| p.add,
            |p: CRealPrelude| p.converges,
        ...
        provides: &[|p: CRealPrelude| p.power_series.power_series_converges_within_radius],
        run: super::power_series::declare_power_series_converges_within_radius,
    },
    BuildStep {
        ...
        requires: &[
            ...
            |p: CRealPrelude| p.one,
            |p: CRealPrelude| p.pow,
            |p: CRealPrelude| p.power_series.one_pow,
            |p: CRealPrelude| p.power_series.power_series_partial,
            |p: CRealPrelude| p.power_series_term,
            |p: CRealPrelude| p.sum_range_congr,
        ],
        provides: &[|p: CRealPrelude| p.power_series.exp_series_partial_is_power_series],
        run: super::power_series::declare_exp_series_partial_is_power_series,
    },
    BuildStep {
        label: "power_series::declare_cos_series_partial_is_power_series",
        requires: &[
            |p: CRealPrelude| p.cos_series_partial,
            |p: CRealPrelude| p.cos_term,
            |p: CRealPrelude| p.creal,
        ...
        provides: &[|p: CRealPrelude| p.power_series.cos_series_partial_is_power_series],
        run: super::power_series::declare_cos_series_partial_is_power_series,
    },
];
