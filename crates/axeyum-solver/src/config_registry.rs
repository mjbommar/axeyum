...
pub static REGISTRY: &[ConfigEntry] = &[
    ...
    ConfigEntry {
        ...
        module: "crates/axeyum-solver/src/lra_online.rs",
        value: "off",
        unit: "lever: 1 | on arms it; anything else is off -- splits a disequality the candidate model violates into its two strict halves for the SAT search",
        protects: Protects::Completeness,
        on_exceed: OnExceed::SearchEvent,
        signal: Signal::None,
