...
macro_rules! full_modules {
    () => {
        ...
        mod quant_bv_instance_set_cert;
...
pub mod certificates {
    ...
    pub mod quantifiers {
        pub use crate::qinst_egraph::{
            ...
            InstantiationLoopExit, NestedActivationLevelGuard, NestedActivationStats,
            NestedActivationStatsGuard, PositivePathLevelGuard,
            ...
            ground_budget, instantiate_forall_via_egraph, last_nested_activation_stats,
...
pub use backend::{
    ...
    DEFAULT_MODEL_PREFERENCE, DEFAULT_MODEL_PREFERENCE_PHASE, DEFAULT_WARM_KEEP_TRAIL,
...
macro_rules! full_exports {
    () => {
        ...
        pub use lia_counters::{
            ...
            LiaCountersGuard, LiaCountersMirror, WarmAssembly, last_lia_counters,
            live_lia_counters,
        };
        #[doc(hidden)]
        pub use lia_gcd::{
