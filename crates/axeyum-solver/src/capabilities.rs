...
pub const CAPABILITIES: &[Capability] = &[
    ...
    Capability {
        ...
        feature: "symbolic memory and UF fallback: select/store and Op::Apply via \
                  ...
                  (full dispatcher; syntactic same-index ROW hits and literal-distinct store \
                  misses can stay warm with original-term replay/core reporting; warm lazy \
                  arrays/UF = ADR-0030 future work)",
        assurance: Assurance::Validated,
        evidence: "full dispatcher model replay; same-index/literal-distinct ROW assertion and \
                   branch warm replay; warm path refuses remaining deferred array/UF theories",
