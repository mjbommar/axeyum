//! ADR-0107: checked free-Boolean models for quantified Bool/Int SAT.
...
use axeyum_solver::{
    ...
    SolverConfig, SolverError, certify_arith_dpll_unsat, check_model,
    check_quantified_bool_model_sat, produce_evidence, solve,
};
