...
#[test]
fn finite_calibration_brier_bad_brier_score_artifact_emits_checked_farkas() {
    assert_resource_farkas(
...
#[test]
fn finite_entropy_information_gain_bad_weighted_entropy_artifact_emits_checked_farkas() {
    assert_resource_farkas(
...
#[test]
fn finite_perceptron_bad_weight_update_artifact_emits_checked_farkas() {
    assert_resource_farkas(
