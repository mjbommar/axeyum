...
fn lower_bv_axeyum(arena: &mut TermArena, e: &BvE, vars: &[TermId; 2]) -> TermId {
    match e {
        BvE::Var(i) => vars[*i],
...
fn lower_bool_axeyum(arena: &mut TermArena, e: &BoolE, vars: &[TermId; 2]) -> TermId {
    match e {
        BoolE::Eq(a, b) => {
            let (a, b) = (
                lower_bv_axeyum(arena, a, vars),
...
fn lower_bv_z3(e: &BvE, vars: &[BV; 2]) -> BV {
    match e {
...
fn lower_bool_z3(e: &BoolE, vars: &[BV; 2]) -> Bool {
    match e {
