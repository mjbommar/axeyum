...
// The `axeyum-gf2-hayes-conditional-variance` CLI cases (`conditional_variance_cli_replays_the_local_haar_decomposition`)
// live on the `agent/gf2/lemire-proof` branch with the `gf2_hayes` module and its
// binary. They return here if that binary is ever lifted out.
