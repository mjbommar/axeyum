...
caller-provided prelude, setup, and replay code. Direct named and tuple symbolic
bundles can also render Rust aggregate initializer statements over those scalar
...
and `render_rust_test_file` assembles caller-owned top-level prelude blocks plus
multiple generated modules or test items into deterministic multi-case fixture
files.
