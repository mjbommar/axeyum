...
- **2026-07-19 — ADR-0259 accepts the fixed cold GQ5 attribution and ADR-0260
  preregisters the narrower origin diagnostic.** Clean detached `d29470cf`
  ...
  Next: implement ADR-0260's profile-only first-origin/duplicate-origin matrix,
  commit it unobserved, and repeat the exact fixed population before selecting
  at most one separately gated generator-elision experiment.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **GQ1/GQ10 readiness increment:** artifact v25 retains v23's word-policy
  ...
  | **GQ5 AIG/CNF construction** | **Cold lane active; broad warm lane closed by ADR-0219; artifact-v35 attribution ACCEPTED without optimization (ADR-0259), origin follow-up preregistered (ADR-0260).** The fixed run finds 119,260 exact duplicates, all primary hits; collision/repeated/complement work is zero, and slice-partial/register-slice own 73.4572%/26.0230% | Implement profile-only first-origin/duplicate-origin pairs, commit before observation, and repeat the fixed 162-query run; select at most one later generator-elision candidate under the preregistered dominance/distribution gate |
