...
- **2026-07-17 — The consolidated code/publication review changes the success
  ...
  ADR-0226 adds the first explicit generated proof denominator.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** (1) add a neutral in-process or topology-equivalent warm
  ...
  cold-reset breadth; (2) measure the now-enforced QF_BV browser artifact's
  generated size, latency, and parser
  footprint, then the warm time/RSS and DRAT deployment points; (3) widen
...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: four-driver map, query/internal attribution, fresh/retained exact-CNF controls, neutral cold-reset SMT breadth, full-cvc5 4,000-row fuzz, and first generated proof denominator DONE; correctness-led evidence open (ADR-0213--0226).** Five fixed-work repetitions establish two wins, parity, and a Z3 win; 9,526 rows reject size alone; cvc5 agrees on all real checks and generated formulas; 169/169 selected UNSAT rows recheck end to end (6.725030% of generated UNSAT). Remaining: warm-neutral SMT; independent/real fuzz and proof coverage with deadlines; finding parity; timeout-sensitive driver; measured qfbv/WASM/RSS/DRAT deployment. |
