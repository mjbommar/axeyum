...
- **2026-07-20 — ADR-0300 preregisters one dense bit-lowering memo experiment.**
  ...
  remain unchanged. Representation-neutral artifact-v39 telemetry must commit
  on the BTree baseline before observation. Exact 162-query structural/storage
  identity then gates six order-balanced unprofiled pairs on bit-blast time,
  cold total, variance, family tails, and RSS. Failure restores the BTree map;
  success is bounded cold-path engineering, not a solver-speed headline.
