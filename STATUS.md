...
- **2026-07-17 — The consolidated code/publication review changes the success
  ...
  checks; ADR-0224 adds the first fail-closed standing multi-oracle fuzz lane.
  Publication blockers are now: (1) a topology-equivalent warm representation/integration
  control; (2) broader multi-oracle rounds plus a measured proof-coverage
  denominator; (3) another neutral implementation/API boundary;
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** (1) add a neutral in-process or topology-equivalent warm
  ...
  ADR-0224's multi-oracle lane with additional fixed-seed rounds, coverage
  accounting, and a measured proof-coverage denominator; (4)
...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: four-driver map, query/internal attribution, fresh/retained exact-CNF controls, neutral cold-reset SMT breadth, and first standing multi-oracle fuzz tranche DONE; correctness-led evidence open (ADR-0213--0224).** Five fixed-work repetitions establish two wins, parity, and a Z3 win; 9,526 rows reject size alone; 431 ordered core calls show retained BatSat beating Z3 Boolean on Axeyum CNF; cvc5 agrees on all real checks and all 250 generated samples. Remaining: warm-neutral SMT; broader fuzz/proof coverage; finding parity; timeout-sensitive driver; measured qfbv/WASM/RSS/DRAT deployment. |
