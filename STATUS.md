...
- **2026-07-14 — ADR-0129 source reconstruction is DONE under the 4 GiB release gate.**
  ...
  local values separately and uses zeta equality during expected-type, application-spine, sort,
  proof-irrelevance, and definitional-equality checks; it retains the telescope
