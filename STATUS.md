...
- **2026-07-19 — ADR-0264 corrects the symbolic-CVE effective-handler join
  ...
  the effective symbol, and has nine passing tests. Commit and execute that
  corrected qualification before binding artifacts. Candidate is not
  executable or detected; no recall claim exists yet.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** first accept ADR-0264's corrected declared/effective-handler
  qualification, then materialize hash-bound vulnerable/fixed artifacts for
  its six candidates and preregister the frontend-executability gate;
...
- **2026-07-19 — ADR-0264 corrects a symbolic-CVE handler-identity defect
  ...
  declared/effective handlers and searches the effective symbol; no artifact,
  frontend, detector, recall, or performance row was observed.
