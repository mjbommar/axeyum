...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: correctness/deployability evidence, neutral warm controls, exact cold attribution, proof denominators, authoritative-policy gates, selected-pair symbolic-CVE recall, and negative harder-driver/duplicate-clause results are complete through ADR-0278.** ADR-0272 rejects performance leadership because warm Bitwuzla wins all four fair drivers. ADR-0273--0275 retain the harder-driver census as incomplete-work negative evidence; ADR-0277 removes its structurally exact candidate after the frozen variance/family gates fail. ADR-0285 now preregisters an independently motivated flat CNF formula arena plus reusable Tseitin scratch: exact clause/proof/replay identity and a >=3% paired total-CNF improvement are required before production. Broader labeled recall and honest correctness/deployability/proof framing remain open; no warm-speed headline or concretization/symbolic-memory reopening is authorized. |
