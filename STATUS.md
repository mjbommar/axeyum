...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **GQ1/GQ10 readiness increment:** artifact v25 retains v23's word-policy
  ...
  |---|---|---|
  | **GQ1 real-query profile** | **Map, query/internal attribution, fresh/retained exact-CNF controls, four-driver neutral cold-reset and source-owner-retained SMT breadth, bounded/canonical/four-schedule raw authority cells, process-isolated corrected-representative end-to-end faithfulness, deadline-aware generated proof widening, isolated behavior-preserving Glaurung A0, taint/SystemBuffer baseline corrections, confidence partition, source-backed nonzero positive control, rejected usbprint resource cell, v2 maximum-precision rejection, stack-region correction, corrected v3 sweep, and exhaustive difference adjudication DONE (ADR-0187/0188/0213--0248 plus Glaurung `7f682e5`).** cvc5 agrees on all 9,526 checks in both external protocols; 302 raw sinks match under unrestricted sole authority on four drivers. ADR-0247 accepts all five scalar policies at 14/14. ADR-0248 closes all 54 varying source-backed rows as 30 plumbing plus 24 duplicate presentations, with zero independent primitives or indeterminate labels. Tcpip remains zero-high/unlabeled. All accepted proof results remain unchanged | Keep symbolic memory gated; separately bound usbprint; add a broader labeled population and wider real proof cells |
  ...
  | **GQ7 warm delta entry** | **Source identity, fair map, query/internal attribution, fresh/retained CNF controls, four-driver neutral cold-reset plus source-owner-retained SMT, bounded raw finding parity, canonical tcpip authority, four-schedule union, isolated configurable-policy A0, taint/SystemBuffer baseline corrections, confidence partition, 14-row source-backed positive control, v1 resource rejection, v2 precision rejection, detector correction, v3 scalar sweep, and exhaustive difference adjudication DONE (ADR-0201--0248 plus Glaurung `7f682e5`).** Every scalar policy preserves 14/14; ADR-0248 finds zero independent primitives among all 54 varying source-backed rows. Tcpip remains diagnostic, and policy cost varies up to 79,950 solves / about 235 MiB | Keep symbolic memory gated; require a broader labeled residual gap and keep usbprint separately bounded |
