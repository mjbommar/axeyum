...
- **2026-07-21 — ADR-0315 accepts modular MIR panic propagation before
  ...
  Next: preregister the smallest annotation lowering into the accepted runtime
  channels with replayed violation UX, without widening call/effect semantics.
