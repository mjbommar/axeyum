...
- **2026-07-10 — direct warm array-valued UF parameters are live.** ADR-0092
  ...
  count, and structural array-key deferral. Next: structural array-valued
  parameter expressions, memory BMC/k-induction, online array proofs, and
...
- **2026-07-10 — nested warm array relation flags are live.** ADR-0091
  ...
  ADR-0092 subsequently lands direct array-valued UF parameters. Next:
  structural array-valued parameter expressions, memory BMC/k-induction, online
  array proofs, and broader low-load aggregate timing.
- **2026-07-10 — retained warm structural array equality is live.** ADR-0090
  ...
  ADR-0091 subsequently lands nested Boolean relation flags, and ADR-0092 lands
  direct array-valued UF parameters. Structural array-valued parameter
  expressions, memory BMC/k-induction, online array proofs, and broader low-load
...
- **2026-07-10 — warm array relations now include exact diff witnesses.**
  ...
  relation flags, and ADR-0092 lands direct array-valued UF parameters;
  structural array-valued parameter expressions, memory BMC/k-induction, and
  online proofs remain.
- **2026-07-10 — array-valued UF parents are retained on the warm path.**
  ...
  structural equality, relation flags, and direct array-valued UF parameters;
  structural array-valued parameter expressions, memory BMC/k-induction, and
  online proofs remain.
...
- **2026-07-10 — retained warm direct array-valued UF parameters landed.**
  ...
  Next: structural array-valued parameter expressions, memory
