...
- **2026-07-19 — ADR-0256 accepts bounded external DRAT interoperability and
  ...
  trace or prioritize the broader labeled-finding population; do not infer
  symbolic-memory headroom from this proof result.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** (1) coordinate with the active Glaurung explorer owner and
  ...
  broader labeled findings, preregister a deterministic bounded scan that
  retains every attempted row and requires the input alone not to verify,
  rather than selecting a proof post hoc or tuning the fixed deadline; (6) widen
