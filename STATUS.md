...
- **2026-07-18 — ADR-0244 v1 fails closed on complete usbprint; ADR-0245
  preregisters the full five-policy v2 over valid boundaries.** Clean detached
  Axeyum `234c6678` and isolated Glaurung `b79f269` preserve the exact v1
  attempt. AnyModel passes all three strata and validates 14/14. Minimum also
  validates 14/14 with zero unexpected high output and passes exact tcpip
  110/110 raw diagnostic parity at 80,563 solves per authority/repetition.
  Its cost is material: positive-control work grows 2,322 -> 60,064 solves.
  All four minimum/complete-usbprint processes then report the preregistered
  300-second wall deadline; source identities stay clean/stable, the rejected
  report is retained, and maximum/site policies are unobserved as required by
  stop-on-first-failure. Complete under AnyModel is therefore not a policy-
  invariant coverage boundary. Do not raise the v1 deadline or count that cell
  as zero. ADR-0245 fixes v2 before observation: all five policies, unchanged
  positive/tcpip source/binary/work identities, 14/14 hard gate, and unlabeled
  tcpip output. Complete usbprint remains a separate bounded resource-frontier
  follow-up. Next commit v1 evidence plus v2, run v2 from that clean detached
  commit, then preregister the usbprint frontier. Live dirty Glaurung remains
  untouched; integration remains separate owner coordination.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **GQ1/GQ10 readiness increment:** artifact v25 retains v23's word-policy
  ...
  |---|---|---|
  | **GQ1 real-query profile** | **Map, query/internal attribution, fresh/retained exact-CNF controls, four-driver neutral cold-reset and source-owner-retained SMT breadth, bounded/canonical/four-schedule raw authority cells, process-isolated corrected-representative end-to-end faithfulness, deadline-aware generated proof widening, isolated behavior-preserving Glaurung A0, taint/SystemBuffer baseline corrections, confidence partition, source-backed nonzero positive control, rejected usbprint resource cell, and v2 preregistration DONE (ADR-0187/0188/0213--0245 plus Glaurung `b79f269`).** cvc5 agrees on all 9,526 checks in both external protocols; 302 raw sinks match under unrestricted sole authority on four drivers. Existing tcpip settings remain zero-high diagnostics. ADR-0243 accepts 14/14 planted rows; minimum retains 14/14 but costs 60,064 solves and preserves tcpip 110/110 at 80,563 solves. ADR-0244 rejects complete usbprint as a policy-invariant boundary after four minimum deadline hits. ADR-0245 fixes all five policies over positive/tcpip before observation. All 74 corrected representative UNSAT rows and 1,505 generated CNF proofs retain their accepted assurance results | Run ADR-0245 unchanged; coordinate corrected A0 integration separately; preregister bounded usbprint frontier; add wider real proof cells |
  ...
  | **GQ7 warm delta entry** | **Source identity, fair map, query/internal attribution, fresh/retained CNF controls, four-driver neutral cold-reset plus source-owner-retained SMT, bounded raw finding parity, canonical tcpip authority, four-schedule union, isolated configurable-policy A0, taint/SystemBuffer baseline corrections, confidence partition, 14-row source-backed positive control, v1 resource rejection, and v2 preregistration DONE; execution WIP, wider default DEFERRED (ADR-0201--0245 plus Glaurung `b79f269`).** Minimum retains 14/14 but costs 60,064 solves; tcpip is exact 110/110 at 80,563; complete usbprint hits all four 300-second deadlines. ADR-0245 retains all five policies over valid positive/tcpip boundaries | Run ADR-0245 unchanged; coordinate corrected A0 integration separately; gate symbolic memory on validated headroom and keep usbprint as a bounded frontier |
  ...
  **Next actions:** (1) coordinate with the active Glaurung explorer owner and
  ...
  and producer confidence is not ground truth; (3) run ADR-0245's preregistered
...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: four-driver fair map, internal/fresh/retained controls, neutral cold/retained SMT, complete three-solver timeout frontier, independent four-oracle fuzz, proof denominators, executable WebAssembly, warm time/RSS/hit-rate deployment, bounded/canonical/four-schedule authority cells, representative whole-certificate process isolation, isolated behavior-preserving Glaurung A0, corrected provenance/SystemBuffer environment, versioned confidence partition, source-backed nonzero positive control, rejected usbprint resource cell, and five-policy v2 preregistration DONE; v2 execution open (ADR-0213--0245 plus Glaurung `b79f269`).** The 12,000-row independent/edge campaign has 12,000 four-way agreements and all 14 corner families. All accepted proof/deployability results remain unchanged. ADR-0243 accepts 14/14 planted rows. ADR-0244 shows minimum retains 14/14 but raises work to 60,064 solves, preserves tcpip 110/110 at 80,563 solves, and fails all four complete-usbprint processes at the 300-second wall. ADR-0245 preregisters all five policies over positive/tcpip while retaining usbprint as a separate resource frontier. Browser and high-reuse memory costs are measured. Remaining: run ADR-0245 unchanged, coordinate clean A0 integration separately, preregister bounded usbprint work, and add wider real manifests. |
