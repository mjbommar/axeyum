...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** measure the exact operation/call/global/memory surface of
  ADR-0267's four admitted LLVM IR sides, preregister the minimum Linux frontend,
  and do not score recall until both sides of a pair clear it;
