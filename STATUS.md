...
- **2026-07-19 — ADR-0251 preregisters a 1,024-query real-proof holdout before
  ...
  registration identities. Next run two clean CPU-3-pinned artifact-v34
  processes under the unchanged 1000 ms cooperative / 1500 ms killable-worker
  policy. Retain every `not-certified` or hard-timeout row; do not adapt bounds
  or select finishers.
