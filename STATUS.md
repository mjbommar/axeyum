...
- **2026-07-19 — ADR-0254 adds standard proof export and preregisters the first
  ...
  control. Next commit this protocol, then run it once from a clean detached
  Axeyum commit without preserving access-controlled proof bytes.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** (1) coordinate with the active Glaurung explorer owner and
  ...
  coverage; execute ADR-0254's pinned external `drat-trim` cell rather than
  tuning the fixed deadline; (6) widen
  ...
  **Validation (2026-07-19, ADR-0254 preregistration):** the proof-export
  ...
  GCC-15 feature-macro command. The selected real proof remains unexported.
