...
- **Session 2026-06-27 — Tiny BV register equality branches.**
  ...
  centralized as the toy ISA grows.
...
- **2026-06-27** — **Tiny BV register equality branches.**
  ...
  register terms/values. Focused tests cover an imported label-bearing memory
  program through label-based checked reachability/safety, a register equality
  branch through checked reachability/concrete replay, and line-numbered parse
  errors, duplicate/missing/dangling label errors, missing label-query errors,
