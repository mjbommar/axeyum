...
- **2026-07-17 — The consolidated code/publication review changes the success
  ...
  real-query proof coverage; and (3) another neutral implementation/API boundary.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **GQ1/GQ10 readiness increment:** artifact v25 retains v23's word-policy
  ...
  |---|---|---|
  | **GQ1 real-query profile** | **Map, query/internal attribution, fresh/retained exact-CNF controls, four-driver neutral cold-reset SMT breadth, and bounded authoritative finding parity DONE (ADR-0187/0188/0213--0229).** cvc5 agrees on all 9,526 checks; 302 raw sinks match under sole Z3/Axeyum authority; BatSat beats Z3 Boolean on retained Axeyum CNF despite native warm Z3 winning end-to-end | Add topology-equivalent neutral and timeout-sensitive/wider authority cells |
