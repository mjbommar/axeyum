...
- **2026-07-09 — base-array selects are live on canonical CDCL(T).** A true
  ...
  ADR-0071. This is base-select congruence after exact eager ROW; P2.2 still owns
  lazy store axioms/extensionality/models. Next P1.6 breadth: mixed BV+LIA/
  `str.len`.
