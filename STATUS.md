...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** (1) coordinate with the active Glaurung explorer owner and
  ...
  the union of reachable findings; (9) preregister and run a wider timeout-
  sensitive sole-authority finding tier under ADR-0250's v6 stop gate, keeping
  every timeout cell separate; (10) preserve ADR-0259's accepted
...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: four-driver fair map, internal/fresh/retained controls, neutral cold/retained SMT, complete three-solver timeout frontier, independent four-oracle fuzz, proof denominators including the accepted 1,024-query holdout, executable WebAssembly, warm time/RSS/hit-rate deployment, bounded/canonical/four-schedule authority cells, representative whole-certificate process isolation, isolated behavior-preserving Glaurung A0, corrected provenance/SystemBuffer environment, versioned confidence partition, source-backed nonzero positive control, two rejected usbprint resource protocols, v2 maximum-precision rejection, model-independent detector correction, corrected v3 scalar sweep, exhaustive source-backed difference adjudication, v6 hidden-work rejection, one neutral standard DRAT consumer plus checker-sanity control, capped nontrivial-proof no-selection, and the closed artifact-v35/v36 cold CNF origin lane DONE without optimization (ADR-0213--0261 plus Glaurung `7f682e5`; stop-class instrumentation candidate `ff3c0a7`).** ADR-0233 already closes neutral timeout-sensitive formula breadth. ADR-0253 adds 1,024/1,024 manifest/Z3 agreements, 515 SAT replays, 509 CNF DRAT rechecks, and stable 508/509 stronger coverage. ADR-0256 accepts one pinned real external verification and the preregistered satisfiable-CNF control while ADR-0258 closes further holdout mining. ADR-0259/0260 attribute 119,260 duplicates; ADR-0261's sole selected leaf-elision candidate changes the structural counters by exactly zero and is rejected before timing. Tcpip variation remains zero-high/unlabeled. Remaining: coordinate the Glaurung footer, add genuinely broader labeled evidence, add a wider timeout-sensitive sole-authority finding tier under v6, and coordinate clean integration separately. |
