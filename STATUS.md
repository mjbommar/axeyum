...
- **2026-07-18 — ADR-0246 accepts model-independent stack-region semantics;
  ...
  the Axeyum cell. No validated coverage headroom is established. Next label a
  bounded policy-difference sample; keep complete usbprint separate and
  symbolic memory deferred. The
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **GQ1/GQ10 readiness increment:** artifact v25 retains v23's word-policy
  ...
  |---|---|---|
  | **GQ1 real-query profile** | **Map, query/internal attribution, fresh/retained exact-CNF controls, four-driver neutral cold-reset and source-owner-retained SMT breadth, bounded/canonical/four-schedule raw authority cells, process-isolated corrected-representative end-to-end faithfulness, deadline-aware generated proof widening, isolated behavior-preserving Glaurung A0, taint/SystemBuffer baseline corrections, confidence partition, source-backed nonzero positive control, rejected usbprint resource cell, v2 maximum-precision rejection, stack-region correction, and corrected v3 sweep DONE (ADR-0187/0188/0213--0247 plus Glaurung `7f682e5`).** cvc5 agrees on all 9,526 checks in both external protocols; 302 raw sinks match under unrestricted sole authority on four drivers. ADR-0247 accepts all five scalar policies at 14/14 with no unexpected high rows. Tcpip has zero high rows; deterministic output varies 84--110 with exact authority parity and AnyModel remains 128/126. All accepted proof results remain unchanged | Independently label a bounded real-driver policy-difference sample; separately bound usbprint; add wider real proof cells |
  ...
  | **GQ7 warm delta entry** | **Source identity, fair map, query/internal attribution, fresh/retained CNF controls, four-driver neutral cold-reset plus source-owner-retained SMT, bounded raw finding parity, canonical tcpip authority, four-schedule union, isolated configurable-policy A0, taint/SystemBuffer baseline corrections, confidence partition, 14-row source-backed positive control, v1 resource rejection, v2 precision rejection, detector correction, and v3 scalar sweep DONE (ADR-0201--0247 plus Glaurung `7f682e5`).** Every scalar policy preserves 14/14; deterministic tcpip output varies 84--110 with exact parity, but remains diagnostic, and policy cost varies up to 79,950 solves / about 235 MiB | Keep symbolic memory deferred; label policy-varying real output before broader exploration and keep usbprint separately bounded |
  ...
  **Next actions:** (1) coordinate with the active Glaurung explorer owner and
  ...
  five-policy v3 campaign; preregister and independently adjudicate a bounded
  sample of policy-varying real-driver rows before selecting further coverage
  work; extend with BoundarySet/DiverseEnum only after bounded
...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: four-driver fair map, internal/fresh/retained controls, neutral cold/retained SMT, complete three-solver timeout frontier, independent four-oracle fuzz, proof denominators, executable WebAssembly, warm time/RSS/hit-rate deployment, bounded/canonical/four-schedule authority cells, representative whole-certificate process isolation, isolated behavior-preserving Glaurung A0, corrected provenance/SystemBuffer environment, versioned confidence partition, source-backed nonzero positive control, rejected usbprint resource cell, v2 maximum-precision rejection, model-independent detector correction, and corrected v3 scalar sweep DONE (ADR-0213--0247 plus Glaurung `7f682e5`).** The 12,000-row independent/edge campaign has 12,000 four-way agreements and all 14 corner families. All accepted proof/deployability results remain unchanged. ADR-0247 accepts all five policies at exact 14/14; tcpip variation remains zero-high/unlabeled and exposes material work/RSS differences. Browser and high-reuse memory costs are measured. Remaining: independently label a bounded real policy-difference sample, preregister a bounded usbprint frontier, coordinate clean integration separately, and add wider real manifests. |
