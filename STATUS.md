...
- **2026-07-09 — canonical `CdclT` now has deterministic VSIDS and phase
  ...
  failures. Next: Luby restarts, then LBD-based learned-clause reduction in the
  canonical driver; no performance win is claimed yet.
