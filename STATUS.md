...
- **2026-07-22 — TL1.3 whole-environment import publication is complete;
  TL1.4 mutation generation is next.** `import_ndjson` no longer accepts or
  ...
  **Next:** TL1.4 generates truncation-at-every-record and the full structural
  mutation corpus against this atomic boundary; TL1.7 dependency digests
  follow.
...
- **2026-07-21 — TL0.1/TL0.2 close the Lean ownership and assurance
  ...
  semantics and TL1.3 has closed atomic publication; TL1.4 now owns the next
  queue item.
