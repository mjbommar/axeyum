...
- **2026-07-19 — ADR-0260 accepts the fixed duplicate-origin observation and
  ADR-0261 preregisters the sole selected experiment.** Clean detached
  ...
  speedup. Next: implement only ADR-0261's same-owner positive-root private
  parity-leaf elision, preserve byte-identical final CNF and all 162 gates, and
  accept only if its exact structural deltas and repeated unprofiled timing
  criteria pass.
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **GQ1/GQ10 readiness increment:** artifact v25 retains v23's word-policy
  ...
  | **GQ5 AIG/CNF construction** | **Cold lane active; broad warm lane closed by ADR-0219; artifact-v35 attribution ACCEPTED without optimization (ADR-0259), artifact-v36 origin observation ACCEPTED (ADR-0260), and one candidate PREREGISTERED (ADR-0261).** Exactly one cell passes: 107,000 same-owner positive-root AND-tree forward-parity duplicates across 29 queries, with a 9.9738% largest-query share | Implement only ADR-0261's private parity-leaf elision; require exact structural deltas, byte-identical final CNF, all 162 gates, and the fixed repeated unprofiled timing win |
  ...
  **Next actions:** (1) coordinate with the active Glaurung explorer owner and
  ...
  implement only ADR-0261's preregistered same-owner positive-root private-
  parity-leaf elision and retain it only if its exact structural and repeated
