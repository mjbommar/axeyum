...
- **2026-07-09 — canonical `CdclT` now has deterministic Luby restarts.** The
  ...
  Next: LBD-based learned-clause reduction, the last local-driver search feature;
  no restart performance win is claimed from the current corpus.
...
- **2026-07-09 — P1.5/P1.6 combined linear arithmetic now uses canonical
  ...
  move the arithmetic-local driver's VSIDS/Luby/LBD/clause-reduction machinery
  into canonical `CdclT`, then advance BV combination.
...
- **2026-07-09 — deterministic Luby restarts migrated into canonical `CdclT`.**
  ...
  corpus results remain clean; the long sweep is neutral at 425.18 s. LBD-based
  learned-clause reduction is now the sole remaining local-driver search feature.
