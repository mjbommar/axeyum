...
- **2026-07-17 — The consolidated code/publication review changes the success
  ...
  RSS/warm-hit/cold and real-query DRAT deployment remain in the first artifact
...
- **Historical Glaurung build-up through 2026-07-14 (superseded by the measured
  ...
  **Next actions:** (1) add a neutral in-process or topology-equivalent warm
  ...
  cold-reset breadth; (2) after ADR-0227's executable QF_BV browser size,
  latency, and parser-footprint baseline, measure the warm time/RSS, cold-gap,
  warm-hit, and real-query DRAT deployment points; (3) widen
...
| P4.5 | Benchmarking & the performance gate (measured Z3 head-to-head) | **WIP: four-driver map, query/internal attribution, fresh/retained exact-CNF controls, neutral cold-reset SMT breadth, full-cvc5 4,000-row fuzz, first generated proof denominator, and executable WebAssembly deployment DONE; correctness-led evidence open (ADR-0213--0227).** Five fixed-work repetitions establish two wins, parity, and a Z3 win; 9,526 rows reject size alone; cvc5 agrees on all real checks and generated formulas; 169/169 selected UNSAT rows recheck end to end (6.725030% of generated UNSAT); stable browser size and Node/Chromium latency are measured. Remaining: warm-neutral SMT; independent/real fuzz and proof coverage with deadlines; finding parity; timeout-sensitive driver; measured RSS/warm-hit/cold and real-query DRAT deployment. |
