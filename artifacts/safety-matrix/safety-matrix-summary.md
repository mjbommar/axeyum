...
Ledger: 2364 facts, 2167 `proved`. Every proved fact appears
...
|---|---:|---:|
| `kernel_theorem` | 1495 / 2167 | 69.0% |
| `per_theorem_footprint` | 59 / 2167 | 2.7% |
| `env_footprint` | 1907 / 2167 | 88.0% |
| `circularity` | 14 / 2167 | 0.6% |
| `semantic_falsification` | 100 / 2167 | 4.6% | **UPPER BOUND — 8 demonstrated.** Counts facts whose evidence names a semantic control, not facts whose control was shown to discriminate.
| `mutation_control` | 15 / 2167 | 0.7% |
| `independent_replay` | 7 / 2167 | 0.3% |
| `coverage_bearing_checker` | 1471 / 2167 | 67.9% |
...
|---|---:|---:|---|
| `exact_statement` | 2167 / 2167 | 100.0% | `artifacts/ontology/settled-fact-statement-pins.json` `pins[].fact_id` (S1, ADR-0763) |
...
2361 distinct `checker_command`s cover 2167 proved facts.
...
| 290 | `cargo run -q -p axeyum-lean-kernel --example nat_axiom_inventory -- --require-axiom-free nat` |
...
- 698 / 2167 proved facts hold two protections or fewer.
- 696 / 2167 have no discriminating checker naming their own subject, where the subject is taken only from an EXPLICIT
...
- 0 / 2167 have no `formal.statement` drift pin.
- 2160 / 2167 have no independent Lean replay.
- 2067 / 2167 carry no semantic-falsification evidence row.
- 2152 / 2167 name no mutation or negative control.
- 2108 / 2167 have no PER-THEOREM axiom footprint check; their footprint evidence is the prelude-wide sweep.
- 50 / 2167 have NO checker of their own: every command they cite is shared with another fact.
- 17 / 2167 cite no `checker_command` at all.
- 2034 / 2167 carry an evidence row listing two or more named `checkers`, and 1362 of those name the PRODUCING run as one of
...
- 1951 evidence rows across 1951 facts declare a semantic `kind` (`exhaustive-enumeration` / `instance-pin`) while their
  ...
  1951 rows, so this census reads `supports`, not `kind`.

## By curation

| curation | facts | median protections | own-subject checker | statement pin |
|---|---:|---:|---:|---:|
| (unset) | 1115 | 1 | 419 | 1115 |
| curated | 14 | 3 | 14 | 14 |
