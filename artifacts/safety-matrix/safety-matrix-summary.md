...
Ledger: 2364 facts, 2172 `proved`. Every proved fact appears
...
|---|---:|---:|
| `kernel_theorem` | 2004 / 2172 | 92.3% |
| `per_theorem_footprint` | 59 / 2172 | 2.7% |
| `env_footprint` | 1912 / 2172 | 88.0% |
| `circularity` | 14 / 2172 | 0.6% |
| `semantic_falsification` | 100 / 2172 | 4.6% | **UPPER BOUND — 8 demonstrated.** Counts facts whose evidence names a semantic control, not facts whose control was shown to discriminate.
| `mutation_control` | 15 / 2172 | 0.7% |
| `independent_replay` | 7 / 2172 | 0.3% |
| `coverage_bearing_checker` | 1980 / 2172 | 91.2% |
...
|---|---:|---:|---|
| `exact_statement` | 2172 / 2172 | 100.0% | `artifacts/ontology/settled-fact-statement-pins.json` `pins[].fact_id` (S1, ADR-0763) |
...
2366 distinct `checker_command`s cover 2172 proved facts.
...
- 217 / 2172 proved facts hold two protections or fewer.
- 192 / 2172 have no discriminating checker naming their own subject, where the subject is taken only from an EXPLICIT
...
- 0 / 2172 have no `formal.statement` drift pin.
- 2165 / 2172 have no independent Lean replay.
- 2072 / 2172 carry no semantic-falsification evidence row.
- 2157 / 2172 name no mutation or negative control.
- 2113 / 2172 have no PER-THEOREM axiom footprint check; their footprint evidence is the prelude-wide sweep.
- 50 / 2172 have NO checker of their own: every command they cite is shared with another fact.
- 17 / 2172 cite no `checker_command` at all.
- 2039 / 2172 carry an evidence row listing two or more named `checkers`, and 1362 of those name the PRODUCING run as one of
...
- 1956 evidence rows across 1956 facts declare a semantic `kind` (`exhaustive-enumeration` / `instance-pin`) while their
  ...
  1956 rows, so this census reads `supports`, not `kind`.
