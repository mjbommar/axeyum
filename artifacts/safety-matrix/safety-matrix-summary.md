...
Ledger: 2366 facts, 2180 `proved`. Every proved fact appears
...
|---|---:|---:|
| `kernel_theorem` | 2012 / 2180 | 92.3% |
| `per_theorem_footprint` | 65 / 2180 | 3.0% |
| `env_footprint` | 1914 / 2180 | 87.8% |
| `circularity` | 14 / 2180 | 0.6% |
| `semantic_falsification` | 100 / 2180 | 4.6% | **UPPER BOUND — 8 demonstrated.** Counts facts whose evidence names a semantic control, not facts whose control was shown to discriminate.
| `mutation_control` | 15 / 2180 | 0.7% |
| `independent_replay` | 7 / 2180 | 0.3% |
| `coverage_bearing_checker` | 1988 / 2180 | 91.2% |
...
|---|---:|---:|---|
| `exact_statement` | 2180 / 2180 | 100.0% | `artifacts/ontology/settled-fact-statement-pins.json` `pins[].fact_id` (S1, ADR-0763) |
...
2376 distinct `checker_command`s cover 2180 proved facts.
...
- 217 / 2180 proved facts hold two protections or fewer.
- 192 / 2180 have no discriminating checker naming their own subject, where the subject is taken only from an EXPLICIT
...
- 0 / 2180 have no `formal.statement` drift pin.
- 2173 / 2180 have no independent Lean replay.
- 2080 / 2180 carry no semantic-falsification evidence row.
- 2165 / 2180 name no mutation or negative control.
- 2115 / 2180 have no PER-THEOREM axiom footprint check; their footprint evidence is the prelude-wide sweep.
- 50 / 2180 have NO checker of their own: every command they cite is shared with another fact.
- 17 / 2180 cite no `checker_command` at all.
- 2047 / 2180 carry an evidence row listing two or more named `checkers`, and 1364 of those name the PRODUCING run as one of
...
- 1964 evidence rows across 1964 facts declare a semantic `kind` (`exhaustive-enumeration` / `instance-pin`) while their
  ...
  1964 rows, so this census reads `supports`, not `kind`.

## By curation

| curation | facts | median protections | own-subject checker | statement pin |
|---|---:|---:|---:|---:|
| (unset) | 1126 | 3 | 934 | 1126 |
| curated | 15 | 3 | 15 | 15 |
