...
- A depth-6 cube-cover probe of F_741 (4096 cells over branch points 2,4,6,8,10,12; 200k conflicts/cell, 8 workers, 900 s wall on s7, 2026-08-12) finished 746 cells unsat (mostly instant unit-propagation refutations), 1132 resource-out at the conflict cap (~4-9 s each), 8 timeout, 2210 unstarted: the refutation is search-hard, as the roadmap predicted, and needs deeper adaptive splitting of the hard subtree plus fleet time
