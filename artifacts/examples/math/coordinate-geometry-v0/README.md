...
- checked QF_LRA/Farkas rejection of a malformed midpoint coordinate;
...
squared-distance identity. The promoted bad rows keep coordinate arithmetic in
exact replay, then check the final linear contradictions between computed
values and malformed claims through the QF_LRA/Farkas route.
