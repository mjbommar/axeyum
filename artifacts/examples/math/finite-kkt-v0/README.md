...
- `bad-kkt-complementarity-rejected`: rejects the malformed claim that the same
  active point and multiplier have complementary-slackness product `1`; exact
  replay computes product `0`, so the error is `1`.
