...
The replay rows are finite list checks. The malformed source rows keep exact
replay results fixed; the `qf-lra-*` rows ask Axeyum to produce independently
checked evidence for the tiny linear contradictions.
