...
- a malformed norm-squared row checked through QF_LRA/Farkas evidence;
...
the bad norm-squared source data, and the fixed polynomial evaluation without
floating-point arithmetic.

The malformed norm row is checked by the QF_LRA/Farkas route after exact
real-pair replay computes `|3 + 4i|^2 = 25` and rejects the claimed value `26`.
