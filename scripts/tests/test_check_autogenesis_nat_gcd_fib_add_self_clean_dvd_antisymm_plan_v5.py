...
class BareFunctionControls(unittest.TestCase):
    def test_v5_plan_passes(self) -> None:
        test_v5_plan_passes()

    def test_v5_checker_binds_branch_specialization_and_zero_authority(self) -> None:
        test_v5_checker_binds_branch_specialization_and_zero_authority()
