...
class BareFunctionControls(unittest.TestCase):
    def test_v3_decline_passes(self) -> None:
        test_v3_decline_passes()

    def test_checker_binds_the_missing_leaf_and_zero_authority(self) -> None:
        test_checker_binds_the_missing_leaf_and_zero_authority()
