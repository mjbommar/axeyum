...
def validate():
 ...
 a={"fact_id":f["id"],"formal_statement_sha256":hashlib.sha256(f["formal"]["statement"].encode()).hexdigest(),"result_manifest":"artifacts/autogenesis/mathlib-nat-fib-eq-zero-goal-identity-result-v1.json","result_manifest_sha256":sha(I),"capsule_path":str(CAPSULE),"capsule_sha256":"b25fc8b0db939ace2cbb0a096e86dd79f185398b93ff3c7698bb7b3d9fd796aa","target_theorem":"Nat.fib_eq_zero","goal_sha256":"cf9757fc1ca8af964ee54762575362e33e6c48dcf34c56381aa1e3a7a0850f4c","declaration_sha256":"9709309661cd94542db84c175fd8a68f1e5a9eba9bc616374320654050435c83","axiom_footprint":[],"direct_theorem_dependencies":DEPS,"fresh_imports":2,"fixed_plan_reconstructions":1,"target_theorem_submissions":1,"search_invocations":0,"ledger_writes":0}; return digest(a)
def main():
 try: receipt=validate(); assert receipt=="c8466767c516d48e0e214aaf7e8a43e88a8bc7fa952a7baa2748eff03d51f3d3"
 ...
 print(f"sealed-nat-fib-eq-zero-capsule: PASS: receipt={receipt} target=Nat.fib_eq_zero footprint=0 dependencies=4"); return 0
