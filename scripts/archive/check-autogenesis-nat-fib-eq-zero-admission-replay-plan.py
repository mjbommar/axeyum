#!/usr/bin/env python3
"""Validate isolated Nat.fib_eq_zero admission replay authority."""
import hashlib,json,pathlib,sys
ROOT=pathlib.Path(__file__).resolve().parents[1]; PLAN=ROOT/"artifacts/autogenesis/mathlib-nat-fib-eq-zero-admission-replay-plan-v1.json"; RESULT=ROOT/"artifacts/autogenesis/mathlib-nat-fib-eq-zero-admission-result-v1.json"
...
def main():
 ...
 except (AssertionError,OSError,ValueError,KeyError,TypeError) as error: print(f"autogenesis-nat-fib-eq-zero-admission-replay-plan: FAIL: {error}",file=sys.stderr); return 1
 print("autogenesis-nat-fib-eq-zero-admission-replay-plan: PASS: replays=0/1|faults=0/1|recoveries=0/1|writes=0/1"); return 0
