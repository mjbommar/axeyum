...
FIELD_PACKS = {
    ...
    "real_analysis": ("reals-rcf-shadow-v0", "Rational/real algebraic shadows of order, limits, and inequalities."),
    ...
    "measure_theory": ("finite-measure-v0", "Finite sigma-algebras, finite measures, random variables, conditional expectations, finite kernels, finite martingales, product tables, and exact probability foundations."),
    "probability_theory": ("finite-probability-v0", "Finite mass tables, random variables, conditional expectation, kernels, martingales, conditioning, Bayes rule, product measures, and exact discrete distributions."),
    "statistics": ("descriptive-statistics-v0", "Mean/variance identities, random variables, conditional expectation, finite kernel and martingale checks, contingency tables, exact tests, and Simpson witnesses."),
    ...
    "differential_equations_and_dynamical_systems": ("bounded-dynamics-v0", "Recurrence systems, discretized dynamics, and invariant checks."),
