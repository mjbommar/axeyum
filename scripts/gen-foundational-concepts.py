...
FIELD_PACKS = {
    ...
    "measure_theory": ("finite-measure-v0", "Finite sigma-algebras, finite measures, and exact probability foundations."),
    "probability_theory": ("finite-probability-v0", "Finite mass tables, conditioning, Bayes rule, and exact discrete distributions."),
