...
CURRICULUM_MAP = {
    ...
    "rationals": {
        ...
        "extra_packs": [
            ...
            (
                "finite-policy-iteration-v0",
                "Exact rational policy-evaluation linear solves, greedy improvement, and policy-stability replay with checked bad policy-value evidence.",
            ),
        ],
    },
    "reals": {
        ...
        "extra_packs": [
            ...
            (
                "finite-linear-discriminant-v0",
                "Finite Fisher-discriminant replay with a checked bad direction proof row and classification/statistical-theory horizon.",
            ),
            (
    ...
    "polynomials": {
        ...
        "extra_packs": [
            ...
            (
                "finite-secant-method-v0",
                "Finite secant-method polynomial evaluation, exact iterate replay, residual decrease, and checked bad-step rejection.",
            ),
            (
    ...
    "sequences-and-limits": {
        ...
        "extra_packs": [
            ...
            (
                "finite-steffensen-method-v0",
                "Finite Steffensen fixed-point acceleration rows, residual-improvement replay, and checked bad accelerated-value proof row.",
            ),
        ],
    },
    "counting": {
    ...
    "linear-algebra": {
        ...
        "extra_packs": [
            ...
            (
                "finite-policy-iteration-v0",
                "Exact rational policy-evaluation linear-system solves with zero-residual replay, greedy improvement rounds, and checked bad policy-value evidence.",
            ),
            (
            ...
            (
                "finite-pivoted-lu-decomposition-v0",
                "Exact rational row-swapped LU factorization, permutation determinant, triangular solve replay, and checked bad pivot-sign evidence.",
            ),
            (
                "finite-ldlt-decomposition-v0",
                "Exact rational LDLT factorization, determinant/positive-minor replay, triangular solve replay, and checked bad diagonal-entry evidence.",
            ),
            (
            ...
            (
                "finite-gram-schmidt-v0",
                "Exact rational Gram-Schmidt projection, normalization, orthonormality, QR product replay, and checked bad projection-coefficient evidence.",
            ),
            (
                "finite-givens-rotation-v0",
                "Exact rational Givens rotation replay, coordinate zeroing, inverse reconstruction, determinant/norm preservation, and checked bad sine-coefficient evidence.",
            ),
            (
                "finite-householder-reflection-v0",
                "Exact rational Householder reflection replay, reflector formula, coordinate zeroing, involution, determinant/norm preservation, and checked bad entry evidence.",
            ),
            (
            ...
            (
                "finite-orthogonal-diagonalization-v0",
                "Exact rational orthogonal diagonalization, spectral invariant replay, eigenpair checks, and checked bad eigenvalue evidence.",
            ),
            (
                "finite-real-schur-decomposition-v0",
                "Exact rational real Schur decomposition, triangular-coupling replay, spectral invariant replay, and checked bad superdiagonal evidence.",
            ),
            (
            ...
            (
                "finite-shifted-qr-step-v0",
                "Exact rational shifted QR step, shifted factorization replay, invariant replay, and checked bad next-step entry evidence.",
            ),
            (
            ...
            (
                "finite-secant-method-v0",
                "Exact rational secant-method iterations with replay-only bad source rows and a separate checked bad-step proof row.",
            ),
            (
                "finite-separation-v0",
    ...
    "calculus": {
        ...
        "extra_packs": [
            ...
            (
                "finite-cubic-spline-interpolation-v0",
                "Finite rational natural cubic spline assembly replay with checked bad-value Farkas row.",
            ),
            (
                "multivariable-calculus-rational-v0",
            ...
            (
                "finite-secant-method-v0",
                "Finite secant-method root-finding replay with checked bad-step evidence and convergence-theorem horizon rows.",
            ),
            (
                "finite-kkt-v0",
...
FIELD_PACKS = {
    ...
    "optimization_and_convexity": [
        ...
        ("finite-policy-iteration-v0", "Finite policy-evaluation linear-solve, greedy-improvement, and policy-stability replay with checked bad policy-value rejection."),
    ],
    ...
    "differential_equations_and_dynamical_systems": ("bounded-dynamics-v0", "Recurrence systems, discretized dynamics, threshold reachability, invariant checks, Euler, Runge-Kutta midpoint, Heun, backward Euler, Crank-Nicolson, Adams-Bashforth, and BDF2 finite time-stepping, Markov transitions, finite hitting times, finite value-iteration Bellman backups, and finite policy-iteration evaluation/improvement rounds."),
    "geometry": [
        (
...
BRIDGE_CONCEPTS = [
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-policy-iteration-v0",
                "Malformed policy-evaluation row checked through exact rational Farkas evidence after finite policy-iteration replay.",
            ),
            (
            ...
            (
                "finite-linear-discriminant-v0",
                "Malformed Fisher-discriminant direction row checked through exact rational Farkas evidence after within-scatter replay.",
            ),
        ],
        "proof_routes": [
            {
        ...
        "source_refs": [
            ...
            "docs/learn/math/policy-iteration-end-to-end.md",
            "docs/learn/math/linear-algebra-and-optimization.md",
            "docs/foundational-resources/PROOF-UPGRADE-FRONTIER.md",
            "docs/foundational-resources/MATH-CURRICULUM-IMPLEMENTATION-MATRIX.md",
            "crates/axeyum-solver/tests/math_resource_lra_routes.rs",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-pivoted-lu-decomposition-v0",
                "Pivoted-LU permutation, determinant-sign, and triangular-solve rows checked as exact rational matrix arithmetic, not pivot-selection or floating-point stability evidence.",
            ),
            (
                "finite-ldlt-decomposition-v0",
                "LDLT determinant, positive-minor, and triangular-solve rows checked as exact rational matrix arithmetic, not indefinite pivoting or floating-point stability evidence.",
            ),
            (
                "finite-condition-number-v0",
            ...
            (
                "finite-orthogonal-diagonalization-v0",
                "Orthogonal diagonalization, eigenpair, trace, and determinant rows checked as exact rational matrix arithmetic, not spectral theorem or eigensolver stability evidence.",
            ),
            (
                "finite-real-schur-decomposition-v0",
                "Real-Schur reconstruction, triangular-coupling, trace, and determinant rows checked as exact rational matrix arithmetic, not Schur theorem or QR-iteration stability evidence.",
            ),
            (
                "finite-polar-decomposition-v0",
            ...
            (
                "finite-shifted-qr-step-v0",
                "One shifted QR step, shifted factorization, orthogonal-similarity replay, trace/determinant invariants, and bad next-step entry rows checked as exact rational arithmetic, not shift-selection or floating-point eigensolver stability evidence.",
            ),
            (
                "finite-conjugate-gradient-v0",
            ...
            (
                "finite-gram-schmidt-v0",
                "Two-vector Gram-Schmidt rows checked as exact rational projection, normalization, and QR arithmetic, not floating-point orthogonalization stability evidence.",
            ),
            (
                "finite-givens-rotation-v0",
                "Givens zeroing rows checked as exact rational rotation arithmetic, not floating-point QR stability evidence.",
            ),
            (
                "finite-householder-reflection-v0",
                "Householder zeroing rows checked as exact rational reflection arithmetic, not floating-point QR stability evidence.",
            ),
            (
            ...
            (
                "finite-policy-iteration-v0",
                "Policy-evaluation linear solves, greedy improvement rounds, stability checks, and bad policy-value rows checked as exact rational replay, not floating-point dynamic-programming or improvement-theorem evidence.",
            ),
            (
                "finite-root-finding-v0",
            ...
            (
                "finite-steffensen-method-v0",
                "Finite Steffensen rows replay exact rational fixed-point acceleration while convergence, fixed-point, denominator-safety, and floating-point stability remain horizon claims.",
            ),
            (
                "finite-taylor-polynomials-v0",
        ...
        "proof_routes": [
            {
                ...
                "sources": [
                    ...
                    "docs/learn/math/shifted-qr-step-end-to-end.md",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-linear-discriminant-v0",
                "Fixed Fisher direction and finite threshold rows that expose a quadratic-ratio optimization shadow while keeping LDA optimality as theorem horizon.",
            ),
            (
                "finite-separation-v0",
    ...
    {
        "id": "bridge_finite_linear_discriminant_shadow",
        "title": "Finite Linear Discriminant Shadow",
        "field_ids": [
            "statistics",
            "linear_algebra",
            "optimization_and_convexity",
        ...
        "resource_status": "validated",
        "summary": (
            "Finite linear-discriminant rows replay exact class means, "
            "within-class scatter, Fisher directions, projected scores, "
            "threshold margins, and source-linked bad-direction Farkas "
            "evidence while keeping classifier theory and numerical "
        ...
        "axeyum_fragments": [
            ...
            "finite classification replay",
            "within-class scatter replay",
            "exact rational arithmetic",
            "QF_LRA",
            "Farkas certificate",
            "finite replay",
        ...
        "example_packs": [
            (
                "finite-linear-discriminant-v0",
                "Exact two-class Fisher discriminant, finite threshold, bad-direction replay, and checked QF_LRA/Farkas row.",
            ),
            (
                "finite-covariance-matrix-v0",
                "Centered Gram and covariance rows that share finite-sample statistics vocabulary.",
            ),
            (
                "inner-product-spaces-rational-v0",
                "Projection and inner-product rows that supply finite direction and score vocabulary.",
            ),
            (
                "finite-ridge-regression-v0",
                "Regularized normal-equation rows that share regression/classification linear-algebra vocabulary.",
            ),
        ],
        "proof_routes": [
            {
                "name": "finite discriminant replay plus QF_LRA/Farkas",
                "status": "checked",
                "checker": "scripts/validate-foundational-example-pack.py and cargo test -p axeyum-solver --test math_resource_lra_routes",
                "lean_status": "partial",
                "sources": [
                ...
                "notes": (
                    "The finite checker recomputes the class means, centered "
                    "rows, within-class scatter, direction equation, projected "
                    "scores, threshold, margins, and Fisher ratio exactly. "
                    "Only the final malformed direction row is promoted to "
        ...
        "open_gaps": [
            "Finite threshold replay does not prove Fisher LDA optimality, Bayes risk, Gaussian modeling assumptions, multiclass LDA, or statistical generalization.",
            "Floating-point covariance, scatter, and classifier implementations need numerical-honesty or QF_FP resources before they can be presented as checked numerical claims.",
            "Regularized, high-dimensional, singular-scatter, and probabilistic classifier theory remain Lean/theorem-horizon work.",
        ],
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state the finite class samples, exact rational means, scatter matrices, direction, scores, threshold, margins, and ratio.",
                "The validator recomputes all finite discriminant quantities from committed source data.",
                "Malformed finite direction claims link to source SMT-LIB artifacts and checked QF_LRA/Farkas regressions after replay.",
                "Learner and query docs keep finite training-set separation separate from general classifier, statistical, and floating-point claims.",
            ],
        },
    },
    {
        "id": "bridge_finite_pca_shadow",
        "title": "Finite Principal Component Shadow",
        "field_ids": [
            "statistics",
            "linear_algebra",
            "optimization_and_convexity",
        ...
        "resource_status": "validated",
        "summary": (
            "Finite PCA rows replay exact sample means, centered Gram and "
            "covariance matrices, principal eigenpairs, projected scores, "
            "one-component residual energy, and source-linked bad-eigenvalue "
            "Farkas evidence while keeping PCA/SVD/statistical and "
            "floating-point theory separate."
        ),
        "prerequisites": [
            "curriculum_rationals",
            "curriculum_linear_algebra",
        ...
        "axeyum_fragments": [
            ...
            "finite matrix replay",
            "finite covariance replay",
            "finite eigenpair replay",
            "finite projection replay",
            "exact rational arithmetic",
            "QF_LRA",
            "Farkas certificate",
            "Lean horizon",
        ...
        "example_packs": [
            (
                "finite-principal-components-v0",
                "Exact four-row PCA shadow with covariance, principal eigenpair, projection/reconstruction replay, and checked bad-eigenvalue evidence.",
            ),
            (
                "finite-covariance-matrix-v0",
                "Centered Gram and covariance rows that supply finite-sample statistics vocabulary.",
            ),
            (
                "finite-singular-value-shadow-v0",
                "SVD-shadow rows that supply singular-vector and spectral-norm vocabulary adjacent to PCA.",
            ),
            (
                "inner-product-spaces-rational-v0",
                "Projection and inner-product rows that supply finite score and residual vocabulary.",
            ),
        ],
        "proof_routes": [
            {
                "name": "finite PCA replay plus QF_LRA/Farkas",
                "status": "checked",
                "checker": "scripts/validate-foundational-example-pack.py and cargo test -p axeyum-solver --test math_resource_lra_routes",
                "lean_status": "partial",
                "sources": [
                ...
                "notes": (
                    "The finite checker recomputes the sample mean, centered "
                    "rows, covariance matrix, eigenpair equations, projected "
                    "scores, one-component reconstruction, residual energy, "
                    "and explained-variance ratio exactly. Only the final "
                    "malformed eigenvalue row is promoted to checked Farkas "
                    "evidence."
                ),
            }
        ],
        ...
        "open_gaps": [
            "Finite covariance/eigenpair replay does not prove PCA variance optimality, SVD equivalence, best-rank approximation, estimator consistency, randomized algorithms, perturbation theory, or statistical generalization.",
            "Floating-point PCA implementations need numerical-honesty or QF_FP resources before they can be presented as checked numerical claims.",
            "High-dimensional, singular, regularized, kernel, and probabilistic PCA theory remain Lean/theorem-horizon work.",
        ],
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state the finite sample, exact rational mean, covariance matrix, principal vector, eigenvalues, projected scores, reconstruction, residuals, and explained-variance ratio.",
    ...
    {
        "id": "bridge_finite_classifier_metrics_shadow",
        "title": "Finite Classifier Metrics Shadow",
        "field_ids": [
            "statistics",
            "probability_theory",
        ],
        ...
        "decidability": "bounded",
        "axeyum_fragments": [
            "finite classifier metrics",
            "finite confusion matrix replay",
            "exact rational arithmetic",
            "QF_LRA",
            "Farkas certificate",
            "finite replay",
        ...
        "example_packs": [
            ...
            (
                "finite-linear-discriminant-v0",
                "Finite classification replay that supplies a linear-discriminant classifier contrast.",
            ),
        ],
        "proof_routes": [
            {
                "name": "finite classifier-metrics replay plus QF_LRA/Farkas",
                "status": "checked",
                "checker": "scripts/validate-foundational-example-pack.py and cargo test -p axeyum-solver --test math_resource_lra_routes",
                "lean_status": "partial",
                "sources": [
                ...
                "notes": (
                    "The finite checker recomputes the committed confusion "
                    "counts and exact rational metrics. Only the final "
                    "malformed precision row is promoted to checked Farkas "
                    "evidence."
                ),
            }
        ],
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-precision-recall-v0",
                "Exact six-row score-ranking table with precision-recall curve, average precision, and checked bad average-precision evidence.",
            ),
            (
                "finite-confusion-matrix-v0",
        ...
        "open_gaps": [
            ...
            "General tie conventions, multiclass averaging conventions, precision-recall theory beyond the committed finite row, and imbalanced-data policy choices remain separate theorem or policy resources.",
    ...
    {
        "id": "bridge_finite_precision_recall_shadow",
        "title": "Finite Precision Recall Shadow",
        "field_ids": [
            "statistics",
            "probability_theory",
        ],
        "resource_status": "validated",
        "summary": (
            "Finite precision-recall rows replay a tie-free scored-classifier "
            "table, exact score order, threshold precision/recall/F1, a "
            "precision-recall curve, average precision, and source-linked "
            "bad-average-precision Farkas evidence while keeping threshold "
            "policy, calibration, confidence intervals, statistical "
            "generalization, tie conventions, interpolation policies, "
            "continuous score distributions, and floating-point behavior "
            "separate."
        ),
        "prerequisites": [
        ...
        "decidability": "bounded",
        "axeyum_fragments": [
            "finite precision-recall replay",
            "finite classifier ranking",
            "exact rational arithmetic",
            "QF_LRA",
            "Farkas certificate",
        ...
        "example_packs": [
            ...
            (
                "finite-roc-auc-v0",
                "Exact ROC/AUC ranking replay that supplies the paired ranking-metric contrast.",
            ),
            (
                "finite-confusion-matrix-v0",
                "Exact actual/predicted classifier metric replay that supplies the confusion-matrix contrast.",
        ...
        "proof_routes": [
            {
                "name": "finite precision-recall replay plus QF_LRA/Farkas",
                "status": "checked",
                "checker": "scripts/validate-foundational-example-pack.py and cargo test -p axeyum-solver --test math_resource_lra_routes",
                "lean_status": "partial",
                "sources": [
                ...
                "notes": (
                    "The finite checker recomputes the committed score order, "
                    "threshold precision/recall, PR curve, and exact average "
                    "precision. Only the final malformed average-precision "
                    "row is promoted to checked Farkas evidence."
                ),
            }
        ],
        ...
        "open_gaps": [
            "Finite tie-free precision-recall replay does not prove threshold optimality, calibration, risk bounds, confidence intervals, sampling guarantees, continuous score-distribution theory, or classifier generalization.",
            "General tie conventions, interpolation policies, multiclass averaging conventions, imbalanced-data policy choices, and precision-recall theorem variants remain separate theorem or policy resources.",
            "Floating-point classifier scores and metric implementations need numerical-honesty or QF_FP resources before they can be presented as checked numerical claims.",
        ],
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state the finite scored table, class totals, score order, threshold rule, PR points, and exact rational average precision.",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-policy-iteration-v0",
                "Exact evaluate-then-improve trace on the same MDP that supplies the policy-space contrast to successive approximation.",
            ),
            (
    ...
    {
        "id": "bridge_finite_policy_iteration_shadow",
        "title": "Finite Policy Iteration Shadow",
        "field_ids": [
            "probability_theory",
            "differential_equations_and_dynamical_systems",
            "optimization_and_convexity",
        ...
        "resource_status": "validated",
        "summary": (
            "Finite policy-iteration rows replay a fixed rational discounted "
            "MDP table, exact zero-residual policy-evaluation linear solves "
            "for every committed policy, each improvement round's Q-values "
            "and unique greedy argmax, termination by policy stability, "
            "componentwise monotone value improvement, and source-linked "
            "bad policy-value Farkas evidence while keeping the "
            "policy-improvement theorem in general, termination and "
            "optimality theorems, average-reward and continuous MDP theory, "
            "stochastic approximation, and floating-point dynamic "
        ...
        "axeyum_fragments": [
            "finite transition systems",
            "finite policy-evaluation linear solve",
            "finite policy-improvement replay",
            "finite policy-stability replay",
            "exact rational arithmetic",
            "QF_LRA",
            "Farkas certificate",
            "finite replay",
        ...
        "example_packs": [
            (
                "finite-policy-iteration-v0",
                "Exact three-policy trace on the shared three-state MDP: evaluation solves (2, 2/3, 0), (2, 3, 0), (5/2, 3, 0), two greedy improvement rounds, a stability round, bad policy-value replay, and checked QF_LRA/Farkas row.",
            ),
            (
                "finite-value-iteration-v0",
                "Exact Bellman-backup trace on the same MDP that supplies the successive-approximation contrast to the evaluate-then-improve loop.",
            ),
            (
                "finite-hitting-times-v0",
                "Exact expected-hitting-time linear-system replay that shares the fixed-policy linear-solve shape.",
            ),
        ],
        "proof_routes": [
            {
                "name": "finite policy-evaluation/improvement replay plus QF_LRA/Farkas",
                "status": "checked",
                "checker": "scripts/validate-foundational-example-pack.py and cargo test -p axeyum-solver --test math_resource_lra_routes",
                "lean_status": "partial",
                "sources": [
                ...
                "notes": (
                    "The finite checker substitutes every committed "
                    "policy-value vector back into its fixed-point equation "
                    "for an exact zero residual, replays each improvement "
                    "round's greedy argmax and the stability round, and "
                    "requires monotone value improvement. Only the final "
                    "malformed policy-value row is promoted to checked "
                    "Farkas evidence."
                ),
            }
        ],
        ...
        "open_gaps": [
            "Finite replay of one committed trace does not prove the policy-improvement theorem, policy-iteration termination, or optimality for other MDPs, discounts, or starting policies.",
            "Uniqueness of the optimal value function and equivalence with the Bellman fixed point in general need theorem resources before they can be treated as checked claims.",
            "Modified, asynchronous, and approximate policy iteration, average-reward and continuous MDP theory, the LP formulation, and stochastic approximation/Q-learning need separate resources before they can be treated as checked claims.",
            "Floating-point policy-evaluation and dynamic-programming behavior needs numerical-honesty or QF_FP resources before it can be presented as checked implementation behavior.",
        ],
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state the finite MDP table, discount, every committed policy, each evaluation solution, every improvement round's Q-values and greedy argmax, the stability round, and the monotone value improvement.",
                "The validator replays the whole trace from committed source data and rejects evaluations, improvements, or stability claims that break exact replay.",
                "Malformed finite policy-value claims link to source SMT-LIB artifacts and checked QF_LRA/Farkas regressions after replay.",
                "Learner and query docs keep finite exact policy-iteration replay separate from improvement-theorem, termination, optimality, average-reward, stochastic-approximation, and floating-point claims.",
            ],
        },
    },
    {
    ...
    },
    {
        ...
        "summary": (
            ...
            "finite Taylor polynomial, cubic Hermite interpolation, and "
            "natural cubic spline assembly "
            "tables, weights, node hits, stencils, endpoint values/slopes, "
            "piece polynomials, knot-continuity constraints, coefficients, "
            "and values. Axeyum can replay the finite "
            "arithmetic and check malformed coefficient, root, discriminant, "
            "product, interpolation-value, Taylor-value, Hermite-value, "
            "spline-value, or step claims "
        ...
        "example_packs": [
            ...
            (
                "finite-secant-method-v0",
                "Exact polynomial evaluation, secant finite-difference denominators, step replay, residual decrease, and checked bad-step row.",
            ),
            (
                "finite-divided-differences-v0",
            ...
            (
                "finite-cubic-spline-interpolation-v0",
                "Exact natural cubic spline assembly replay, C1/C2 knot-continuity checks, natural-boundary checks, and checked bad spline-value evidence.",
            ),
            (
        ...
        "proof_routes": [
            {
                ...
                "notes": (
                    ...
                    "Taylor coefficients and values, Hermite endpoint "
                    "value/slope rows, or natural spline piece and "
                    "knot-continuity rows. Negative rows graduate only "
        ...
        "open_gaps": [
            ...
            "Divided-difference, barycentric, finite-difference, Taylor, Hermite, and natural-spline rows are finite table/weight/stencil/coefficient/endpoint/piece/value replays; interpolation uniqueness, equivalence, error estimates, node-choice conditioning, Runge phenomena, general spline theory, Hermite interpolation theory, Taylor theorem, remainder bounds, convergence, and floating-point interpolation or Taylor evaluation stay Lean or numerical-honesty horizons.",
        ...
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state coefficient domain, degree bound, coefficient tuple, evaluation point, divisor, factor witness, coefficient window, divided-difference table, Newton coefficients, barycentric weights, node-hit data, Taylor coefficient data, Hermite endpoint value/slope data, or spline piece/knot data.",
                "Validators recompute evaluation, product, remainder, GCD/factor witness, derivative, coefficient extraction, divided-difference rows, Newton interpolation values, barycentric weights, terms, node hits, interpolation values, Taylor coefficients, Taylor values, Taylor remainders, Hermite basis values, Hermite values, spline piece values, and spline derivative-continuity rows before trusting a solver result.",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-steffensen-method-v0",
                "Fixed affine fixed-point triples, exact Steffensen acceleration replay, residual-improvement checks, and a convergence/fixed-point horizon.",
            ),
            (
            ...
            (
                "finite-heun-method-v0",
                "Fixed-step explicit trapezoidal Heun stages, exact quadratic trace replay, zero-error table, and checked bad first-step row.",
            ),
            (
            ...
            (
                "finite-adams-bashforth-method-v0",
                "Fixed-step explicit two-step Adams-Bashforth derivative-history replay for y' = 2t, zero-error trace, and checked bad first-step row.",
            ),
            (
                "finite-bdf2-method-v0",
                "Fixed-step implicit two-step BDF2 endpoint-state replay for y' = -y, monotone decay trace, and checked bad first-step row.",
            ),
            (
                "counting-v0",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-secant-method-v0",
                "Secant root-finding replay over exact rational endpoints with a separate checked bad-step row.",
            ),
            (
                "finite-interval-arithmetic-shadow-v0",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-steffensen-method-v0",
                "Finite Steffensen fixed-point acceleration, residual-improvement replay, and bad accelerated-value row.",
            ),
            (
                "generating-functions-v0",
        ...
        "proof_routes": [
            {
                ...
                "sources": [
                    ...
                    "docs/proof-cookbook/recipes/lean-horizon-template.md",
                    "docs/learn/math/aitken-acceleration-end-to-end.md",
                    "docs/learn/math/steffensen-method-end-to-end.md",
    ...
    },
    {
        ...
        "summary": (
            ...
            "checks natural cubic spline assembly rows from first- and "
            "second-derivative knot constraints, "
            "reuses gradient/Hessian data for finite Newton steps, "
            "replays fixed complex real-pair partial derivatives, and isolates "
            "bad derivative, finite-difference, Taylor, Hermite, spline, "
            "gradient, or Newton-coordinate claims as small linear "
        ...
        "axeyum_fragments": [
            ...
            "natural cubic spline derivative-continuity replay",
        ...
        "example_packs": [
            ...
            (
                "finite-cubic-spline-interpolation-v0",
                "Natural cubic spline C1/C2 knot-continuity and natural-boundary replay with checked bad spline-value evidence.",
            ),
            (
                "multivariable-calculus-rational-v0",
            ...
            (
                "finite-secant-method-v0",
                "Secant-step rows that reuse exact polynomial evaluation without requiring derivative data.",
            ),
            (
                "finite-newton-step-v0",
        ...
        "proof_routes": [
            {
                ...
                "notes": (
                    ...
                    "natural spline derivative-continuity rows, "
                    "plus gradient/Hessian data for "
                    "the finite Newton-step pack. Bad finite derivative, "
                    "finite-difference, Taylor, Hermite, spline, gradient, "
        ...
        "open_gaps": [
            "Finite derivative, finite-difference, finite Taylor, finite Hermite, and finite natural-spline replay does not prove differentiability from limits, product/chain rules in general, Taylor theorem, Hermite interpolation theory, spline existence/uniqueness, Taylor-error bounds, convergence order, stability, MVT, or FTC.",
        ...
        "graduation": {
            ...
            "criteria": [
                ...
                "The validator recomputes symbolic derivative samples, finite-difference stencil values, Taylor coefficients, Taylor values, Taylor remainders, Hermite basis values, endpoint slope constraints, Hermite values, spline first/second derivative constraints, and spline values exactly.",
    ...
    {
        "id": "bridge_lu_replay",
        "title": "Finite Matrix Factorization Replay",
        "field_ids": ["linear_algebra", "numerical_analysis"],
        "resource_status": "validated",
        "summary": (
            "Claimed Gaussian-elimination transcripts, LU, pivoted-LU, and LDLT decompositions, QR, Gram-Schmidt, Givens, Householder, and "
            ...
            "matrices; malformed row-operation, product-entry, diagonal, scalar, and "
        ...
        "axeyum_fragments": [
            ...
            "permutation matrix replay",
            "LDLT factorization replay",
            "LRA (exact rationals)",
            "matrix multiplication replay",
            "Gram-Schmidt projection replay",
            "orthogonal factorization replay",
            "Givens rotation replay",
            "Householder reflection replay",
            "positive-definite factorization replay",
            "QF_LRA",
        ],
        "example_packs": [
            (
            ...
            (
                "finite-pivoted-lu-decomposition-v0",
                "Exact pivoted-LU permutation replay, determinant-sign accounting, triangular solve, and checked bad pivot-sign evidence.",
            ),
            (
                "finite-ldlt-decomposition-v0",
                "Exact LDLT unit-lower/diagonal factorization, determinant and positive-minor replay, triangular solve, and checked bad diagonal-entry evidence.",
            ),
            (
                "finite-qr-decomposition-v0",
                "Exact rational QR factorization, orthogonality, triangularity, product replay, and checked bad product-entry evidence.",
            ),
            (
                "finite-gram-schmidt-v0",
                "Exact rational Gram-Schmidt projection, normalization, orthonormality, upper-triangular factor, QR product replay, and checked bad projection-coefficient evidence.",
            ),
            (
                "finite-givens-rotation-v0",
                "Exact rational Givens rotation, coordinate zeroing, inverse reconstruction, determinant/norm preservation, and checked bad sine-coefficient evidence.",
            ),
            (
                "finite-householder-reflection-v0",
                "Exact rational Householder reflection, reflector formula, coordinate zeroing, involution, determinant/norm preservation, and checked bad entry evidence.",
            ),
            (
                "finite-cholesky-decomposition-v0",
        ...
        "proof_routes": [
            {
                ...
                "notes": (
                    ...
                    "back-substitution, LU multipliers, permutation matrices, LDLT products, L*U, triangular solves, determinant signs, Q*R, Q^T*Q, Gram-Schmidt projection coefficients, G^T*G, G*x, H^T*H, H*x, L*L^T, Schur "
        ...
        "open_gaps": [
            "Gaussian elimination, LU, pivoted LU, LDLT, QR, Gram-Schmidt, Givens, Householder, Cholesky, and Schur replay check fixed transcripts, factorizations, multipliers, permutations, diagonal pivots, determinant signs, triangular solves, projection coefficients, rotations, reflections, or block identities; they do not prove existence, pivoting strategy correctness, LDLT/LU/QR/Gram-Schmidt/Givens/Householder/Cholesky algorithm correctness, conditioning, or numerical stability.",
        ...
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state the exact matrix entries, elimination row operations, lower/upper, unit-lower/diagonal, or orthogonal/upper-triangular factors, LU multipliers, permutation matrices, triangular solves, Gram-Schmidt projection coefficients, Givens rotation coefficients, Householder reflector data, and rational arithmetic domain.",
                "The validator recomputes row operations, pivot products, back-substitution, LU multipliers, permutation products, LDLT products, determinant signs, L*U, triangular solves, Q^T*Q, Q*R, Gram-Schmidt projections, G^T*G, G*x, H^T*H, H*x, L*L^T, Schur complements, determinant factors, inverses, and positive leading principal minors, and separate qf-lra row-operation, product-entry, multiplier, coefficient, sign, diagonal, or scalar rows reject corrupted equalities through checked QF_LRA/Farkas evidence.",
    ...
    },
    {
        ...
        "summary": (
            ...
            "triangularization, polar factorization, QR-iteration and shifted-QR steps, "
        ...
        "example_packs": [
            ...
            (
                "finite-orthogonal-diagonalization-v0",
                "Rational orthogonal diagonalization, eigenpair, trace/determinant invariant, and checked bad eigenvalue rows.",
            ),
            (
                "finite-real-schur-decomposition-v0",
                "Rational real Schur reconstruction, triangular coupling, trace/determinant invariant, and checked bad superdiagonal rows.",
            ),
            (
                "finite-polar-decomposition-v0",
            ...
            (
                "finite-shifted-qr-step-v0",
                "Rational shifted QR step, shifted factorization, orthogonal-similarity replay, trace/determinant invariant, and checked bad next-step entry rows.",
            ),
            (
                "finite-power-iteration-v0",
            ...
            (
                "finite-principal-components-v0",
                "Covariance principal eigenpair, projection/reconstruction replay, explained-variance ratio, and checked bad eigenvalue rows.",
            ),
            (
        ...
        "proof_routes": [
            {
                ...
                "notes": (
                    ...
                    "the orthogonal-diagonalization shadow replays Q^T*Q, "
                    "Q*D*Q^T, column eigenpairs, trace, and determinant; "
                    "the real-Schur shadow replays Q^T*Q, Q*T*Q^T, "
                    "A*Q = Q*T, trace, determinant, and triangular "
                    "coupling; "
                    "the polar shadow replays U^T*U, U*P, A^T*A = P^2, "
        ...
        "open_gaps": [
            "Fixed eigenpair, orthogonal-diagonalization, real-Schur, polar, QR-step, shifted-QR-step, power-iteration, Arnoldi, Lanczos, Jordan-chain, and singular-value replay does not prove existence of eigenvalues, real/complex Schur theorem, polar decomposition theorem, square-root functional calculus, QR-iteration convergence, shifted QR/deflation theory, power-iteration convergence, Arnoldi/Ritz convergence, Lanczos/Ritz convergence, Jordan normal form, SVD, diagonalization criteria, spectral theorem, or stability of numerical eigensolvers.",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-principal-components-v0",
                "Exact finite-sample covariance, principal-component eigenpair, projection energy, and checked bad eigenvalue evidence.",
            ),
            (
                "finite-concentration-v0",
    ...
    },
    {
        ...
        "title": "Finite Dynamics And Time-Stepping Replay",
        "field_ids": [
            "differential_equations_and_dynamical_systems",
            "numerical_analysis",
            "real_analysis",
        ...
        "summary": (
            ...
            "solves, Crank-Nicolson averaged slopes, Adams-Bashforth "
            "derivative history, BDF2 implicit history, or finite error "
            ...
            "backward Euler update, Crank-Nicolson update, "
            "Adams-Bashforth multistep update, or BDF2 implicit "
            "multistep update."
        ),
        "prerequisites": [
            "bridge_finite_model_replay",
        ...
        "example_packs": [
            ...
            (
                "finite-runge-kutta-midpoint-v0",
                "Exact explicit midpoint Runge-Kutta stages, finite zero-error table for y' = 2t, and checked bad first-step row.",
            ),
            (
                "finite-heun-method-v0",
                "Exact explicit trapezoidal Heun stages, finite zero-error table for y' = 2t, and checked bad first-step row.",
            ),
            (
                "finite-backward-euler-method-v0",
            ...
            (
                "finite-adams-bashforth-method-v0",
                "Exact two-step Adams-Bashforth derivative-history replay for y' = 2t, finite zero-error table, and checked bad first-step row.",
            ),
            (
                "finite-bdf2-method-v0",
                "Exact implicit two-step BDF2 endpoint-state replay for y' = -y, finite monotone decay table, and checked bad first-step row.",
            ),
        ],
        "proof_routes": [
            {
                ...
                "sources": [
                    ...
                    "docs/learn/math/adams-bashforth-method-end-to-end.md",
                    "docs/learn/math/bdf2-method-end-to-end.md",
                ...
                "notes": (
                    ...
                    "implicit solve, Crank-Nicolson averaged slope, "
                    "Adams-Bashforth derivative-history update, or BDF2 "
                    "implicit history update exactly. "
        ...
        "open_gaps": [
            ...
            "Euler, Runge-Kutta midpoint, Heun, backward Euler, Crank-Nicolson, Adams-Bashforth, and BDF2 rows are exact rational numerical shadows; floating-point implementations, adaptive methods, stiffness behavior, nonlinear solves, and asymptotic error theory stay in numerical-honesty or Lean-horizon lanes.",
        ],
        "graduation": {
            "status": "validated",
            "criteria": [
                "Rows state the transition rule, horizon, initial condition, trace, invariant/threshold, and exact rational data.",
                "The validator recomputes each finite transition, matrix state, Euler update, Runge-Kutta midpoint or Heun stage/update, backward Euler implicit solve/update, Crank-Nicolson averaged-slope update, Adams-Bashforth derivative-history update, BDF2 implicit history update, and finite error value.",
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-policy-iteration-v0",
                "Finite policy-evaluation linear solves and greedy improvement over stochastic transition rows with checked bad policy-value evidence.",
            ),
        ],
        "proof_routes": [
            {
    ...
    },
    {
        ...
        "example_packs": [
            ...
            (
                "finite-linear-discriminant-v0",
                "Fisher-direction and finite threshold rows that reuse exact inner products, projected scores, and within-scatter matrix vocabulary.",
            ),
            (
                "finite-covariance-matrix-v0",
            ...
            (
                "finite-gram-schmidt-v0",
                "Exact two-vector Gram-Schmidt projection, residual, orthonormality, QR product replay, and bad projection-coefficient evidence.",
            ),
            (
                "finite-givens-rotation-v0",
                "Exact two-dimensional Givens rotation, coordinate zeroing, inverse reconstruction, determinant/norm preservation, and bad sine-coefficient evidence.",
            ),
            (
                "finite-householder-reflection-v0",
                "Exact two-dimensional Householder reflection, reflector formula, coordinate zeroing, involution, determinant/norm preservation, and bad entry evidence.",
            ),
            (
                "finite-arnoldi-iteration-v0",
