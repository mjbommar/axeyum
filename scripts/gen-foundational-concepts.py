...
FIELD_PACKS = {
    ...
    "measure_theory": ("finite-measure-v0", "Finite sigma-algebras, finite measures, product tables, and exact probability foundations."),
    "probability_theory": ("finite-probability-v0", "Finite mass tables, conditioning, Bayes rule, product measures, and exact discrete distributions."),
    "statistics": ("descriptive-statistics-v0", "Mean/variance identities, contingency tables, exact tests, and Simpson witnesses."),
