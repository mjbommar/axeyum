...
FIELD_PACKS = {
    ...
    "measure_theory": ("finite-measure-v0", "Finite sigma-algebras, finite measures, random variables, conditional expectations, product tables, and exact probability foundations."),
    "probability_theory": ("finite-probability-v0", "Finite mass tables, random variables, conditional expectation, conditioning, Bayes rule, product measures, and exact discrete distributions."),
    "statistics": ("descriptive-statistics-v0", "Mean/variance identities, random variables, conditional expectation, contingency tables, exact tests, and Simpson witnesses."),
