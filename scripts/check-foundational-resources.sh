...
python3 scripts/query-foundational-resources.py concepts --field statistics --text pca --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-principal-components-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-principal-components-v0 --route Farkas --proof-status checked --text qf-lra-bad-principal-eigenvalue --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-principal-components-v0 --proof-status replay-only --text reconstruction --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-principal-components-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_pca_shadow --pack finite-principal-components-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_eigenpair --pack finite-principal-components-v0 --route Farkas --proof-status checked --require-any >/dev/null
...
python3 scripts/query-foundational-resources.py concepts --field statistics --text "naive bayes" --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-naive-bayes-classifier-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-naive-bayes-classifier-v0 --route Farkas --proof-status checked --text qf-lra-bad-posterior --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-naive-bayes-classifier-v0 --proof-status replay-only --text posterior --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-naive-bayes-classifier-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_naive_bayes_shadow --pack finite-naive-bayes-classifier-v0 --route Farkas --proof-status checked --require-any >/dev/null
...
python3 scripts/query-foundational-resources.py concepts --field statistics --text "roc auc" --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-roc-auc-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-roc-auc-v0 --route Farkas --proof-status checked --text qf-lra-bad-auc --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-roc-auc-v0 --proof-status replay-only --text auc --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-roc-auc-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_roc_auc_shadow --pack finite-roc-auc-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_classifier_metrics_shadow --pack finite-roc-auc-v0 --route Farkas --proof-status checked --require-any >/dev/null
...
python3 scripts/query-foundational-resources.py concepts --field statistics --text calibration --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-calibration-brier-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-calibration-brier-v0 --route Farkas --proof-status checked --text qf-lra-bad-brier-score --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-calibration-brier-v0 --proof-status replay-only --text "Brier score" --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-calibration-brier-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_calibration_brier_shadow --pack finite-calibration-brier-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_classifier_metrics_shadow --pack finite-calibration-brier-v0 --route Farkas --proof-status checked --require-any >/dev/null
...
python3 scripts/query-foundational-resources.py concepts --field statistics --text svm --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-hard-margin-svm-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-hard-margin-svm-v0 --route Farkas --proof-status checked --text qf-lra-bad-bias --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-hard-margin-svm-v0 --proof-status replay-only --text svm --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-hard-margin-svm-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_hard_margin_svm_shadow --pack finite-hard-margin-svm-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_probability_mass_table --pack finite-hard-margin-svm-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_exact_vs_floating_arithmetic --pack finite-hard-margin-svm-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py horizon-frontier --text svm --require-any >/dev/null
python3 scripts/query-foundational-resources.py concepts --field probability_theory --text bellman --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-value-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-value-iteration-v0 --route Farkas --proof-status checked --text qf-lra-bad-backup --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-value-iteration-v0 --proof-status replay-only --text iteration --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-value-iteration-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_value_iteration_shadow --pack finite-value-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_stochastic_kernel --pack finite-value-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_exact_vs_floating_arithmetic --pack finite-value-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py horizon-frontier --text bellman --require-any >/dev/null
python3 scripts/query-foundational-resources.py concepts --field probability_theory --text policy-iteration --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-policy-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-policy-iteration-v0 --route Farkas --proof-status checked --text qf-lra-bad-policy-value --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-policy-iteration-v0 --proof-status replay-only --text policy --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-policy-iteration-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_finite_policy_iteration_shadow --pack finite-policy-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_stochastic_kernel --pack finite-policy-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_exact_vs_floating_arithmetic --pack finite-policy-iteration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py horizon-frontier --text policy-iteration --require-any >/dev/null
...
python3 scripts/query-foundational-resources.py checks --pack finite-ridge-regression-v0 --proof-status lean-horizon --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_residual_bound --pack finite-ridge-regression-v0 --route Farkas --proof-status checked --require-any >/dev/null
...
python3 scripts/query-foundational-resources.py checks --pack finite-aitken-acceleration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --pack finite-aitken-acceleration-v0 --route Farkas --proof-status checked --text qf-lra-bad-aitken-value --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_sequence_tail_shadow --pack finite-aitken-acceleration-v0 --route Farkas --proof-status checked --require-any >/dev/null
python3 scripts/query-foundational-resources.py checks --concept bridge_exact_vs_floating_arithmetic --pack finite-aitken-acceleration-v0 --route Farkas --proof-status checked --require-any >/dev/null
