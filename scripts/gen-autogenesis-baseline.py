...
SEAMS = (
    ...
    },
    {
        "id": "route-dispatch",
        "state": "manual",
        "owner": "route adapters",
        "source": "scripts/close-fact.py",
        "marker": "solver produces a verdict",
        "gap": "no typed fact-to-route dispatch contract exists",
    },
    {
    ...
    },
    {
        ...
        "source": "scripts/close-fact.py",
        "marker": "checker_command",
        "gap": "caller-authored shell text chooses the checker",
    },
    {
