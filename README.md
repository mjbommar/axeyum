...
returns a wrong answer**. Current surface (527 tests, clippy-clean):
...
- **Calculus** — `differentiate`/`differentiate_n`, `integrate` (polynomial, full
  ...
  Stirling-composed raw moments through order 35, plus Laplace and bounded
  polynomial-geometric Z-transform pairs.
