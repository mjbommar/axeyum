...
The current execution ledger for stabilizing the 111 current math packs,
...
it records all 111 current non-template packs as focused-lesson linked, with no
...
theorem boundaries, shortest-path theorem boundaries, circle-geometry
tangent/chord, inversion-geometry circle-line, and cyclic-geometry Ptolemy
theorem boundaries.
...
121 concept rows, 111 non-template packs, 703 expected checks (342 `sat`,
287 `unsat`, 74 `not-run`), 334 checked rows, 295 replay-only rows, 74
Lean-horizon rows, 108 promoted solver-reuse packs, and 3
...
The generated solver-reuse disposition audit now reports 108 promoted math
packs, 3 non-benchmark-horizon packs, and 0 unclassified rows, so future
...
packs**, **3 non-benchmark-horizon packs**, and **0 unclassified packs** after
