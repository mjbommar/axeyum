...
The current execution ledger for stabilizing the 139 current math packs,
...
it records all 139 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 139 non-template packs, 915 expected checks (467 `sat`,
346 `unsat`, 102 `not-run`), 365 checked rows, 448 replay-only rows, 102
Lean-horizon rows, and 139 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 139 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 139 promoted math
...
the foundational resource dashboards now report **139 promoted solver-reuse
