...
**Next:** freeze a hash-only qualification of the exact `Eq.symm` dependency observed in the otherwise empty-footprint residual; forbid all exporter, importer, and target reruns.
