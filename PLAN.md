...
The current execution ledger for stabilizing the 114 current math packs,
...
it records all 114 current non-template packs as focused-lesson linked, with no
...
121 concept rows, 114 non-template packs, 726 expected checks (353 `sat`,
296 `unsat`, 77 `not-run`), 340 checked rows, 309 replay-only rows, 77
Lean-horizon rows, and 114 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 114 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 114 promoted math
...
the foundational resource dashboards now report **114 promoted solver-reuse
