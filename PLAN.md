...
The current execution ledger for stabilizing the 147 current math packs,
...
it records all 147 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 147 non-template packs, 960 expected checks (488 `sat`,
362 `unsat`, 110 `not-run`), 373 checked rows, 477 replay-only rows, 110
Lean-horizon rows, and 147 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 147 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 147 promoted math
...
the foundational resource dashboards now report **147 promoted solver-reuse
