...
The current execution ledger for stabilizing the 135 current math packs,
...
it records all 135 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 135 non-template packs, 887 expected checks (451 `sat`,
338 `unsat`, 98 `not-run`), 361 checked rows, 428 replay-only rows, 98
Lean-horizon rows, and 135 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 135 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 135 promoted math
...
the foundational resource dashboards now report **135 promoted solver-reuse
