...
The current execution ledger for stabilizing the 133 current math packs,
...
it records all 133 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 133 non-template packs, 872 expected checks (442 `sat`,
334 `unsat`, 96 `not-run`), 359 checked rows, 417 replay-only rows, 96
Lean-horizon rows, and 133 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 133 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 133 promoted math
...
the foundational resource dashboards now report **133 promoted solver-reuse
