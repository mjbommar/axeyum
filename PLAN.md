...
The current execution ledger for stabilizing the 128 current math packs,
...
it records all 128 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 128 non-template packs, 834 expected checks (419 `sat`,
324 `unsat`, 91 `not-run`), 354 checked rows, 389 replay-only rows, 91
Lean-horizon rows, and 128 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 128 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 128 promoted math
...
the foundational resource dashboards now report **128 promoted solver-reuse
