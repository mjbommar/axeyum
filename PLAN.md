...
**Next:** execute V5's single scoped `.olean` stage, two exports, two imports, and mandatory cleanup; accept only a sealed empty-footprint residual with every rejected target/order root absent.
