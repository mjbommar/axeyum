...
polynomial replay, finite random-matrix moments, homomorphism preservation,
kernel/image replay, quotient maps, ideal closure, module actions, tensor
bilinearity, finite group actions, and Lean horizons, so resource packs can
point at shared evidence and boundary vocabulary instead of repeating it
locally.
...
the foundational resource dashboards now report **81 promoted solver-reuse
packs**, **3 non-benchmark-horizon packs**, and **0 unclassified packs** after
the latest coordinate-geometry bad squared-distance QF_LRA/Farkas promotion,
...
classification pass for bounded dynamics, complex algebra, and finite
operators, plus the earlier
