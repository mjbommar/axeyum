...
`basic_block_containing_pc` / `trace_basic_blocks`, source-aware concrete trace
rows via `trace_source_steps`, and label-based reachability/safety query wrappers
over the existing checked PC queries. P4.2 still needs richer byte-level/binary
