...
The current execution ledger for stabilizing the 129 current math packs,
...
it records all 129 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 129 non-template packs, 842 expected checks (424 `sat`,
326 `unsat`, 92 `not-run`), 355 checked rows, 395 replay-only rows, 92
Lean-horizon rows, and 129 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 129 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 129 promoted math
...
the foundational resource dashboards now report **129 promoted solver-reuse
