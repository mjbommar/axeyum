...
> the conjunctive row also times out without a completed stage. All three QF_NIA
...
> dispatch/plumbing wins; the remaining three are quantified-BV size/export-cost
> cases. Next measure phase/RSS/kernel-term/module/external-Lean cost on those
> three before choosing a production evidence-aware dispatch boundary.
