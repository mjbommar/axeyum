...
**Next:** preregister one hash-only, non-rendering identity audit of the sealed exact `Int.fib_of_nonneg` root before operation registration or ledger authority.
