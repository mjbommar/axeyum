...
| Public documentation and examples | `WIP`, user-directed lane | Public/crate/consumer/prover/curriculum/contributor front doors are indexed; 34 Cargo examples and the consumer 48-case aggregate are guarded. Corrected built-vs-planned, aspirational-vs-landed, Lean 4.30-vs-offline-quotient, bounded-string/P2.7, proof-assurance, `i128` LRA/Farkas, native-CDCL/default-BatSat, RUP-only-LRAT, and online-combination/fallback boundaries. Source-backed guards require nonzero full-feature tests across cookbook, learner, contributor, foundational-resource, and rules docs. Generated authorities remain canonical; continue live-linked drift. |
