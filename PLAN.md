...
The current execution ledger for stabilizing the 122 current math packs,
...
it records all 122 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 122 non-template packs, 786 expected checks (389 `sat`,
312 `unsat`, 85 `not-run`), 348 checked rows, 353 replay-only rows, 85
Lean-horizon rows, and 122 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 122 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 122 promoted math
...
the foundational resource dashboards now report **122 promoted solver-reuse
