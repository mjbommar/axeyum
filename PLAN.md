...
The current execution ledger for stabilizing the 134 current math packs,
...
it records all 134 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 134 non-template packs, 879 expected checks (446 `sat`,
336 `unsat`, 97 `not-run`), 360 checked rows, 422 replay-only rows, 97
Lean-horizon rows, and 134 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 134 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 134 promoted math
...
the foundational resource dashboards now report **134 promoted solver-reuse
