...
| **Lean certificate coverage** | **Substantial but uneven** | All 35 measured rows have complete dominance-audit artifacts: 327 baseline UNSAT decisions become 325 evidence-audit UNSAT outcomes and 261 Lean-checked outcomes. The generated [proof-gap matrix](docs/plan/generated/proof-gap-matrix.md) tightens the full conjunction to 259/327: 54 uncertified audit-row occurrences, eight reconstruction-only gaps, four declared `bit-blast` trust holes, and two QF_NIA `IntPow2` proof-production errors. The parser-backed [shape census](docs/plan/generated/proof-gap-shape-census.md) deduplicates the 54 to 52 paths / 47 exact contents (25 arithmetic, 22 string/sequence), and finds three contents discharged before the ordinary parsed-IR DAG. The next prerequisite is route/reduction provenance, not a syntax-selected proof rule. The trusted-reduction ledger is **not yet zero**, and the Lean tactic backend (P3.7) is unbuilt. |
