...
[note 11](docs/research/10-cas/lemire-signed-trace/11-backward-chains-diary.md);
...
[Note 15](docs/research/10-cas/lemire-signed-trace/15-arxiv-techniques-2023-2026.md)
...
(b) [Note 16](docs/research/10-cas/lemire-signed-trace/16-large-q-threshold.md):
...
(c) [Note 17](docs/research/10-cas/lemire-signed-trace/17-cylinder-plancherel.md):
...
conjecture. [The lane note](docs/research/10-cas/lemire-signed-trace/01-target-and-toolkit.md)
