...
| Public documentation and examples | `WIP`, user-directed lane | Public, crate, consumer, prover, curriculum, and contributor front doors are indexed; all 34 Cargo examples and the consumer 48-case aggregate are guarded. Current corrections cover route-specific beginner UNSAT assurance, built-vs-planned prover status, aspirational north-star claims, landed foundation phases, partial TL2.15, offline-only TL2.10 quotient work, resolved symbolic-shift/high-assurance-UNSAT research questions, and the bounded-string sound-incomplete/default-12/retry-48/cap-512 support boundary. Generated authorities remain canonical; continue from concrete live-linked drift. |
