...
The current execution ledger for stabilizing the 126 current math packs,
...
it records all 126 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 126 non-template packs, 818 expected checks (409 `sat`,
320 `unsat`, 89 `not-run`), 352 checked rows, 377 replay-only rows, 89
Lean-horizon rows, and 126 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 126 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 126 promoted math
...
the foundational resource dashboards now report **126 promoted solver-reuse
