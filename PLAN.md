...
The current execution ledger for stabilizing the 136 current math packs,
...
it records all 136 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 136 non-template packs, 895 expected checks (456 `sat`,
340 `unsat`, 99 `not-run`), 362 checked rows, 434 replay-only rows, 99
Lean-horizon rows, and 136 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 136 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 136 promoted math
...
the foundational resource dashboards now report **136 promoted solver-reuse
