...
The current execution ledger for stabilizing the 131 current math packs,
...
it records all 131 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 131 non-template packs, 858 expected checks (434 `sat`,
330 `unsat`, 94 `not-run`), 357 checked rows, 407 replay-only rows, 94
Lean-horizon rows, and 131 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 131 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 131 promoted math
...
the foundational resource dashboards now report **131 promoted solver-reuse
