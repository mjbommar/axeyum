...
4. **Authoritative finding parity — bounded four-driver, first canonical
   ...
   confidence-schema tiers and source-backed positive control DONE; policy
   sweep preregistration WIP (ADR-0229/0236/0238/0239/0240/0241/0242/0243):** sole-authority Z3 and Axeyum
   ...
   least/greatest/site/boundary/diverse sweep with that hard regression stratum
   and separately reported unlabeled real-driver discovery output. Deterministic work bounds are
