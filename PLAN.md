...
The current execution ledger for stabilizing the 140 current math packs,
...
it records all 140 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 140 non-template packs, 923 expected checks (472 `sat`,
348 `unsat`, 103 `not-run`), 366 checked rows, 454 replay-only rows, 103
Lean-horizon rows, and 140 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 140 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 140 promoted math
...
the foundational resource dashboards now report **140 promoted solver-reuse
