...
| Public documentation and examples | `WIP`, user-directed lane | Public/crate/consumer/prover/curriculum/contributor front doors are indexed; 34 Cargo examples and the 48-case consumer aggregate are guarded. Corrected built-vs-planned, aspirational-vs-landed, Lean 4.30-vs-offline-quotient, bounded-string/P2.7, proof-assurance, `i128` LRA/Farkas, native-CDCL/default-BatSat, and RUP-only-LRAT boundaries. Source-backed guards now require nonzero full-feature tests across cookbook, learner, contributor, foundational-resource, and rules documentation. Generated authorities remain canonical; continue from live-linked drift. |
