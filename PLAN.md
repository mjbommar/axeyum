...
**Next:** preregister one pinned Lean core export of `if_pos`, audit its exact closure, and keep `Int.fib_of_nonneg` construction separately unauthorized until that support is demonstrably empty-footprint.
