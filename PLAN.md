...
The current execution ledger for stabilizing the 151 current math packs,
...
it records all 151 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 151 non-template packs, 984 expected checks (500 `sat`,
370 `unsat`, 114 `not-run`), 377 checked rows, 493 replay-only rows, 114
Lean-horizon rows, and 151 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 151 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 151 promoted math
...
the foundational resource dashboards now report **151 promoted solver-reuse
