...
the foundational resource dashboards now report **62 promoted solver-reuse
packs** and **22 unclassified packs** after the latest Bool/CNF finite-set and
proof-method, QF_LRA linear-algebra/optimization/convexity,
