...
**Next:** construct and qualify a generic target-owned integer pair-case eliminator, then freeze the four concrete `Int.fib_add` constructor branches over admitted recurrence and integer-presentation capsules.
