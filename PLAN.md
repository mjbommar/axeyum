...
**Next:** implement and compile the frozen exact specialization driver over target-owned `Int.fib`, `Nat.fib`, `Int.fib_natCast`, and the qualified constructor residual; execution remains separately gated.
