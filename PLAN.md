...
The current execution ledger for stabilizing the 153 current math packs,
...
it records all 153 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 153 non-template packs, 996 expected checks (506 `sat`,
374 `unsat`, 116 `not-run`), 379 checked rows, 501 replay-only rows, 116
Lean-horizon rows, and 153 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 153 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 153 promoted math
...
the foundational resource dashboards now report **153 promoted solver-reuse
