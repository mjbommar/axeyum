...
The current execution ledger for stabilizing the 138 current math packs,
...
it records all 138 current non-template packs as focused-lesson linked, with no
...
Schur complements, real-Schur rows, singular-value shadows, dynamics/Euler rows, and complex
real-pair resources.
...
122 concept rows, 138 non-template packs, 908 expected checks (463 `sat`,
344 `unsat`, 101 `not-run`), 364 checked rows, 443 replay-only rows, 101
Lean-horizon rows, and 138 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 138 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 138 promoted math
...
the foundational resource dashboards now report **138 promoted solver-reuse
