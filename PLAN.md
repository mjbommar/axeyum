...
The current execution ledger for stabilizing the 132 current math packs,
...
it records all 132 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 132 non-template packs, 865 expected checks (438 `sat`,
332 `unsat`, 95 `not-run`), 358 checked rows, 412 replay-only rows, 95
Lean-horizon rows, and 132 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 132 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 132 promoted math
...
the foundational resource dashboards now report **132 promoted solver-reuse
