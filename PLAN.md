...
The current execution ledger for stabilizing the 152 current math packs,
...
it records all 152 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 152 non-template packs, 990 expected checks (503 `sat`,
372 `unsat`, 115 `not-run`), 378 checked rows, 497 replay-only rows, 115
Lean-horizon rows, and 152 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 152 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 152 promoted math
...
the foundational resource dashboards now report **152 promoted solver-reuse
