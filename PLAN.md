...
The current execution ledger for stabilizing the 115 current math packs,
...
it records all 115 current non-template packs as focused-lesson linked, with no
...
121 concept rows, 115 non-template packs, 733 expected checks (357 `sat`,
298 `unsat`, 78 `not-run`), 341 checked rows, 314 replay-only rows, 78
Lean-horizon rows, and 115 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 115 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 115 promoted math
...
the foundational resource dashboards now report **115 promoted solver-reuse
