...
`load`/`store` plus load-equality branch/assume queries. This is still a one-shot
fallback, not final warm lazy theory incrementality or a full CFG frontend.
