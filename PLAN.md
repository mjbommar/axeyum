...
**Next:** execute the frozen function-abstracted `Nat.fib_eq_zero` residual once under pinned Lean 4.30, export twice, and stop on any elaboration or dependency-contract mismatch before exact specialization.
