...
**Next:** freeze one current-source binary build and one fail-if-present exact `Nat.fib_eq_zero` execution; focused Clippy passed without reading either proof stream or leaving a runnable binary.
