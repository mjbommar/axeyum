...
The current execution ledger for stabilizing the 92 existing math packs,
...
finite recurrence-prefix, separation/root-finding, and KKT checks into focused packs: finite monotone-prefix
...
finite constrained-quadratic KKT replay, and checked
QF_LRA/Farkas rejection of bad upper-bound, bad finite-value, bad Newton-step,
bad separator, and bad stationarity rows, while
monotone convergence, closed-form recurrence solving, asymptotics, and
separation/KKT/stability/convergence theorems remain Lean-horizon.
...
separation plus finite KKT stationarity/complementarity replay queryable while
keeping duality, KKT sufficiency, SDP, general separation, and
...
the foundational resource dashboards now report **92 promoted solver-reuse
