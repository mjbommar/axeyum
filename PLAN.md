...
metadata for graph reachability/matching/cuts/d-separation/search-runtime,
...
`logic-basics-v0` and `finite-cardinality-v0` are the first promoted packs from
that batch: `tiny-cnf-refutation` and `no-injection-four-to-three` now have
