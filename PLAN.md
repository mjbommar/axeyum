...
**Next:** execute one bounded `Init.Prelude` export of clean `Nat.zero_lt_succ` and `Nat.add_pos_right`, then import twice and seal before writing the exact specialization driver.
