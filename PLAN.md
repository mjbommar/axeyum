...
The current execution ledger for stabilizing the 113 current math packs,
...
it records all 113 current non-template packs as focused-lesson linked, with no
...
121 concept rows, 113 non-template packs, 719 expected checks (349 `sat`,
294 `unsat`, 76 `not-run`), 339 checked rows, 304 replay-only rows, 76
Lean-horizon rows, and 113 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 113 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 113 promoted math
...
the foundational resource dashboards now report **113 promoted solver-reuse
