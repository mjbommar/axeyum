...
The current execution ledger for stabilizing the 121 current math packs,
...
it records all 121 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 121 non-template packs, 777 expected checks (383 `sat`,
310 `unsat`, 84 `not-run`), 347 checked rows, 346 replay-only rows, 84
Lean-horizon rows, and 121 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 121 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 121 promoted math
...
the foundational resource dashboards now report **121 promoted solver-reuse
