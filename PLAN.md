...
The current execution ledger for stabilizing the 150 current math packs,
...
it records all 150 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 150 non-template packs, 978 expected checks (497 `sat`,
368 `unsat`, 113 `not-run`), 376 checked rows, 489 replay-only rows, 113
Lean-horizon rows, and 150 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 150 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 150 promoted math
...
the foundational resource dashboards now report **150 promoted solver-reuse
