...
The current execution ledger for stabilizing the 112 current math packs,
...
it records all 112 current non-template packs as focused-lesson linked, with no
...
121 concept rows, 112 non-template packs, 713 expected checks (346 `sat`,
292 `unsat`, 75 `not-run`), 338 checked rows, 300 replay-only rows, 75
Lean-horizon rows, and 112 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 112 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 112 promoted math
...
the foundational resource dashboards now report **112 promoted solver-reuse
