...
the foundational resource dashboards now report **57 promoted solver-reuse
packs** and **27 unclassified packs** after the latest QF_LRA finite-probability,
QF_UF, QF_LIA, and QF_BV source-metadata promotion batches;
prefer the next
