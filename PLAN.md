...
The current execution ledger for stabilizing the 123 current math packs,
...
it records all 123 current non-template packs as focused-lesson linked, with no
...
122 concept rows, 123 non-template packs, 795 expected checks (395 `sat`,
314 `unsat`, 86 `not-run`), 349 checked rows, 360 replay-only rows, 86
Lean-horizon rows, and 123 promoted solver-reuse packs. The rules/law JSON
...
coverage audit records all 123 non-template packs as focused-lesson linked,
...
The generated solver-reuse disposition audit now reports 123 promoted math
...
the foundational resource dashboards now report **123 promoted solver-reuse
