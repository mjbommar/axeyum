...
- Per-instance evidence/Lean coverage is measured by
  ...
  quantified `25% (1/4)`, QF_ABV/cvc5+bitwuzla `87% (147/169)`,
  ...
  extensionality coverage for `ext23`, and finite row-wise extensionality
  coverage for `ext19`, `ext24`, and `ext25`, plus the current ABV
