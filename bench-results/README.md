...
- Per-instance evidence/Lean coverage is measured by
  ...
  quantified `100% (4/4)`, BV/cvc5 quantified `100% (37/37)`,
  QF_ABV/cvc5+bitwuzla `100% (169/169)`,
  ...
  `100% (2/2)`, QF_UFFF/cvc5 `100% (8/8)`, QF_UFLIA curated `100% (2/2)`, and
  QF_UFLIA bounded `100% (5/5)`.
