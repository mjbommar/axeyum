...
- Per-instance evidence/Lean coverage is measured by
  ...
  quantified `25% (1/4)`, QF_ABV/cvc5+bitwuzla `89% (151/169)`,
  ...
  coverage for `ext13`, `read9`, `write16`, and `write17`, plus the current
  ABV `BvAbstraction` rows reflected by the refreshed artifact.
