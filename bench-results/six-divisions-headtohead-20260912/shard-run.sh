#!/usr/bin/env bash
# One shard of the fair head-to-head for the six unmeasured divisions.
# Protocol copied verbatim from
# bench-results/fpbv-divisions-headtohead-20260912/shard-run.sh (lane
# BOARD-FPBV, ADR-1941); only the axeyum binary path differs.
#
...
AX=/nas3/data/axeyum/harness/six-divisions/bin/smtcomp_cli
Z3=/usr/bin/z3
