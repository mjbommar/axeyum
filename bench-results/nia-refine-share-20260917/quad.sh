...
#
# Arms (lemmas x share):
#   L0S0  AXEYUM_NIA_ORDER_LEMMAS=0 AXEYUM_NIA_REFINE_SHARE=0   shipped
#   L1S0  AXEYUM_NIA_ORDER_LEMMAS=1 AXEYUM_NIA_REFINE_SHARE=0   lemmas, old share
#   L0S3  AXEYUM_NIA_ORDER_LEMMAS=0 AXEYUM_NIA_REFINE_SHARE=3   no lemmas, new share
#   L1S3  AXEYUM_NIA_ORDER_LEMMAS=1 AXEYUM_NIA_REFINE_SHARE=3   ADR-2136's B arm
#
...
ARM_L0S0="AXEYUM_NIA_ORDER_LEMMAS=0 AXEYUM_NIA_REFINE_SHARE=0"
ARM_L1S0="AXEYUM_NIA_ORDER_LEMMAS=1 AXEYUM_NIA_REFINE_SHARE=0"
ARM_L0S3="AXEYUM_NIA_ORDER_LEMMAS=0 AXEYUM_NIA_REFINE_SHARE=3"
ARM_L1S3="AXEYUM_NIA_ORDER_LEMMAS=1 AXEYUM_NIA_REFINE_SHARE=3"
...
printf 'file\tL0S0_1\tL0S0_2\tL0S0_3\tL1S0_1\tL1S0_2\tL1S0_3\tL0S3_1\tL0S3_2\tL0S3_3\tL1S3_1\tL1S3_2\tL1S3_3\tL0S0\tL1S0\tL0S3\tL1S3\n' > "$OUT"
n=0
while IFS= read -r f; do
  [ -n "$f" ] || continue
  n=$((n+1))
  a1=$(one "$ARM_L0S0"); b1=$(one "$ARM_L1S0"); c1=$(one "$ARM_L0S3"); d1=$(one "$ARM_L1S3")
  d2=$(one "$ARM_L1S3"); c2=$(one "$ARM_L0S3"); b2=$(one "$ARM_L1S0"); a2=$(one "$ARM_L0S0")
  a3=$(one "$ARM_L0S0"); b3=$(one "$ARM_L1S0"); c3=$(one "$ARM_L0S3"); d3=$(one "$ARM_L1S3")
  ...
  printf '%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n' \
    ...
    "$ca" "$cb" "$cc" "$cd" >> "$OUT"
  printf 'quad %d: L0S0=%s L1S0=%s L0S3=%s L1S3=%s %s\n' "$n" "$ca" "$cb" "$cc" "$cd" "${f##*/}" >&2
done < "$LIST"
