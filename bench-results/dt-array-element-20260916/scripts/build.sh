#!/usr/bin/env bash
# DT-ARRAY-ELEMENT -- build this lane's binary in a target dir of its own and
...
TAG="${1:-base}"
TARGET=/data0/axeyum/dt-array-element-target-$TAG
OUT=/nas3/data/axeyum/harness/dt-array-element/bin
