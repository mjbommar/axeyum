...
- Complete committed dominance audits with exact audited `dominant%(D)`: 16. Remaining rows are readiness or partial-audit entries.
...
| QF_FP | `qf-fp-bitwuzla-regress-clean` | 16 | 94% (15/16) | 86% (6/7) | errors 1, timeouts 1, Lean unsat 6/7, evidence certified 15/16, evidence checked 15/16, trust holes timeout, timeout phases lean-reconstruction 1 | `bench-results/dominance/qf-fp-bitwuzla-regress-clean-dominance-audit.json` |
...
| QF_FP | `qf-fp-bitwuzla-regress-clean` | 16 | 16 | 100% | strong | 0 | complete | 94% (15/16) | 86% (6/7) | fix audit errors | keep FP as measured-competitive, not Lean-dominant, until Fpa2Bv certs grow |
