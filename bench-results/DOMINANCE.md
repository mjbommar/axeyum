...
| QF_LRA | `qf-lra-cvc5-regress-clean` | 9 | 78% (7/9) | 33% (1/3) | Lean unsat 1/3 | `bench-results/dominance/qf-lra-cvc5-regress-clean-dominance-audit.json` |
...
| QF_LRA | `qf-lra-cvc5-regress-clean` | 11 | 9 | 82% | strong | 0 | complete | 78% (7/9) | 33% (1/3) | close Lean unsat gaps | run per-instance Lean reconstruction over the committed LRA slice |
