...
| QF_AX | `qf-ax-cvc5-regress-clean` | 5 | 100% (5/5) | 100% (4/4) | none | `bench-results/dominance/qf-ax-cvc5-regress-clean-dominance-audit.json` |
...
| QF_AX | `qf-ax-cvc5-regress-clean` | 8 | 5 | 62% | mid | 0 | complete | 100% (5/5) | 100% (4/4) | dominant on audited row | replace finite index enumeration with witnessed extensionality, then certify |
