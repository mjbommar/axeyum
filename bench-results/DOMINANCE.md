...
| QF_UF | `qf-uf-cvc5-regress-clean-bounded-uninterp-sorts` | 44 | 84% (37/44) | 57% (8/14) | timeouts 1, Lean unsat 8/14, evidence certified 38/44, evidence checked 43/44, trust holes bit-blast, timeout, timeout phases check-evidence 1 | `bench-results/dominance/qf-uf-cvc5-regress-clean-bounded-uninterp-sorts-dominance-audit.json` |
...
| QF_UF | `qf-uf-cvc5-regress-clean-bounded-uninterp-sorts` | 82 | 44 | 54% | mid | 0 | complete | 84% (37/44) | 57% (8/14) | fix audit timeouts | remeasure after first-class uninterpreted sorts, then run Lean audit |
