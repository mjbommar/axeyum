...
- 35 measured division rows, 992 files, 749 decided, 628 oracle-compared.
...
| BV | `bv-cvc5-regress-clean-quantified` | 50 | 82% (41/50) | 47% (8/17) | Lean unsat 8/17 | `bench-results/dominance/bv-cvc5-regress-clean-quantified-dominance-audit.json` |
...
| BV | `bv-cvc5-regress-clean-quantified` | 54 | 50 | 93% | strong | 0 | complete | 82% (41/50) | 47% (8/17) | close Lean unsat gaps | audit quantified-BV rows with per-instance Lean reconstruction |
