...
- 35 measured division rows, 992 files, 747 decided, 628 oracle-compared.
...
| BV | `bv-cvc5-regress-clean-quantified` | 48 | 83% (40/48) | 50% (8/16) | Lean unsat 8/16 | `bench-results/dominance/bv-cvc5-regress-clean-quantified-dominance-audit.json` |
...
| BV | `bv-cvc5-regress-clean-quantified` | 54 | 48 | 89% | strong | 0 | complete | 83% (40/48) | 50% (8/16) | close Lean unsat gaps | audit quantified-BV rows with per-instance Lean reconstruction |
