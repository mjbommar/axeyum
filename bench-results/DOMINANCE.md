...
- 35 measured division rows, 992 files, 661 decided, 609 oracle-compared.
...
| QF_AX | `qf-ax-cvc5-regress-clean` | 6 | 100% (6/6) | 100% (5/5) | none | `bench-results/dominance/qf-ax-cvc5-regress-clean-dominance-audit.json` |
...
| QF_ALIA | `qf-alia-cvc5-regress-clean` | 6 | 6 | 100% | strong | 0 | complete | 100% (6/6) | 100% (5/5) | dominant on audited row | move solve frontier to AUFLIA scalar search and QF_AX declared-sort SAT models |
...
| QF_AX | `qf-ax-cvc5-regress-clean` | 8 | 6 | 75% | mid | 0 | complete | 100% (6/6) | 100% (5/5) | dominant on audited row | build replay-checked declared-sort SAT models for arrays2/arrays3 |
