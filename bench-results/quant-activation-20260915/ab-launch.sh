#!/usr/bin/env bash
# QUANT-ACTIVATION -- launch the six-division A/B across this lane's pinned cores.
#
...
STAGE="${4:-/nas3/data/axeyum/harness/quant-activation/stage}"
AX=${QA_AX:-/nas3/data/axeyum/harness/quant-activation/bin/smtcomp_cli-lever}
