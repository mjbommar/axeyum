#!/usr/bin/env bash
# QUANT-ACTIVATION -- interleaved per-file A/B of ONE BINARY at TWO ENV VALUES
# (ADR-2120, `AXEYUM_QINST_POSITIVE_PATH`).
#
...
# B = the same binary with `AXEYUM_QINST_POSITIVE_PATH=<valueB>`.
#
