#!/usr/bin/env bash
# SKELETON-REACH -- build this lane's binary in an EMPTY target dir and verify
...
TAG="${1:-base}"
TARGET=/data0/axeyum/skeleton-reach-target-$TAG
OUT=/nas3/data/axeyum/harness/skeleton-reach/bin
