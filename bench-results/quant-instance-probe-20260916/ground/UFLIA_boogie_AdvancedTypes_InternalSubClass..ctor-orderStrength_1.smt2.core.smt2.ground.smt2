...
(declare-fun InternalSubClass () Int)
...
(declare-fun AnotherSubClass () Int)
...
(declare-fun block6800_correct () Int)
...
(assert (or (= inv_ sharingMode_) (= (select2 (store2 Heap_0_ this inv_ InternalSubClass) this sharingMode_) (select2 Heap_0_ this sharingMode_))))
(check-sat)
