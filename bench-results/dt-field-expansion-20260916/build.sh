#!/usr/bin/env bash
# DT-FIELD-EXPANSION -- build this lane's binary in a target dir of its own and
...
TAG="${1:-base}"
TARGET=/data0/axeyum/dt-field-expansion-target-$TAG
OUT=/nas3/data/axeyum/harness/dt-field-expansion/bin
