...
- **DISAGREE = 0 across all baselines** — zero wrong verdicts over 628 oracle-compared instances (992 files total, 747 decided).
...
| BV | `bv-cvc5-regress-clean-quantified` | 54 | 48 | 89% | 0 | 6 | 0 | 0 | :status | 2.529 |
...
**Totals:** 992 files, 747 decided, 628 oracle-compared, **0 disagreements.**
