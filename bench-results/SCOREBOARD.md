...
- **DISAGREE = 0 across all baselines** — zero wrong verdicts over 606 oracle-compared instances (992 files total, 658 decided).
...
**Totals:** 992 files, 658 decided, 606 oracle-compared, **0 disagreements.**
