...
- **DISAGREE = 0 across all baselines** — zero wrong verdicts over 609 oracle-compared instances (992 files total, 661 decided).
...
| QF_AX | `qf-ax-cvc5-regress-clean` | 8 | 6 | 75% | 0 | 2 | 6 | 0 | z3-binary | 6.667 |
...
**Totals:** 992 files, 661 decided, 609 oracle-compared, **0 disagreements.**
