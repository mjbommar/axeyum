...
- **DISAGREE = 0 across all baselines** — zero wrong verdicts over 608 oracle-compared instances (992 files total, 660 decided).
...
| QF_AX | `qf-ax-cvc5-regress-clean` | 8 | 5 | 62% | 1 | 2 | 5 | 0 | z3-binary | 10.000 |
...
**Totals:** 992 files, 660 decided, 608 oracle-compared, **0 disagreements.**
