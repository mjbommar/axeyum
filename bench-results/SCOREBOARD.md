...
- **DISAGREE = 0 across all baselines** — zero wrong verdicts over 628 oracle-compared instances (992 files total, 749 decided).
...
| BV | `bv-cvc5-regress-clean-quantified` | 54 | 50 | 93% | 0 | 4 | 0 | 0 | :status | 1.624 |
...
**Totals:** 992 files, 749 decided, 628 oracle-compared, **0 disagreements.**
