...
| BV | `bv-cvc5-regress-clean-quantified` | 54 | 54 | 100% | 0 | 0 | 52 | 0 | z3-binary | 0.033 |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| bv_reduction | 38 | 30 | +8 | 40 | 4 | QF_BV word-level reduction depth (unsat at knob N) |
| lia_cuts | 35 | 26 | +9 | 36 | 4 | QF_LIA branch-and-cut depth (sat at knob N) |
