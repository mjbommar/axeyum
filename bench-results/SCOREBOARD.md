...
- **DISAGREE = 0 across all baselines** — zero wrong verdicts over 628 oracle-compared instances (992 files total, 746 decided).
...
| BV | `bv-cvc5-regress-clean-quantified` | 54 | 47 | 87% | 0 | 7 | 0 | 0 | :status | 3.008 |
...
**Totals:** 992 files, 746 decided, 628 oracle-compared, **0 disagreements.**
